...
namespace Pulumi.Aiven
{
    ...
    public partial class OpenSearch : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("components")]
        public Output<ImmutableArray<Outputs.OpenSearchComponent>> Components { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.OpenSearchServiceIntegration>> ServiceIntegrations { get; private set; } = null!;
        ...
        /// </summary>
        [Output("techEmails")]
        public Output<ImmutableArray<Outputs.OpenSearchTechEmail>> TechEmails { get; private set; } = null!;
        ...
        public OpenSearch(string name, OpenSearchArgs args, CustomResourceOptions? options = null)
            : base("aiven:index/openSearch:OpenSearch", name, args ?? new OpenSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenSearch(string name, Input<string> id, OpenSearchState? state = null, CustomResourceOptions? options = null)
            : base("aiven:index/openSearch:OpenSearch", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenSearch Get(string name, Input<string> id, OpenSearchState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenSearch(name, id, state, options);
        }
    }

    public sealed class OpenSearchArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30  GiB to scale your service. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
        /// </summary>
        ...
        private InputList<Inputs.OpenSearchServiceIntegrationArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.OpenSearchServiceIntegrationArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.OpenSearchServiceIntegrationArgs>());
        ...
        [Input("techEmails")]
        private InputList<Inputs.OpenSearchTechEmailArgs>? _techEmails;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        public InputList<Inputs.OpenSearchTechEmailArgs> TechEmails
        {
            get => _techEmails ?? (_techEmails = new InputList<Inputs.OpenSearchTechEmailArgs>());
        ...
        public OpenSearchArgs()
        {
        }
        public static new OpenSearchArgs Empty => new OpenSearchArgs();
    }

    public sealed class OpenSearchState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30  GiB to scale your service. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
        /// </summary>
        ...
        [Input("components")]
        private InputList<Inputs.OpenSearchComponentGetArgs>? _components;

        /// <summary>
        /// Service component information objects
        /// </summary>
        public InputList<Inputs.OpenSearchComponentGetArgs> Components
        {
            get => _components ?? (_components = new InputList<Inputs.OpenSearchComponentGetArgs>());
        ...
        [Input("serviceIntegrations")]
        private InputList<Inputs.OpenSearchServiceIntegrationGetArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.OpenSearchServiceIntegrationGetArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.OpenSearchServiceIntegrationGetArgs>());
            set => _serviceIntegrations = value;
        }
        ...
        [Input("techEmails")]
        private InputList<Inputs.OpenSearchTechEmailGetArgs>? _techEmails;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        public InputList<Inputs.OpenSearchTechEmailGetArgs> TechEmails
        {
            get => _techEmails ?? (_techEmails = new InputList<Inputs.OpenSearchTechEmailGetArgs>());
            set => _techEmails = value;
        }
        ...
        public OpenSearchState()
        {
        }
        public static new OpenSearchState Empty => new OpenSearchState();
    }
}
