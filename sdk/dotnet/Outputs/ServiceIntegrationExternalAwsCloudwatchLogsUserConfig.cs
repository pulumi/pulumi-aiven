...
namespace Pulumi.Aiven.Outputs
{
    ...
    [OutputType]
    public sealed class ServiceIntegrationExternalAwsCloudwatchLogsUserConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServiceIntegrationExternalAwsCloudwatchLogsUserConfig(ImmutableArray<string> selectedLogFields)
        {
