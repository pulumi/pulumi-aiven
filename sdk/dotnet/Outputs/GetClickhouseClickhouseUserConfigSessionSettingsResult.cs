...
namespace Pulumi.Aiven.Outputs
{
    ...
    [OutputType]
    public sealed class GetClickhouseClickhouseUserConfigSessionSettingsResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetClickhouseClickhouseUserConfigSessionSettingsResult(string? compatibility)
        {
