...
namespace Pulumi.Aiven.Outputs
{
    ...
    [OutputType]
    public sealed class ServiceIntegrationExternalOpensearchLogsUserConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServiceIntegrationExternalOpensearchLogsUserConfig(ImmutableArray<string> selectedLogFields)
        {
