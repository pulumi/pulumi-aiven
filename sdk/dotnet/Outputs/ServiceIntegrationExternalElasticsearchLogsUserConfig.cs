...
namespace Pulumi.Aiven.Outputs
{
    ...
    [OutputType]
    public sealed class ServiceIntegrationExternalElasticsearchLogsUserConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServiceIntegrationExternalElasticsearchLogsUserConfig(ImmutableArray<string> selectedLogFields)
        {
