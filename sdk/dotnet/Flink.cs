...
namespace Pulumi.Aiven
{
    ...
    /// {
    ///     var exampleFlink = new Aiven.Index.Flink("example_flink", new()
    ///     {
    ...
    public partial class Flink : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("components")]
        public Output<ImmutableArray<Outputs.FlinkComponent>> Components { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.FlinkServiceIntegration>> ServiceIntegrations { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.FlinkTag>> Tags { get; private set; } = null!;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        [Output("techEmails")]
        public Output<ImmutableArray<Outputs.FlinkTechEmail>> TechEmails { get; private set; } = null!;
        ...
        public Flink(string name, FlinkArgs args, CustomResourceOptions? options = null)
            : base("aiven:index/flink:Flink", name, args ?? new FlinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Flink(string name, Input<string> id, FlinkState? state = null, CustomResourceOptions? options = null)
            : base("aiven:index/flink:Flink", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Flink Get(string name, Input<string> id, FlinkState? state = null, CustomResourceOptions? options = null)
        {
            return new Flink(name, id, state, options);
        }
    }

    public sealed class FlinkArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30 GiB to the default disk space defined by the `Plan`. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
        /// </summary>
        ...
        private InputList<Inputs.FlinkServiceIntegrationArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.FlinkServiceIntegrationArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.FlinkServiceIntegrationArgs>());
        ...
        [Input("tags")]
        private InputList<Inputs.FlinkTagArgs>? _tags;

        /// <summary>
        /// Tags are key-value pairs that allow you to categorize services.
        /// </summary>
        public InputList<Inputs.FlinkTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.FlinkTagArgs>());
            set => _tags = value;
        }

        [Input("techEmails")]
        private InputList<Inputs.FlinkTechEmailArgs>? _techEmails;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        public InputList<Inputs.FlinkTechEmailArgs> TechEmails
        {
            get => _techEmails ?? (_techEmails = new InputList<Inputs.FlinkTechEmailArgs>());
        ...
        public static new FlinkArgs Empty => new FlinkArgs();
    }

    public sealed class FlinkState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30 GiB to the default disk space defined by the `Plan`. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
        /// </summary>
        ...
        [Input("components")]
        private InputList<Inputs.FlinkComponentGetArgs>? _components;

        /// <summary>
        /// Service component information objects
        /// </summary>
        public InputList<Inputs.FlinkComponentGetArgs> Components
        {
            get => _components ?? (_components = new InputList<Inputs.FlinkComponentGetArgs>());
        ...
        [Input("serviceIntegrations")]
        private InputList<Inputs.FlinkServiceIntegrationGetArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.FlinkServiceIntegrationGetArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.FlinkServiceIntegrationGetArgs>());
            set => _serviceIntegrations = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.FlinkTagGetArgs>? _tags;

        /// <summary>
        /// Tags are key-value pairs that allow you to categorize services.
        /// </summary>
        public InputList<Inputs.FlinkTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.FlinkTagGetArgs>());
            set => _tags = value;
        }

        [Input("techEmails")]
        private InputList<Inputs.FlinkTechEmailGetArgs>? _techEmails;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        public InputList<Inputs.FlinkTechEmailGetArgs> TechEmails
        {
            get => _techEmails ?? (_techEmails = new InputList<Inputs.FlinkTechEmailGetArgs>());
            set => _techEmails = value;
        }
        ...
        public static new FlinkState Empty => new FlinkState();
    }
}
