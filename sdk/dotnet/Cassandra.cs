...
namespace Pulumi.Aiven
{
    ...
    public partial class Cassandra : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.CassandraServiceIntegration>> ServiceIntegrations { get; private set; } = null!;
        ...
        public Cassandra(string name, CassandraArgs args, CustomResourceOptions? options = null)
            : base("aiven:index/cassandra:Cassandra", name, args ?? new CassandraArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cassandra(string name, Input<string> id, CassandraState? state = null, CustomResourceOptions? options = null)
            : base("aiven:index/cassandra:Cassandra", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Cassandra Get(string name, Input<string> id, CassandraState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class CassandraArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.CassandraServiceIntegrationArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.CassandraServiceIntegrationArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.CassandraServiceIntegrationArgs>());
        ...
        public CassandraArgs()
        {
        }
        public static new CassandraArgs Empty => new CassandraArgs();
    }
    ...
    public sealed class CassandraState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("components")]
        private InputList<Inputs.CassandraComponentGetArgs>? _components;

        /// <summary>
        /// Service component information objects
        /// </summary>
        public InputList<Inputs.CassandraComponentGetArgs> Components
        {
            get => _components ?? (_components = new InputList<Inputs.CassandraComponentGetArgs>());
        ...
        [Input("serviceIntegrations")]
        private InputList<Inputs.CassandraServiceIntegrationGetArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.CassandraServiceIntegrationGetArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.CassandraServiceIntegrationGetArgs>());
            set => _serviceIntegrations = value;
        }
        ...
        public static new CassandraState Empty => new CassandraState();
    }
}
