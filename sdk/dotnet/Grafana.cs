...
namespace Pulumi.Aiven
{
    ...
    public partial class Grafana : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("grafanas")]
        public Output<ImmutableArray<Outputs.GrafanaGrafana>> GrafanaServer { get; private set; } = null!;
    ...
    public sealed class GrafanaState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("grafanas")]
        private InputList<Inputs.GrafanaGrafanaGetArgs>? _grafanas;

        /// <summary>
        /// Grafana server provided values
        /// </summary>
        public InputList<Inputs.GrafanaGrafanaGetArgs> GrafanaServer
        {
            get => _grafanas ?? (_grafanas = new InputList<Inputs.GrafanaGrafanaGetArgs>());
            set => _grafanas = value;
        }
