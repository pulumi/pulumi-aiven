...
namespace Pulumi.Aiven
{
    ...
    public partial class ElasticSearch : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.ElasticSearchElasticsearch>> Elasticsearches { get; private set; } = null!;
    ...
    public sealed class ElasticSearchState : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ElasticSearchElasticsearchGetArgs>? _elasticsearches;

        /// <summary>
        /// Elasticsearch server provided values
        /// </summary>
        public InputList<Inputs.ElasticSearchElasticsearchGetArgs> Elasticsearches
        {
            get => _elasticsearches ?? (_elasticsearches = new InputList<Inputs.ElasticSearchElasticsearchGetArgs>());
