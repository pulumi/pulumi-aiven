...
namespace Pulumi.Aiven.Inputs
{
    ...
    public sealed class DragonflyDragonflyUserConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.DragonflyDragonflyUserConfigIpFilterObjectArgs>? _ipFilterObjects;

        /// <summary>
        /// Allow incoming connections from CIDR address block, e.g. `10.20.0.0/16`
        /// </summary>
        public InputList<Inputs.DragonflyDragonflyUserConfigIpFilterObjectArgs> IpFilterObjects
        {
            get => _ipFilterObjects ?? (_ipFilterObjects = new InputList<Inputs.DragonflyDragonflyUserConfigIpFilterObjectArgs>());
        ...
        /// </summary>
        [Input("migration")]
        public Input<Inputs.DragonflyDragonflyUserConfigMigrationArgs>? Migration { get; set; }

        /// <summary>
        /// Allow access to selected service ports from private networks
        /// </summary>
        [Input("privateAccess")]
        public Input<Inputs.DragonflyDragonflyUserConfigPrivateAccessArgs>? PrivateAccess { get; set; }
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Inputs.DragonflyDragonflyUserConfigPublicAccessArgs>? PublicAccess { get; set; }
        ...
        public DragonflyDragonflyUserConfigArgs()
        {
        }
        public static new DragonflyDragonflyUserConfigArgs Empty => new DragonflyDragonflyUserConfigArgs();
    }
}
