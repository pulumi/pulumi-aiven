...
namespace Pulumi.Aiven.Inputs
{
    ...
    public sealed class AlloydbomniAlloydbomniGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("bouncer")]
        ...
        [Input("params")]
        private InputList<Inputs.AlloydbomniAlloydbomniParamGetArgs>? _params;

        /// <summary>
        /// AlloyDB Omni connection parameters.
        /// </summary>
        public InputList<Inputs.AlloydbomniAlloydbomniParamGetArgs> Params
        {
            get => _params ?? (_params = new InputList<Inputs.AlloydbomniAlloydbomniParamGetArgs>());
            set
            {
                var emptySecret = Output.CreateSecret(ImmutableArray.Create<Inputs.AlloydbomniAlloydbomniParamGetArgs>());
        ...
        public AlloydbomniAlloydbomniGetArgs()
        {
        }
        public static new AlloydbomniAlloydbomniGetArgs Empty => new AlloydbomniAlloydbomniGetArgs();
    }
}
