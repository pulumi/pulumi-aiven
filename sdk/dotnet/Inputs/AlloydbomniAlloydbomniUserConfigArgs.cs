...
namespace Pulumi.Aiven.Inputs
{
    ...
    public sealed class AlloydbomniAlloydbomniUserConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.AlloydbomniAlloydbomniUserConfigIpFilterObjectArgs>? _ipFilterObjects;

        /// <summary>
        /// Allow incoming connections from CIDR address block, e.g. `10.20.0.0/16`
        /// </summary>
        public InputList<Inputs.AlloydbomniAlloydbomniUserConfigIpFilterObjectArgs> IpFilterObjects
        {
            get => _ipFilterObjects ?? (_ipFilterObjects = new InputList<Inputs.AlloydbomniAlloydbomniUserConfigIpFilterObjectArgs>());
        ...
        /// </summary>
        [Input("pg")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPgArgs>? Pg { get; set; }
        ...
        /// </summary>
        [Input("pgaudit")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPgauditArgs>? Pgaudit { get; set; }

        /// <summary>
        /// PGBouncer connection pooling settings
        /// </summary>
        [Input("pgbouncer")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPgbouncerArgs>? Pgbouncer { get; set; }

        /// <summary>
        /// System-wide settings for pglookout
        /// </summary>
        [Input("pglookout")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPglookoutArgs>? Pglookout { get; set; }

        /// <summary>
        /// Allow access to selected service ports from private networks
        /// </summary>
        [Input("privateAccess")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPrivateAccessArgs>? PrivateAccess { get; set; }

        /// <summary>
        /// Allow access to selected service components through Privatelink
        /// </summary>
        [Input("privatelinkAccess")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPrivatelinkAccessArgs>? PrivatelinkAccess { get; set; }
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Inputs.AlloydbomniAlloydbomniUserConfigPublicAccessArgs>? PublicAccess { get; set; }
        ...
        public AlloydbomniAlloydbomniUserConfigArgs()
        {
        }
        public static new AlloydbomniAlloydbomniUserConfigArgs Empty => new AlloydbomniAlloydbomniUserConfigArgs();
    }
}
