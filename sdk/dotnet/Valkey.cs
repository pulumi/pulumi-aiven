...
namespace Pulumi.Aiven
{
    ...
    /// ```
    /// </summary>
    [AivenResourceType("aiven:index/valkey:Valkey")]
    public partial class Valkey : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("components")]
        public Output<ImmutableArray<Outputs.ValkeyComponent>> Components { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ValkeyServiceIntegration>> ServiceIntegrations { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.ValkeyTag>> Tags { get; private set; } = null!;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        [Output("techEmails")]
        public Output<ImmutableArray<Outputs.ValkeyTechEmail>> TechEmails { get; private set; } = null!;
        ...
        /// </summary>
        [Output("valkeyUserConfig")]
        public Output<Outputs.ValkeyValkeyUserConfig?> ValkeyUserConfig { get; private set; } = null!;
        ...
        public Valkey(string name, ValkeyArgs args, CustomResourceOptions? options = null)
            : base("aiven:index/valkey:Valkey", name, args ?? new ValkeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Valkey(string name, Input<string> id, ValkeyState? state = null, CustomResourceOptions? options = null)
            : base("aiven:index/valkey:Valkey", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Valkey Get(string name, Input<string> id, ValkeyState? state = null, CustomResourceOptions? options = null)
        {
            return new Valkey(name, id, state, options);
        }
    }

    public sealed class ValkeyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30  GiB to scale your service. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart and there might be a short downtime for services with no HA capabilities.
        /// </summary>
        ...
        private InputList<Inputs.ValkeyServiceIntegrationArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.ValkeyServiceIntegrationArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.ValkeyServiceIntegrationArgs>());
        ...
        [Input("tags")]
        private InputList<Inputs.ValkeyTagArgs>? _tags;

        /// <summary>
        /// Tags are key-value pairs that allow you to categorize services.
        /// </summary>
        public InputList<Inputs.ValkeyTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ValkeyTagArgs>());
            set => _tags = value;
        }

        [Input("techEmails")]
        private InputList<Inputs.ValkeyTechEmailArgs>? _techEmails;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        public InputList<Inputs.ValkeyTechEmailArgs> TechEmails
        {
            get => _techEmails ?? (_techEmails = new InputList<Inputs.ValkeyTechEmailArgs>());
        ...
        [Input("valkey")]
        private Input<Inputs.ValkeyValkeyArgs>? _valkey;
        ...
        public Input<Inputs.ValkeyValkeyArgs>? ValkeyServer
        {
            ...
            set
            {
                ...
                _valkey = Output.Tuple<Input<Inputs.ValkeyValkeyArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        /// Valkey user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        /// </summary>
        [Input("valkeyUserConfig")]
        public Input<Inputs.ValkeyValkeyUserConfigArgs>? ValkeyUserConfig { get; set; }

        public ValkeyArgs()
        {
        }
        public static new ValkeyArgs Empty => new ValkeyArgs();
    }

    public sealed class ValkeyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30  GiB to scale your service. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart and there might be a short downtime for services with no HA capabilities.
        /// </summary>
        ...
        [Input("components")]
        private InputList<Inputs.ValkeyComponentGetArgs>? _components;

        /// <summary>
        /// Service component information objects
        /// </summary>
        public InputList<Inputs.ValkeyComponentGetArgs> Components
        {
            get => _components ?? (_components = new InputList<Inputs.ValkeyComponentGetArgs>());
        ...
        [Input("serviceIntegrations")]
        private InputList<Inputs.ValkeyServiceIntegrationGetArgs>? _serviceIntegrations;

        /// <summary>
        /// Service integrations to specify when creating a service. Not applied after initial service creation
        /// </summary>
        public InputList<Inputs.ValkeyServiceIntegrationGetArgs> ServiceIntegrations
        {
            get => _serviceIntegrations ?? (_serviceIntegrations = new InputList<Inputs.ValkeyServiceIntegrationGetArgs>());
            set => _serviceIntegrations = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.ValkeyTagGetArgs>? _tags;

        /// <summary>
        /// Tags are key-value pairs that allow you to categorize services.
        /// </summary>
        public InputList<Inputs.ValkeyTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ValkeyTagGetArgs>());
            set => _tags = value;
        }

        [Input("techEmails")]
        private InputList<Inputs.ValkeyTechEmailGetArgs>? _techEmails;

        /// <summary>
        /// The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
        /// </summary>
        public InputList<Inputs.ValkeyTechEmailGetArgs> TechEmails
        {
            get => _techEmails ?? (_techEmails = new InputList<Inputs.ValkeyTechEmailGetArgs>());
            set => _techEmails = value;
        }
        ...
        [Input("valkey")]
        private Input<Inputs.ValkeyValkeyGetArgs>? _valkey;
        ...
        public Input<Inputs.ValkeyValkeyGetArgs>? ValkeyServer
        {
            ...
            {
                var emptySecret = Output.CreateSecret(0);
                _valkey = Output.Tuple<Input<Inputs.ValkeyValkeyGetArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        /// </summary>
        [Input("valkeyUserConfig")]
        public Input<Inputs.ValkeyValkeyUserConfigGetArgs>? ValkeyUserConfig { get; set; }

        public ValkeyState()
        {
        }
        public static new ValkeyState Empty => new ValkeyState();
    }
}
