...
export class Dragonfly extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.DragonflyComponent[]>;
    /**
     ...
     */
    declare public readonly dragonfly: pulumi.Output<outputs.DragonflyDragonfly>;
    /**
     ...
     */
    declare public readonly dragonflyUserConfig: pulumi.Output<outputs.DragonflyDragonflyUserConfig | undefined>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.DragonflyServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.DragonflyTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.DragonflyTechEmail[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DragonflyArgs | DragonflyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dragonfly"] = state?.dragonfly;
            resourceInputs["dragonflyUserConfig"] = state?.dragonflyUserConfig;
            ...
            resourceInputs["dragonflyUserConfig"] = args?.dragonflyUserConfig;
...
export interface DragonflyState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.DragonflyComponent>[] | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Dragonfly server provided values
     */
    dragonfly?: pulumi.Input<inputs.DragonflyDragonfly | undefined>;
    /**
     * Dragonfly user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    dragonflyUserConfig?: pulumi.Input<inputs.DragonflyDragonflyUserConfig | undefined>;
    /**
     * Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.DragonflyServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.DragonflyTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.DragonflyTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
