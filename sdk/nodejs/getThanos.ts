 ...
 */
export interface GetThanosArgs {
    /**
 ...
 */
export interface GetThanosResult {
    /**
     ...
     */
    readonly components: outputs.GetThanosComponent[];
    /**
     ...
     */
    readonly serviceIntegrations: outputs.GetThanosServiceIntegration[];
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     */
    readonly tags: outputs.GetThanosTag[];
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    readonly techEmails: outputs.GetThanosTechEmail[];
    /**
 ...
 * A collection of arguments for invoking getThanos.
 */
export interface GetThanosOutputArgs {
    /**
     * The name of the project this resource belongs to. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
     */
