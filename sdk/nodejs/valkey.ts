...
export class Valkey extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.ValkeyComponent[]>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.ValkeyServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.ValkeyTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.ValkeyTechEmail[] | undefined>;
    /**
     ...
     */
    declare public readonly valkey: pulumi.Output<outputs.ValkeyValkey>;
    /**
     ...
     */
    declare public readonly valkeyUserConfig: pulumi.Output<outputs.ValkeyValkeyUserConfig | undefined>;
    ...
    constructor(name: string, argsOrState?: ValkeyArgs | ValkeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["valkeyUserConfig"] = state?.valkeyUserConfig;
        } else {
            ...
            resourceInputs["valkeyUserConfig"] = args?.valkeyUserConfig;
...
export interface ValkeyState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.ValkeyComponent>[] | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.ValkeyServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.ValkeyTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.ValkeyTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
     ...
     * Valkey server provided values
     */
    valkey?: pulumi.Input<inputs.ValkeyValkey | undefined>;
    /**
     * Valkey user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    valkeyUserConfig?: pulumi.Input<inputs.ValkeyValkeyUserConfig | undefined>;
}
