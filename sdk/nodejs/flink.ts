...
export class Flink extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.FlinkComponent[]>;
    /**
     ...
     */
    declare public readonly flink: pulumi.Output<outputs.FlinkFlink>;
    /**
     ...
     */
    declare public readonly flinkUserConfig: pulumi.Output<outputs.FlinkFlinkUserConfig | undefined>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.FlinkServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.FlinkTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.FlinkTechEmail[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: FlinkArgs | FlinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["flink"] = state?.flink;
            resourceInputs["flinkUserConfig"] = state?.flinkUserConfig;
            ...
            resourceInputs["flinkUserConfig"] = args?.flinkUserConfig;
...
export interface FlinkState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.FlinkComponent>[] | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Values provided by the Flink server.
     */
    flink?: pulumi.Input<inputs.FlinkFlink | undefined>;
    /**
     * Flink user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    flinkUserConfig?: pulumi.Input<inputs.FlinkFlinkUserConfig | undefined>;
    /**
     * Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.FlinkServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.FlinkTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.FlinkTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
