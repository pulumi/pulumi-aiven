...
export interface GetKafkaKafkaUserConfig {
     ...
     */
    kafkaDiskless?: outputs.GetKafkaKafkaUserConfigKafkaDiskless;
    /**
...
export interface GetKafkaKafkaUserConfigKafka {
     ...
     */
    logMessageTimestampAfterMaxMs?: number;
    /**
     ...
     */
    logMessageTimestampBeforeMaxMs?: number;
    /**
...
export interface GetKafkaTopicListTopic {
     ...
     * Topic tags.
     */
    tags?: outputs.GetKafkaTopicListTopicTag[];
    /**
     * Topic description.
     */
...
export interface GetOpenSearchOpensearchUserConfigOpensearch {
     ...
     */
    segrep?: outputs.GetOpenSearchOpensearchUserConfigOpensearchSegrep;
    /**
...
export interface GetOpenSearchOpensearchUserConfigOpensearchSegrep {
    /**
...
export interface GetPgPgUserConfig {
    ...
    /**
     * Enable the pgStatPlans extension. Changing this parameter causes a service restart. Tracks execution plans for SQL queries. Default: `false`.
     */
...
export interface GetServiceIntegrationClickhouseKafkaUserConfigTable {
     ...
     */
    producerCompressionLevel?: number;
    /**
     ...
     */
    producerQueueBufferingMaxKbytes?: number;
    /**
     * The maximum number of messages to buffer before sending. Default: `100000`.
     */
    producerQueueBufferingMaxMessages?: number;
    /**
     ...
     */
    producerRequestRequiredAcks?: number;
    /**
...
export interface GetServiceIntegrationDatadogUserConfig {
     ...
     */
    datadogFunctionMetricsEnabled?: boolean;
    /**
     ...
     */
    datadogPgRelations?: outputs.GetServiceIntegrationDatadogUserConfigDatadogPgRelation[];
    /**
...
export interface GetServiceIntegrationDatadogUserConfigDatadogPgRelation {
    /**
...
export interface GetServiceIntegrationEndpointOpentelemetryUserConfig {
    /**
...
export interface KafkaKafkaUserConfig {
     ...
     * Kafka Diskless configuration values
     */
    kafkaDiskless?: outputs.KafkaKafkaUserConfigKafkaDiskless;
    /**
     * Enable Kafka-REST service. Default: `false`.
     */
    kafkaRest?: boolean;
...
export interface OpenSearchOpensearchUserConfigOpensearch {
     ...
     * Segment Replication Backpressure Settings
     */
    segrep?: outputs.OpenSearchOpensearchUserConfigOpensearchSegrep;
    /**
     * Shard indexing back pressure settings
     */
...
export interface ServiceIntegrationDatadogUserConfig {
     ...
     * Relations to collect PostgreSQL relation metrics for, such as table size, index statistics, row counts, vacuum ages and locks. No relation metrics are collected when unset
     */
    datadogPgRelations?: outputs.ServiceIntegrationDatadogUserConfigDatadogPgRelation[];
    /**
     * Enable Datadog PgBouncer Metric Tracking.
     */
    datadogPgbouncerEnabled?: boolean;
