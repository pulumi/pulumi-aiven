...
export class Thanos extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly components!: pulumi.Output<outputs.ThanosComponent[]>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.ThanosServiceIntegration[] | undefined>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.ThanosTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    public readonly techEmails!: pulumi.Output<outputs.ThanosTechEmail[] | undefined>;
    /**
     ...
     */
    public readonly thanos!: pulumi.Output<outputs.ThanosThanos>;
    /**
     * Thanos user configurable settings
     */
    public readonly thanosUserConfig!: pulumi.Output<outputs.ThanosThanosUserConfig | undefined>;
    ...
    constructor(name: string, argsOrState?: ThanosArgs | ThanosState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["thanos"] = state ? state.thanos : undefined;
            resourceInputs["thanosUserConfig"] = state ? state.thanosUserConfig : undefined;
        } else {
            ...
            resourceInputs["thanosUserConfig"] = args ? args.thanosUserConfig : undefined;
...
export interface ThanosState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.ThanosComponent>[]>;
    /**
     * Service disk space. Possible values depend on the service type, the cloud provider and the project. Therefore, reducing will result in the service rebalancing.
     *
     * @deprecated This will be removed in v5.0.0. Please use `additionalDiskSpace` to specify the space to be added to the default `diskSpace` defined by the plan.
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.ThanosServiceIntegration>[]>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.ThanosTag>[]>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.ThanosTechEmail>[]>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
     ...
     * Thanos server connection details.
     */
    thanos?: pulumi.Input<inputs.ThanosThanos>;
    /**
     * Thanos user configurable settings
     */
    thanosUserConfig?: pulumi.Input<inputs.ThanosThanosUserConfig>;
}
