...
export class Thanos extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ThanosState, opts?: pulumi.CustomResourceOptions): Thanos {
        return new Thanos(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/thanos:Thanos';

    /**
     * Returns true if the given object is an instance of Thanos.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Thanos {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Thanos.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.ThanosComponent[]>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.ThanosServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.ThanosTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.ThanosTechEmail[] | undefined>;
    /**
     ...
     */
    declare public readonly thanos: pulumi.Output<outputs.ThanosThanos>;
    /**
     ...
     */
    declare public readonly thanosUserConfig: pulumi.Output<outputs.ThanosThanosUserConfig | undefined>;
     ...
     */
    constructor(name: string, args: ThanosArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ThanosArgs | ThanosState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ThanosState | undefined;
            ...
            resourceInputs["thanos"] = state?.thanos;
            resourceInputs["thanosUserConfig"] = state?.thanosUserConfig;
        } else {
            const args = argsOrState as ThanosArgs | undefined;
            ...
            resourceInputs["thanos"] = args?.thanos ? pulumi.secret(args.thanos) : undefined;
            resourceInputs["thanosUserConfig"] = args?.thanosUserConfig;
        ...
        const secretOpts = { additionalSecretOutputs: ["servicePassword", "serviceUri", "thanos"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(Thanos.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ThanosState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.ThanosComponent>[] | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.ThanosServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.ThanosTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.ThanosTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
     ...
     * Thanos server connection details.
     */
    thanos?: pulumi.Input<inputs.ThanosThanos | undefined>;
    /**
     * Thanos user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    thanosUserConfig?: pulumi.Input<inputs.ThanosThanosUserConfig | undefined>;
}
