...
export class Kafka extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.KafkaComponent[]>;
    /**
     * Create a default wildcard Kafka ACL.
     */
    declare public readonly defaultAcl: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly kafkaUserConfig: pulumi.Output<outputs.KafkaKafkaUserConfig | undefined>;
    /**
     * Kafka server connection details.
     */
    declare public readonly kafkas: pulumi.Output<outputs.KafkaKafka[]>;
    /**
     ...
     */
    declare public readonly karapace: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.KafkaServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.KafkaTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.KafkaTechEmail[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: KafkaArgs | KafkaState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["kafkaUserConfig"] = state?.kafkaUserConfig;
            resourceInputs["kafkas"] = state?.kafkas;
            resourceInputs["karapace"] = state?.karapace;
            ...
            resourceInputs["kafkaUserConfig"] = args?.kafkaUserConfig;
            resourceInputs["kafkas"] = args?.kafkas ? pulumi.secret(args.kafkas) : undefined;
            resourceInputs["karapace"] = args?.karapace;
...
export interface KafkaState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.KafkaComponent>[] | undefined>;
    /**
     * Create a default wildcard Kafka ACL.
     */
    defaultAcl?: pulumi.Input<boolean | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Kafka user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    kafkaUserConfig?: pulumi.Input<inputs.KafkaKafkaUserConfig | undefined>;
    /**
     * Kafka server connection details.
     */
    kafkas?: pulumi.Input<pulumi.Input<inputs.KafkaKafka>[] | undefined>;
    /**
     * Switch the service to use [Karapace](https://aiven.io/docs/products/kafka/karapace) for schema registry and REST proxy. This attribute is deprecated, use `schemaRegistry` and `kafkaRest` instead.
     *
     * @deprecated Usage of this field is discouraged.
     */
    karapace?: pulumi.Input<boolean | undefined>;
    /**
     * Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.KafkaServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.KafkaTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.KafkaTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
