...
export class M3Aggregator extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly m3aggregators!: pulumi.Output<outputs.M3AggregatorM3aggregator[]>;
    /**
    ...
    constructor(name: string, argsOrState?: M3AggregatorArgs | M3AggregatorState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["m3aggregators"] = state ? state.m3aggregators : undefined;
            ...
            resourceInputs["m3aggregators"] = undefined /*out*/;
