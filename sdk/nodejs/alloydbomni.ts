...
export class Alloydbomni extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlloydbomniState, opts?: pulumi.CustomResourceOptions): Alloydbomni {
        return new Alloydbomni(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/alloydbomni:Alloydbomni';

    /**
     * Returns true if the given object is an instance of Alloydbomni.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Alloydbomni {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Alloydbomni.__pulumiType;
    }
     ...
     */
    public readonly alloydbomni!: pulumi.Output<outputs.AlloydbomniAlloydbomni>;
    /**
     ...
     */
    public readonly alloydbomniUserConfig!: pulumi.Output<outputs.AlloydbomniAlloydbomniUserConfig | undefined>;
    /**
     ...
     */
    public /*out*/ readonly components!: pulumi.Output<outputs.AlloydbomniComponent[]>;
    /**
     ...
     */
    public readonly serviceAccountCredentials!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.AlloydbomniServiceIntegration[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.AlloydbomniTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    public readonly techEmails!: pulumi.Output<outputs.AlloydbomniTechEmail[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AlloydbomniArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AlloydbomniArgs | AlloydbomniState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AlloydbomniState | undefined;
            resourceInputs["additionalDiskSpace"] = state ? state.additionalDiskSpace : undefined;
            resourceInputs["alloydbomni"] = state ? state.alloydbomni : undefined;
            resourceInputs["alloydbomniUserConfig"] = state ? state.alloydbomniUserConfig : undefined;
            ...
            const args = argsOrState as AlloydbomniArgs | undefined;
            ...
            resourceInputs["alloydbomni"] = args?.alloydbomni ? pulumi.secret(args.alloydbomni) : undefined;
            resourceInputs["alloydbomniUserConfig"] = args ? args.alloydbomniUserConfig : undefined;
        ...
        const secretOpts = { additionalSecretOutputs: ["alloydbomni", "serviceAccountCredentials", "servicePassword", "serviceUri"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(Alloydbomni.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AlloydbomniState {
    /**
     * Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30  GiB to scale your service. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.AlloydbomniServiceIntegration>[]>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.AlloydbomniTag>[]>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.AlloydbomniTechEmail>[]>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
 ...
 */
export interface AlloydbomniArgs {
    /**
     * Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30  GiB to scale your service. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
     */
    additionalDiskSpace?: pulumi.Input<string>;
