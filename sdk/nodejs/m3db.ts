...
export class M3Db extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: M3DbArgs | M3DbState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["m3db"] = state ? state.m3db : undefined;
            inputs["m3dbUserConfig"] = state ? state.m3dbUserConfig : undefined;
            ...
            inputs["m3db"] = args ? args.m3db : undefined;
            inputs["m3dbUserConfig"] = args ? args.m3dbUserConfig : undefined;
        ...
        super(M3Db.__pulumiType, name, inputs, opts);
    }
}
