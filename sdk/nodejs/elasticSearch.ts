...
export class ElasticSearch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aiven:index/elasticSearch:ElasticSearch';
     ...
     */
    public /*out*/ readonly components!: pulumi.Output<outputs.ElasticSearchComponent[]>;
    /**
     ...
     */
    public readonly elasticsearch!: pulumi.Output<outputs.ElasticSearchElasticsearch>;
    /**
     * defines Elasticsearch specific additional configuration options. 
     * The following configuration options available:
     */
    public readonly elasticsearchUserConfig!: pulumi.Output<outputs.ElasticSearchElasticsearchUserConfig | undefined>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.ElasticSearchServiceIntegration[] | undefined>;
    /**
...
export interface ElasticSearchState {
     ...
     * Service component information objects
     */
    readonly components?: pulumi.Input<pulumi.Input<inputs.ElasticSearchComponent>[]>;
    /**
     * Allow clients to connect to elasticsearch from the public 
     * internet for service nodes that are in a project VPC or another type of private network.
     */
    readonly elasticsearch?: pulumi.Input<inputs.ElasticSearchElasticsearch>;
    /**
     * defines Elasticsearch specific additional configuration options. 
     * The following configuration options available:
     */
    readonly elasticsearchUserConfig?: pulumi.Input<inputs.ElasticSearchElasticsearchUserConfig>;
    /**
     * day of week when maintenance operations should be performed. 
     * On monday, tuesday, wednesday, etc.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    readonly serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.ElasticSearchServiceIntegration>[]>;
    /**
     * specifies the actual name of the service. The name cannot be changed
     * later without destroying and re-creating the service so name should be picked based on
     * intended service usage rather than current attributes.
