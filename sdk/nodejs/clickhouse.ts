...
export class Clickhouse extends pulumi.CustomResource {
     ...
     */
    declare public readonly clickhouse: pulumi.Output<outputs.ClickhouseClickhouse>;
    /**
     ...
     */
    declare public readonly clickhouseUserConfig: pulumi.Output<outputs.ClickhouseClickhouseUserConfig | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.ClickhouseComponent[]>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.ClickhouseServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.ClickhouseTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.ClickhouseTechEmail[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ClickhouseArgs | ClickhouseState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["clickhouseUserConfig"] = state?.clickhouseUserConfig;
            ...
            resourceInputs["clickhouseUserConfig"] = args?.clickhouseUserConfig;
...
export interface ClickhouseState {
     ...
     * Values provided by the ClickHouse server.
     */
    clickhouse?: pulumi.Input<inputs.ClickhouseClickhouse | undefined>;
    /**
     * Clickhouse user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    clickhouseUserConfig?: pulumi.Input<inputs.ClickhouseClickhouseUserConfig | undefined>;
    /**
     * The cloud provider and region the service is hosted in. The format is `provider-region`, for example: `google-europe-west1`. The [available cloud regions](https://aiven.io/docs/platform/reference/list_of_clouds) can differ per project and service. Changing this value [migrates the service to another cloud provider or region](https://aiven.io/docs/platform/howto/migrate-services-cloud-region). The migration runs in the background and includes a DNS update to redirect traffic to the new region. Most services experience no downtime, but some databases may have a brief interruption during DNS propagation.
     */
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.ClickhouseComponent>[] | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.ClickhouseServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.ClickhouseTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.ClickhouseTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
