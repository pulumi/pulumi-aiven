...
export class Pg extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly components: pulumi.Output<outputs.PgComponent[]>;
    /**
     ...
     */
    declare public readonly pg: pulumi.Output<outputs.PgPg>;
    /**
     ...
     */
    declare public readonly pgUserConfig: pulumi.Output<outputs.PgPgUserConfig | undefined>;
    /**
     ...
     */
    declare public readonly serviceIntegrations: pulumi.Output<outputs.PgServiceIntegration[]>;
    /**
     ...
     */
    declare public readonly tags: pulumi.Output<outputs.PgTag[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    declare public readonly techEmails: pulumi.Output<outputs.PgTechEmail[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PgArgs | PgState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["pgUserConfig"] = state?.pgUserConfig;
            ...
            resourceInputs["pgUserConfig"] = args?.pgUserConfig;
...
export interface PgState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.PgComponent>[] | undefined>;
    /**
     * Service disk space to set. Possible values depend on the service type, the cloud provider and the project. Reducing will result in the service rebalancing.
     */
     ...
     * Values provided by the PostgreSQL server.
     */
    pg?: pulumi.Input<inputs.PgPg | undefined>;
    /**
     * Pg user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
     */
    pgUserConfig?: pulumi.Input<inputs.PgPgUserConfig | undefined>;
    /**
     * Defines what kind of computing resources are allocated for the service. Plan names must be lowercase alphanumeric (e.g., `business-8`, `myPlan16`). It can be changed after creation, though there are some restrictions when going to a smaller plan such as the new plan must have sufficient amount of disk space to store all current data and switching to a plan with fewer nodes might not be supported. The basic plan names are `hobbyist`, `startup-x`, `business-x` and `premium-x` where `x` is (roughly) the amount of memory on each node (also other attributes like number of CPUs and amount of disk space varies but naming is based on memory). The available options can be seen from the [Aiven pricing page](https://aiven.io/pricing).
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.PgServiceIntegration>[] | undefined>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.PgTag>[] | undefined>;
    /**
     * The email addresses for [service contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.PgTechEmail>[] | undefined>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent unintentional service deletion. This does not shield against deleting databases or topics but for services with backups much of the content can at least be restored from backup in case accidental deletion is done.
     */
