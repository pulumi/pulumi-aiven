...
class InfluxdbUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] username: The actual name of the InfluxDB User. To set up proper dependencies please refer to this variable as a reference. This
...
class InfluxdbUser(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InfluxdbUserArgs.__new__(InfluxdbUserArgs)
        ...
        super(InfluxdbUser, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'InfluxdbUser':
        """
        ...
        __props__ = _InfluxdbUserState.__new__(_InfluxdbUserState)
