...
class ClickhouseArgs:
    ...
    def _configure(
        ...
        if clickhouse_user_config is None and 'clickhouseUserConfig' in kwargs:
            clickhouse_user_config = kwargs['clickhouseUserConfig']
    ...
    def service_integrations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClickhouseServiceIntegrationArgs']]]]):
...
class _ClickhouseState:
    ...
    @property
    @pulumi.getter
    def components(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClickhouseComponentArgs']]]]:
        """
    ...
    @components.setter
    def components(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClickhouseComponentArgs']]]]):
...
class Clickhouse(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            clickhouse_user_config = _utilities.configure(clickhouse_user_config, ClickhouseClickhouseUserConfigArgs, True)
