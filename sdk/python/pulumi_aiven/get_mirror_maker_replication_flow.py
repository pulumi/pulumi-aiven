...
class GetMirrorMakerReplicationFlowResult:
    ...
    def config_properties_excludes(self) -> Sequence[builtins.str]:
        """
    ...
    def emit_backward_heartbeats_enabled(self) -> builtins.bool:
        """
    ...
    def emit_heartbeats_enabled(self) -> builtins.bool:
        """
    ...
    def exactly_once_delivery_enabled(self) -> builtins.bool:
        """
    ...
    def offset_syncs_topic_location(self) -> builtins.str:
        """
    ...
    def replication_policy_class(self) -> builtins.str:
        """
    ...
    def source_cluster(self) -> builtins.str:
        """
    ...
    def sync_group_offsets_enabled(self) -> builtins.bool:
        """
    ...
    def sync_group_offsets_interval_seconds(self) -> builtins.int:
        """
    ...
    def target_cluster(self) -> builtins.str:
        """
    ...
    def topics_blacklists(self) -> Sequence[builtins.str]:
        """
...
def get_mirror_maker_replication_flow(project: Optional[builtins.str] = None,
                                      service_name: Optional[builtins.str] = None,
                                      source_cluster: Optional[builtins.str] = None,
                                      target_cluster: Optional[builtins.str] = None,
    ...
    :param builtins.str service_name: The name of the project this resource belongs to. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
    :param builtins.str source_cluster: Source cluster alias. Maximum length: `128`.
    :param builtins.str target_cluster: Target cluster alias. Maximum length: `128`.
    """
    __args__ = dict()
...
def get_mirror_maker_replication_flow_output(project: Optional[pulumi.Input[builtins.str]] = None,
