...
class InfluxDb(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 service_integrations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InfluxDbServiceIntegrationArgs']]]]] = None,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cloud_name: Optional[pulumi.Input[str]] = None,
            components: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['InfluxDbComponentArgs']]]]] = None,
            influxdb: Optional[pulumi.Input[pulumi.InputType['InfluxDbInfluxdbArgs']]] = None,
            influxdb_user_config: Optional[pulumi.Input[pulumi.InputType['InfluxDbInfluxdbUserConfigArgs']]] = None,
            maintenance_window_dow: Optional[pulumi.Input[str]] = None,
            maintenance_window_time: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] cloud_name: Cloud the service runs in
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['InfluxDbComponentArgs']]]] components: Service component information objects
        :param pulumi.Input[pulumi.InputType['InfluxDbInfluxdbArgs']] influxdb: InfluxDB server provided values
        :param pulumi.Input[pulumi.InputType['InfluxDbInfluxdbUserConfigArgs']] influxdb_user_config: InfluxDB user configurable settings
        :param pulumi.Input[str] maintenance_window_dow: Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: Time of day when maintenance operations should be performed. UTC time in HH:mm:ss format.
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.InfluxDbComponent']:
        """
    ...
    @property
    @pulumi.getter
    def influxdb(self) -> 'outputs.InfluxDbInfluxdb':
        """
    ...
    def influxdb_user_config(self) -> Optional['outputs.InfluxDbInfluxdbUserConfig']:
        """
    ...
    def service_integrations(self) -> Optional[List['outputs.InfluxDbServiceIntegration']]:
        """
