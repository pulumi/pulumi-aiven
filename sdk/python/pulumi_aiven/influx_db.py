...
class InfluxDb(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[float] service_port: InfluxDB port.
    ...
    @property
    @pulumi.getter
    def components(self) -> pulumi.Output[List['outputs.InfluxDbComponent']]:
        """
    ...
    def service_integrations(self) -> pulumi.Output[Optional[List['outputs.InfluxDbServiceIntegration']]]:
        """
