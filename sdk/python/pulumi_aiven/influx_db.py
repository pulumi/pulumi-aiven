...
class InfluxDbArgs:
    ...
    def _configure(
        ...
        if influxdb_user_config is None and 'influxdbUserConfig' in kwargs:
            influxdb_user_config = kwargs['influxdbUserConfig']
...
class InfluxDb(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InfluxDbArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            influxdb_user_config = _utilities.configure(influxdb_user_config, InfluxDbInfluxdbUserConfigArgs, True)
    ...
    def get(resource_name: str,
        ...
        __props__ = _InfluxDbState.__new__(_InfluxDbState)
