...
class FlinkArgs:
    ...
    def _configure(
        ...
        if flink_user_config is None and 'flinkUserConfig' in kwargs:
            flink_user_config = kwargs['flinkUserConfig']
    ...
    @flink.setter
    def flink(self, value: Optional[pulumi.Input['FlinkFlinkArgs']]):
    ...
    def flink_user_config(self, value: Optional[pulumi.Input['FlinkFlinkUserConfigArgs']]):
    ...
    def service_integrations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FlinkServiceIntegrationArgs']]]]:
        """
    ...
    def service_integrations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FlinkServiceIntegrationArgs']]]]):
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FlinkTagArgs']]]]:
        """
...
class _FlinkState:
    ...
    @property
    @pulumi.getter
    def components(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FlinkComponentArgs']]]]:
        """
    ...
    @components.setter
    def components(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FlinkComponentArgs']]]]):
...
class Flink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            flink = _utilities.configure(flink, FlinkFlinkArgs, True)
            __props__.__dict__["flink"] = flink
            flink_user_config = _utilities.configure(flink_user_config, FlinkFlinkUserConfigArgs, True)
