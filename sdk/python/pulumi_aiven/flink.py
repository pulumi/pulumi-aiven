...
class FlinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] disk_space: The disk space of the service, possible values depend on the service type, the cloud provider and the project. Reducing
