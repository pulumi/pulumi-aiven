...
class GetKafkaConnectResult:
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.GetKafkaConnectComponentResult']:
    ...
    def service_integrations(self) -> Optional[List['outputs.GetKafkaConnectServiceIntegrationResult']]:
...
def get_kafka_connect(cloud_name: Optional[str] = None,
                      components: Optional[List[pulumi.InputType['GetKafkaConnectComponentArgs']]] = None,
                      ...
                      service_integrations: Optional[List[pulumi.InputType['GetKafkaConnectServiceIntegrationArgs']]] = None,
    ...
    :param float service_port: Kafka Connect port.
