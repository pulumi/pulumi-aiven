...
def get_mysql_user(project: Optional[builtins.str] = None,
    ...
    :param builtins.str username: The name of the MySQL service user. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
    """
    __args__ = dict()
...
def get_mysql_user_output(project: Optional[pulumi.Input[builtins.str]] = None,
