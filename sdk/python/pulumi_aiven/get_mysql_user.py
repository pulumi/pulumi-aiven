...
class GetMysqlUserResult:
    ...
    """
    def __init__(__self__, access_cert=None, access_key=None, authentication=None, id=None, mysql_grants=None, password=None, password_encryption_type=None, project=None, service_name=None, timeouts=None, type=None, username=None):
...
def get_mysql_user(project: Optional[_builtins.str] = None,
    ...
    example = aiven.get_mysql_user(project="my-project",
