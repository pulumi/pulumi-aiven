...
class GetGrafanaResult:
    ...
    def service_integrations(self) -> Optional[Sequence['outputs.GetGrafanaServiceIntegrationResult']]:
...
def get_grafana(cloud_name: Optional[str] = None,
                components: Optional[Sequence[pulumi.InputType['GetGrafanaComponentArgs']]] = None,
                ...
                service_integrations: Optional[Sequence[pulumi.InputType['GetGrafanaServiceIntegrationArgs']]] = None,
    ...
    :param str cloud_name: defines where the cloud provider and region where the service is hosted
           ...
           like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
           [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
    :param pulumi.InputType['GetGrafanaGrafanaArgs'] grafana: Grafana specific server provided values.
    :param pulumi.InputType['GetGrafanaGrafanaUserConfigArgs'] grafana_user_config: defines Grafana specific additional configuration options. The following 
           configuration options available:
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value
           ...
           creation but doing so triggers migration to new servers so the operation can take
           significant amount of time to complete if the service has a lot of data.
    :param str service_host: Grafana hostname.
    :param str service_name: specifies the actual name of the service. The name cannot be changed
           later without destroying and re-creating the service so name should be picked based on
           intended service usage rather than current attributes.
    :param str service_password: Password used for connecting to the Grafana service, if applicable.
    :param int service_port: Grafana port.
    :param str service_uri: URI for connecting to the Grafana service.
    :param str service_username: Username used for connecting to the Grafana service, if applicable.
...
def get_grafana_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                       components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetGrafanaComponentArgs']]]]] = None,
                       grafana: Optional[pulumi.Input[Optional[pulumi.InputType['GetGrafanaGrafanaArgs']]]] = None,
                       grafana_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetGrafanaGrafanaUserConfigArgs']]]] = None,
                       ...
                       service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetGrafanaServiceIntegrationArgs']]]]] = None,
