...
class AccountArgs:
    def __init__(__self__, *,
                 ...
                 primary_billing_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Account resource.
        :param pulumi.Input[builtins.str] name: Account name
        :param pulumi.Input[builtins.str] primary_billing_group_id: Billing group id
        """
        if name is not None:
    ...
    def primary_billing_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Billing group id
        """
    ...
    def primary_billing_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AccountState:
    def __init__(__self__, *,
                 ...
                 is_account_owner: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_account_owner: If true, user is part of the owners team for this account
        :param pulumi.Input[builtins.str] name: Account name
        :param pulumi.Input[builtins.str] owner_team_id: Owner team id
        :param pulumi.Input[builtins.str] primary_billing_group_id: Billing group id
    ...
    @_utilities.deprecated("""The new Organization resource won't have it, and will not have a replacement.""")
    def is_account_owner(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_account_owner(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Account(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            primary_billing_group_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Account':
        """
    ...
    @pulumi.getter(name="isAccountOwner")
    @_utilities.deprecated("""The new Organization resource won't have it, and will not have a replacement.""")
    def is_account_owner(self) -> pulumi.Output[builtins.bool]:
        """
        If true, user is part of the owners team for this account
        """
        return pulumi.get(self, "is_account_owner")
    ...
    @pulumi.getter(name="ownerTeamId")
    @_utilities.deprecated("""The new Organization resource won't have it, and will not have a replacement.""")
    def owner_team_id(self) -> pulumi.Output[builtins.str]:
        """
        Owner team id
        """
        return pulumi.get(self, "owner_team_id")
    ...
    @pulumi.getter(name="primaryBillingGroupId")
    @_utilities.deprecated("""The new Organization resource won't have it, and will not have a replacement.""")
    def primary_billing_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Billing group id
        """
        return pulumi.get(self, "primary_billing_group_id")
