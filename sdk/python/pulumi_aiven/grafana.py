...
class Grafana(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 service_integrations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GrafanaServiceIntegrationArgs']]]]] = None,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cloud_name: Optional[pulumi.Input[str]] = None,
            components: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GrafanaComponentArgs']]]]] = None,
            grafana: Optional[pulumi.Input[pulumi.InputType['GrafanaGrafanaArgs']]] = None,
            grafana_user_config: Optional[pulumi.Input[pulumi.InputType['GrafanaGrafanaUserConfigArgs']]] = None,
            maintenance_window_dow: Optional[pulumi.Input[str]] = None,
            maintenance_window_time: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] cloud_name: Cloud the service runs in
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['GrafanaComponentArgs']]]] components: Service component information objects
        :param pulumi.Input[pulumi.InputType['GrafanaGrafanaArgs']] grafana: Grafana server provided values
        :param pulumi.Input[pulumi.InputType['GrafanaGrafanaUserConfigArgs']] grafana_user_config: Grafana user configurable settings
        :param pulumi.Input[str] maintenance_window_dow: Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: Time of day when maintenance operations should be performed. UTC time in HH:mm:ss format.
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.GrafanaComponent']:
        """
    ...
    @property
    @pulumi.getter
    def grafana(self) -> 'outputs.GrafanaGrafana':
        """
    ...
    def grafana_user_config(self) -> Optional['outputs.GrafanaGrafanaUserConfig']:
        """
    ...
    def service_integrations(self) -> Optional[List['outputs.GrafanaServiceIntegration']]:
        """
