...
class ElasticSearchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ElasticSearchElasticsearchUserConfigArgs'] elasticsearch_user_config: Elasticsearch user configurable settings
...
class _ElasticSearchState:
    def __init__(__self__, *,
                 ...
                 elasticsearch_user_config: Optional[pulumi.Input['ElasticSearchElasticsearchUserConfigArgs']] = None,
                 elasticsearches: Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchElasticsearchArgs']]]] = None,
                 maintenance_window_dow: Optional[pulumi.Input[str]] = None,
                 maintenance_window_time: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input['ElasticSearchElasticsearchUserConfigArgs'] elasticsearch_user_config: Elasticsearch user configurable settings
        :param pulumi.Input[Sequence[pulumi.Input['ElasticSearchElasticsearchArgs']]] elasticsearches: Elasticsearch server provided values
        :param pulumi.Input[str] maintenance_window_dow: Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: Time of day when maintenance operations should be performed. UTC time in HH:mm:ss format.
        :param pulumi.Input[str] plan: Defines what kind of computing resources are allocated for the service. It can be changed after creation, though there are some restrictions when going to a smaller plan such as the new plan must have sufficient amount of disk space to store all current data and switching to a plan with fewer nodes might not be supported. The basic plan names are `hobbyist`, `startup-x`, `business-x` and `premium-x` where `x` is (roughly) the amount of memory on each node (also other attributes like number of CPUs and amount of disk space varies but naming is based on memory). The available options can be seem from the [Aiven pricing page](https://aiven.io/pricing).
        :param pulumi.Input[str] project: Identifies the project this resource belongs to. To set up proper dependencies please refer to this variable as a reference. This property cannot be changed, doing so forces recreation of the resource.
    ...
    @property
    @pulumi.getter
    def elasticsearches(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchElasticsearchArgs']]]]:
        """
    ...
    def elasticsearches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchElasticsearchArgs']]]]):
...
class ElasticSearch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            disk_space_used: Optional[pulumi.Input[str]] = None,
            elasticsearch_user_config: Optional[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchUserConfigArgs']]] = None,
            elasticsearches: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchArgs']]]]] = None,
            maintenance_window_dow: Optional[pulumi.Input[str]] = None,
            maintenance_window_time: Optional[pulumi.Input[str]] = None,
            plan: Optional[pulumi.Input[str]] = None,
            project: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] disk_space_used: Disk space that service is currently using
        :param pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchUserConfigArgs']] elasticsearch_user_config: Elasticsearch user configurable settings
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchArgs']]]] elasticsearches: Elasticsearch server provided values
        :param pulumi.Input[str] maintenance_window_dow: Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: Time of day when maintenance operations should be performed. UTC time in HH:mm:ss format.
        :param pulumi.Input[str] plan: Defines what kind of computing resources are allocated for the service. It can be changed after creation, though there are some restrictions when going to a smaller plan such as the new plan must have sufficient amount of disk space to store all current data and switching to a plan with fewer nodes might not be supported. The basic plan names are `hobbyist`, `startup-x`, `business-x` and `premium-x` where `x` is (roughly) the amount of memory on each node (also other attributes like number of CPUs and amount of disk space varies but naming is based on memory). The available options can be seem from the [Aiven pricing page](https://aiven.io/pricing).
        :param pulumi.Input[str] project: Identifies the project this resource belongs to. To set up proper dependencies please refer to this variable as a reference. This property cannot be changed, doing so forces recreation of the resource.
    ...
    @property
    @pulumi.getter
    def elasticsearches(self) -> pulumi.Output[Sequence['outputs.ElasticSearchElasticsearch']]:
        """
        Elasticsearch server provided values
        """
        return pulumi.get(self, "elasticsearches")
