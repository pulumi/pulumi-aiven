...
class ElasticSearch(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.ElasticSearchComponent']:
        """
    ...
    @property
    @pulumi.getter
    def elasticsearch(self) -> 'outputs.ElasticSearchElasticsearch':
        """
    ...
    def elasticsearch_user_config(self) -> Optional['outputs.ElasticSearchElasticsearchUserConfig']:
        """
    ...
    def service_integrations(self) -> Optional[List['outputs.ElasticSearchServiceIntegration']]:
        """
