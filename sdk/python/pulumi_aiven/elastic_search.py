...
class ElasticSearchArgs:
    def __init__(__self__, *,
                 ...
                 elasticsearch: Optional[pulumi.Input['ElasticSearchElasticsearchArgs']] = None,
                 elasticsearch_user_config: Optional[pulumi.Input['ElasticSearchElasticsearchUserConfigArgs']] = None,
                 maintenance_window_dow: Optional[pulumi.Input[str]] = None,
                 maintenance_window_time: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input[str]] = None,
                 project_vpc_id: Optional[pulumi.Input[str]] = None,
                 service_integrations: Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchServiceIntegrationArgs']]]] = None,
        ...
        :param pulumi.Input['ElasticSearchElasticsearchArgs'] elasticsearch: Allow clients to connect to elasticsearch from the public 
               internet for service nodes that are in a project VPC or another type of private network.
        :param pulumi.Input['ElasticSearchElasticsearchUserConfigArgs'] elasticsearch_user_config: defines Elasticsearch specific additional configuration options. 
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ElasticSearchServiceIntegrationArgs']]] service_integrations: Service integrations to specify when creating a service. Not applied after initial service creation
    ...
    @property
    @pulumi.getter
    def elasticsearch(self) -> Optional[pulumi.Input['ElasticSearchElasticsearchArgs']]:
        """
    ...
    def elasticsearch(self, value: Optional[pulumi.Input['ElasticSearchElasticsearchArgs']]):
        pulumi.set(self, "elasticsearch", value)

    @property
    @pulumi.getter(name="elasticsearchUserConfig")
    def elasticsearch_user_config(self) -> Optional[pulumi.Input['ElasticSearchElasticsearchUserConfigArgs']]:
        """
    ...
    def elasticsearch_user_config(self, value: Optional[pulumi.Input['ElasticSearchElasticsearchUserConfigArgs']]):
    ...
    def service_integrations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchServiceIntegrationArgs']]]]:
        """
    ...
    def service_integrations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchServiceIntegrationArgs']]]]):
...
class _ElasticSearchState:
    def __init__(__self__, *,
                 cloud_name: Optional[pulumi.Input[str]] = None,
                 components: Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchComponentArgs']]]] = None,
                 elasticsearch: Optional[pulumi.Input['ElasticSearchElasticsearchArgs']] = None,
                 elasticsearch_user_config: Optional[pulumi.Input['ElasticSearchElasticsearchUserConfigArgs']] = None,
                 maintenance_window_dow: Optional[pulumi.Input[str]] = None,
                 maintenance_window_time: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] cloud_name: defines where the cloud provider and region where the service is hosted
               ...
               like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
               [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
        :param pulumi.Input[Sequence[pulumi.Input['ElasticSearchComponentArgs']]] components: Service component information objects
        :param pulumi.Input['ElasticSearchElasticsearchArgs'] elasticsearch: Allow clients to connect to elasticsearch from the public 
               internet for service nodes that are in a project VPC or another type of private network.
        :param pulumi.Input['ElasticSearchElasticsearchUserConfigArgs'] elasticsearch_user_config: defines Elasticsearch specific additional configuration options. 
               The following configuration options available:
        ...
        :param pulumi.Input[str] project_vpc_id: optionally specifies the VPC the service should run in. If the value
               ...
               creation but doing so triggers migration to new servers so the operation can take
               significant amount of time to complete if the service has a lot of data.
        :param pulumi.Input[str] service_host: Elasticsearch hostname.
        :param pulumi.Input[Sequence[pulumi.Input['ElasticSearchServiceIntegrationArgs']]] service_integrations: Service integrations to specify when creating a service. Not applied after initial service creation
        :param pulumi.Input[str] service_name: specifies the actual name of the service. The name cannot be changed
               later without destroying and re-creating the service so name should be picked based on
               intended service usage rather than current attributes.
        :param pulumi.Input[str] service_password: Password used for connecting to the Elasticsearch service, if applicable.
        :param pulumi.Input[int] service_port: Elasticsearch port.
        :param pulumi.Input[str] service_type: Aiven internal service type code
        :param pulumi.Input[str] service_uri: URI for connecting to the Elasticsearch service.
        :param pulumi.Input[str] service_username: Username used for connecting to the Elasticsearch service, if applicable.
    ...
    @property
    @pulumi.getter
    def components(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchComponentArgs']]]]:
        """
    ...
    @components.setter
    def components(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ElasticSearchComponentArgs']]]]):
...
class ElasticSearch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cloud_name: Optional[pulumi.Input[str]] = None,
                 elasticsearch: Optional[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchArgs']]] = None,
                 elasticsearch_user_config: Optional[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchUserConfigArgs']]] = None,
                 maintenance_window_dow: Optional[pulumi.Input[str]] = None,
                 maintenance_window_time: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 project_vpc_id: Optional[pulumi.Input[str]] = None,
                 service_integrations: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ElasticSearchServiceIntegrationArgs']]]]] = None,
                 service_name: Optional[pulumi.Input[str]] = None,
                 termination_protection: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] cloud_name: defines where the cloud provider and region where the service is hosted
               ...
               like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
               [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
        :param pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchArgs']] elasticsearch: Allow clients to connect to elasticsearch from the public 
               internet for service nodes that are in a project VPC or another type of private network.
        :param pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchUserConfigArgs']] elasticsearch_user_config: defines Elasticsearch specific additional configuration options. 
               The following configuration options available:
        :param pulumi.Input[str] maintenance_window_dow: day of week when maintenance operations should be performed. 
               On monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: time of day when maintenance operations should be performed. 
        ...
        :param pulumi.Input[str] project_vpc_id: optionally specifies the VPC the service should run in. If the value
               ...
               creation but doing so triggers migration to new servers so the operation can take
               significant amount of time to complete if the service has a lot of data.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ElasticSearchServiceIntegrationArgs']]]] service_integrations: Service integrations to specify when creating a service. Not applied after initial service creation
        :param pulumi.Input[str] service_name: specifies the actual name of the service. The name cannot be changed
               later without destroying and re-creating the service so name should be picked based on
               intended service usage rather than current attributes.
        :param pulumi.Input[bool] termination_protection: prevents the service from being deleted. It is recommended to
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cloud_name: Optional[pulumi.Input[str]] = None,
            components: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ElasticSearchComponentArgs']]]]] = None,
            elasticsearch: Optional[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchArgs']]] = None,
            elasticsearch_user_config: Optional[pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchUserConfigArgs']]] = None,
            maintenance_window_dow: Optional[pulumi.Input[str]] = None,
            maintenance_window_time: Optional[pulumi.Input[str]] = None,
            ...
            service_username: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            termination_protection: Optional[pulumi.Input[bool]] = None) -> 'ElasticSearch':
        """
        ...
        :param pulumi.Input[str] cloud_name: defines where the cloud provider and region where the service is hosted
               ...
               like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
               [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ElasticSearchComponentArgs']]]] components: Service component information objects
        :param pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchArgs']] elasticsearch: Allow clients to connect to elasticsearch from the public 
               internet for service nodes that are in a project VPC or another type of private network.
        :param pulumi.Input[pulumi.InputType['ElasticSearchElasticsearchUserConfigArgs']] elasticsearch_user_config: defines Elasticsearch specific additional configuration options. 
               The following configuration options available:
    ...
    @property
    @pulumi.getter
    def components(self) -> pulumi.Output[Sequence['outputs.ElasticSearchComponent']]:
        """
        Service component information objects
        """
        return pulumi.get(self, "components")
    ...
    @property
    @pulumi.getter
    def elasticsearch(self) -> pulumi.Output['outputs.ElasticSearchElasticsearch']:
        """
        Allow clients to connect to elasticsearch from the public 
        internet for service nodes that are in a project VPC or another type of private network.
        """
    ...
    @property
    @pulumi.getter(name="elasticsearchUserConfig")
    def elasticsearch_user_config(self) -> pulumi.Output[Optional['outputs.ElasticSearchElasticsearchUserConfig']]:
        """
        defines Elasticsearch specific additional configuration options. 
        The following configuration options available:
        """
    ...
    @property
    @pulumi.getter(name="serviceIntegrations")
    def service_integrations(self) -> pulumi.Output[Optional[Sequence['outputs.ElasticSearchServiceIntegration']]]:
        """
        Service integrations to specify when creating a service. Not applied after initial service creation
        """
        return pulumi.get(self, "service_integrations")
