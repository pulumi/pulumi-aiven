...
class Cassandra(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def cassandra(self) -> 'outputs.CassandraCassandra':
        """
    ...
    def cassandra_user_config(self) -> Optional['outputs.CassandraCassandraUserConfig']:
        """
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.CassandraComponent']:
        """
    ...
    def service_integrations(self) -> Optional[List['outputs.CassandraServiceIntegration']]:
        """
