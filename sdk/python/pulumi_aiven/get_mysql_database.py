...
def get_mysql_database(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: The name of the database. Changing this property forces recreation of the resource.
...
def get_mysql_database_output(database_name: Optional[pulumi.Input[builtins.str]] = None,
