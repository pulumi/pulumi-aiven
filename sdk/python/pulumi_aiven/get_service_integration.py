...
def get_service_integration(destination_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str integration_type: Type of the service integration. The possible values are `alert_triage_kafka`, `alertmanager`, `autoscaler`, `caching`, `clickhouse_credentials`, `clickhouse_kafka`, `clickhouse_postgresql`, `dashboard`, `datadog`, `datahub_metadata_ingestion`, `datasource`, `disaster_recovery`, `external_aws_cloudwatch_logs`, `external_aws_cloudwatch_metrics`, `external_elasticsearch_logs`, `external_google_cloud_logging`, `external_opensearch_logs`, `flink`, `flink_external_bigquery`, `flink_external_kafka`, `flink_external_postgresql`, `internal_connectivity`, `jolokia`, `kafka_connect`, `kafka_connect_postgresql`, `kafka_logs`, `kafka_mirrormaker`, `logs`, `metrics`, `opensearch_cross_cluster_replication`, `opensearch_cross_cluster_search`, `opentelemetry`, `postgresql_clickhouse_cdc`, `prometheus`, `read_replica`, `rsyslog`, `schema_registry_proxy`, `service_composition`, `stresstester`, `thanos_distributed_query`, `thanos_migrate`, `thanos_object_storage`, `thanoscompactor`, `thanosquery`, `thanosruler`, `thanosstore`, `vector` and `vmalert`.
