...
class GetElasticSearchResult:
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.GetElasticSearchComponentResult']:
    ...
    def service_integrations(self) -> Optional[List['outputs.GetElasticSearchServiceIntegrationResult']]:
...
def get_elastic_search(cloud_name: Optional[str] = None,
                       components: Optional[List[pulumi.InputType['GetElasticSearchComponentArgs']]] = None,
                       ...
                       service_integrations: Optional[List[pulumi.InputType['GetElasticSearchServiceIntegrationArgs']]] = None,
    ...
    :param float service_port: Elasticsearch port.
