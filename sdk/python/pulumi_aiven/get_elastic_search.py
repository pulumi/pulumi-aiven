...
class GetElasticSearchResult:
    ...
    def elasticsearch_user_configs(self) -> Sequence['outputs.GetElasticSearchElasticsearchUserConfigResult']:
        """
    ...
    @property
    @pulumi.getter
    def elasticsearches(self) -> Sequence['outputs.GetElasticSearchElasticsearchResult']:
        """
    ...
    def service_integrations(self) -> Sequence['outputs.GetElasticSearchServiceIntegrationResult']:
        """
...
def get_elastic_search(project: Optional[str] = None,
...
def get_elastic_search_output(project: Optional[pulumi.Input[str]] = None,
