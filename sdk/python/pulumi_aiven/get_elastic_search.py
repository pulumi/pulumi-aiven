...
class GetElasticSearchResult:
    ...
    @property
    @pulumi.getter
    def components(self) -> Sequence['outputs.GetElasticSearchComponentResult']:
        return pulumi.get(self, "components")

    @property
    @pulumi.getter
    def elasticsearch(self) -> 'outputs.GetElasticSearchElasticsearchResult':
        """
    ...
    def elasticsearch_user_config(self) -> Optional['outputs.GetElasticSearchElasticsearchUserConfigResult']:
        """
    ...
    def service_integrations(self) -> Optional[Sequence['outputs.GetElasticSearchServiceIntegrationResult']]:
...
def get_elastic_search(cloud_name: Optional[str] = None,
                       components: Optional[Sequence[pulumi.InputType['GetElasticSearchComponentArgs']]] = None,
                       elasticsearch: Optional[pulumi.InputType['GetElasticSearchElasticsearchArgs']] = None,
                       elasticsearch_user_config: Optional[pulumi.InputType['GetElasticSearchElasticsearchUserConfigArgs']] = None,
                       ...
                       service_integrations: Optional[Sequence[pulumi.InputType['GetElasticSearchServiceIntegrationArgs']]] = None,
    ...
    :param str cloud_name: defines where the cloud provider and region where the service is hosted
           ...
           like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
           [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
    :param pulumi.InputType['GetElasticSearchElasticsearchArgs'] elasticsearch: Elasticsearch specific server provided values.
    :param pulumi.InputType['GetElasticSearchElasticsearchUserConfigArgs'] elasticsearch_user_config: defines Elasticsearch specific additional configuration options. 
           The following configuration options available:
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value
           ...
           creation but doing so triggers migration to new servers so the operation can take
           significant amount of time to complete if the service has a lot of data.
    :param str service_host: Elasticsearch hostname.
    :param str service_name: specifies the actual name of the service. The name cannot be changed
           later without destroying and re-creating the service so name should be picked based on
           intended service usage rather than current attributes.
    :param str service_password: Password used for connecting to the Elasticsearch service, if applicable.
    :param int service_port: Elasticsearch port.
    :param str service_uri: URI for connecting to the Elasticsearch service.
    :param str service_username: Username used for connecting to the Elasticsearch service, if applicable.
    ...
    __ret__ = pulumi.runtime.invoke('aiven:index/getElasticSearch:getElasticSearch', __args__, opts=opts, typ=GetElasticSearchResult).value
...
@_utilities.lift_output_func(get_elastic_search)
def get_elastic_search_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                              components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetElasticSearchComponentArgs']]]]] = None,
                              elasticsearch: Optional[pulumi.Input[Optional[pulumi.InputType['GetElasticSearchElasticsearchArgs']]]] = None,
                              elasticsearch_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetElasticSearchElasticsearchUserConfigArgs']]]] = None,
                              ...
                              service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetElasticSearchServiceIntegrationArgs']]]]] = None,
