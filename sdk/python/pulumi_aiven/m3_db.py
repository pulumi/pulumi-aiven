...
class M3DbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['M3DbM3dbArgs'] m3db: M3 specific server provided values.
        :param pulumi.Input['M3DbM3dbUserConfigArgs'] m3db_user_config: defines M3 specific additional configuration options. The following 
...
class M3Db(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] cloud_name: defines where the cloud provider and region where the service is hosted
               ...
               like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
               [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
        :param pulumi.Input[pulumi.InputType['M3DbM3dbArgs']] m3db: M3 specific server provided values.
        :param pulumi.Input[pulumi.InputType['M3DbM3dbUserConfigArgs']] m3db_user_config: defines M3 specific additional configuration options. The following 
               configuration options available:
        :param pulumi.Input[str] maintenance_window_dow: day of week when maintenance operations should be performed. 
               On monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: time of day when maintenance operations should be performed. 
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(M3DbArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['m3db'] = m3db
            __props__['m3db_user_config'] = m3db_user_config
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[str] project_vpc_id: optionally specifies the VPC the service should run in. If the value
               ...
               creation but doing so triggers migration to new servers so the operation can take
               significant amount of time to complete if the service has a lot of data.
        :param pulumi.Input[str] service_host: M3 hostname.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['M3DbServiceIntegrationArgs']]]] service_integrations: Service integrations to specify when creating a service. Not applied after initial service creation
        :param pulumi.Input[str] service_name: specifies the actual name of the service. The name cannot be changed
               later without destroying and re-creating the service so name should be picked based on
               intended service usage rather than current attributes.
        :param pulumi.Input[str] service_password: Password used for connecting to the M3 service, if applicable.
        :param pulumi.Input[int] service_port: M3 port.
        :param pulumi.Input[str] service_type: Aiven internal service type code
        :param pulumi.Input[str] service_uri: URI for connecting to the M3 service.
        :param pulumi.Input[str] service_username: Username used for connecting to the M3 service, if applicable.
