...
class GetOpenSearchResult:
    ...
    """
    def __init__(__self__, cloud_name=None, components=None, id=None, maintenance_window_dow=None, maintenance_window_time=None, opensearch=None, opensearch_user_config=None, plan=None, project=None, project_vpc_id=None, service_host=None, service_integrations=None, service_name=None, service_password=None, service_port=None, service_type=None, service_uri=None, service_username=None, state=None, termination_protection=None):
    ...
    @property
    @pulumi.getter
    def opensearch(self) -> 'outputs.GetOpenSearchOpensearchResult':
        """
    ...
    def opensearch_user_config(self) -> Optional['outputs.GetOpenSearchOpensearchUserConfigResult']:
        """
    ...
    def service_integrations(self) -> Optional[Sequence['outputs.GetOpenSearchServiceIntegrationResult']]:
...
def get_open_search(cloud_name: Optional[str] = None,
                    components: Optional[Sequence[pulumi.InputType['GetOpenSearchComponentArgs']]] = None,
                    maintenance_window_dow: Optional[str] = None,
                    maintenance_window_time: Optional[str] = None,
                    opensearch: Optional[pulumi.InputType['GetOpenSearchOpensearchArgs']] = None,
                    opensearch_user_config: Optional[pulumi.InputType['GetOpenSearchOpensearchUserConfigArgs']] = None,
                    plan: Optional[str] = None,
                    project: Optional[str] = None,
                    project_vpc_id: Optional[str] = None,
                    service_host: Optional[str] = None,
                    service_integrations: Optional[Sequence[pulumi.InputType['GetOpenSearchServiceIntegrationArgs']]] = None,
    ...
    :param str cloud_name: defines where the cloud provider and region where the service is hosted in. This can be changed freely
           after service is created. Changing the value will trigger a potentially lengthy migration process for the service.
           Format is cloud provider name
           (`aws`, `azure`, `do` `google`, `upcloud`, etc.), dash, and the cloud provider specific region name. These are
           documented on each Cloud provider's own support articles,
           like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
           [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
    :param str maintenance_window_dow: day of week when maintenance operations should be performed. On monday, tuesday, wednesday,
           etc.
    :param str maintenance_window_time: time of day when maintenance operations should be performed. UTC time in HH:mm:ss format.
    :param pulumi.InputType['GetOpenSearchOpensearchArgs'] opensearch: Allow clients to connect to opensearch from the public internet for service nodes that are in a
           project VPC or another type of private network.
    :param pulumi.InputType['GetOpenSearchOpensearchUserConfigArgs'] opensearch_user_config: defines Opensearch specific additional configuration options. The following configuration
           options available:
    :param str plan: defines what kind of computing resources are allocated for the service. It can be changed after creation,
           though there are some restrictions when going to a smaller plan such as the new plan must have sufficient amount of
           disk space to store all current data and switching to a plan with fewer nodes might not be supported. The basic plan
           names are `hobbyist`, `startup-x`, `business-x` and `premium-x` where `x` is
           (roughly) the amount of memory on each node (also other attributes like number of CPUs and amount of disk space varies
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value is not set the service is not
           run inside a VPC. When set, the value should be given as a reference as shown above to set up dependencies correctly
           and the VPC must be in the same cloud and region as the service itself. Project can be freely moved to and from VPC
           after creation but doing so triggers migration to new servers so the operation can take significant amount of time to
           complete if the service has a lot of data.
    :param str service_host: Opensearch hostname.
    :param str service_name: specifies the actual name of the service. The name cannot be changed later without
           ...
           attributes.
    :param str service_password: Password used for connecting to the Opensearch service, if applicable.
    :param int service_port: Opensearch port.
    :param str service_uri: URI for connecting to the Opensearch service.
    :param str service_username: Username used for connecting to the Opensearch service, if applicable.
    :param str state: Service state.
    :param bool termination_protection: prevents the service from being deleted. It is recommended to set this to `true` for all
           production services to prevent unintentional service deletion. This does not shield against deleting databases or
           topics but for services with backups much of the content can at least be restored from backup in case accidental
           deletion is done.
    """
...
def get_open_search_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                           components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetOpenSearchComponentArgs']]]]] = None,
                           ...
                           opensearch: Optional[pulumi.Input[Optional[pulumi.InputType['GetOpenSearchOpensearchArgs']]]] = None,
                           opensearch_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetOpenSearchOpensearchUserConfigArgs']]]] = None,
                           ...
                           service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetOpenSearchServiceIntegrationArgs']]]]] = None,
