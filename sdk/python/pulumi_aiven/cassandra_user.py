...
class CassandraUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] username: The actual name of the Cassandra User. To set up proper dependencies please refer to this variable as a reference. This
...
class CassandraUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'CassandraUser':
        """
        ...
        __props__ = _CassandraUserState.__new__(_CassandraUserState)
