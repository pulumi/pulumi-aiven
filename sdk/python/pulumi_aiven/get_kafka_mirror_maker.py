...
class GetKafkaMirrorMakerResult:
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.GetKafkaMirrorMakerComponentResult']:
    ...
    def service_integrations(self) -> Optional[List['outputs.GetKafkaMirrorMakerServiceIntegrationResult']]:
...
def get_kafka_mirror_maker(cloud_name: Optional[str] = None,
                           components: Optional[List[pulumi.InputType['GetKafkaMirrorMakerComponentArgs']]] = None,
                           ...
                           service_integrations: Optional[List[pulumi.InputType['GetKafkaMirrorMakerServiceIntegrationArgs']]] = None,
    ...
    :param float service_port: Kafka Mirror Maker 2 port.
