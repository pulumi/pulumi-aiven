...
class PgArgs:
    ...
    def _configure(
        ...
        if pg_user_config is None and 'pgUserConfig' in kwargs:
            pg_user_config = kwargs['pgUserConfig']
...
class Pg(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            pg = _utilities.configure(pg, PgPgArgs, True)
            __props__.__dict__["pg"] = pg
            pg_user_config = _utilities.configure(pg_user_config, PgPgUserConfigArgs, True)
