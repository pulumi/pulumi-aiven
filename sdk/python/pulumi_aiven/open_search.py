...
class OpenSearchArgs:
    def __init__(__self__, *,
                 ...
                 opensearch: Optional[pulumi.Input['OpenSearchOpensearchArgs']] = None,
        ...
        :param pulumi.Input[str] service_name: specifies the actual name of the service. The name cannot be changed later without
               ...
               attributes.
        :param pulumi.Input[str] cloud_name: defines where the cloud provider and region where the service is hosted in. This can be
        ...
        :param pulumi.Input[str] maintenance_window_dow: day of week when maintenance operations should be performed. On monday, tuesday,
               wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: time of day when maintenance operations should be performed. UTC time in HH:mm:
               ss format.
        :param pulumi.Input['OpenSearchOpensearchArgs'] opensearch: Allow clients to connect to opensearch from the public internet for service nodes
               that are in a project VPC or another type of private network.
        :param pulumi.Input['OpenSearchOpensearchUserConfigArgs'] opensearch_user_config: defines Opensearch specific additional configuration options. The following
               configuration options available:
        :param pulumi.Input[str] plan: defines what kind of computing resources are allocated for the service. It can be changed after
        ...
        :param pulumi.Input[str] project_vpc_id: optionally specifies the VPC the service should run in. If the value is not set the
        ...
        :param pulumi.Input[bool] termination_protection: prevents the service from being deleted. It is recommended to set this to `true`
    ...
    @property
    @pulumi.getter
    def opensearch(self) -> Optional[pulumi.Input['OpenSearchOpensearchArgs']]:
        """
    ...
    @opensearch.setter
    def opensearch(self, value: Optional[pulumi.Input['OpenSearchOpensearchArgs']]):
...
class _OpenSearchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] project_vpc_id: optionally specifies the VPC the service should run in. If the value is not set the
               ...
               moved to and from VPC after creation but doing so triggers migration to new servers so the operation can take
               significant amount of time to complete if the service has a lot of data.
        :param pulumi.Input[str] service_host: Opensearch hostname.
        :param pulumi.Input[Sequence[pulumi.Input['OpenSearchServiceIntegrationArgs']]] service_integrations: Service integrations to specify when creating a service. Not applied after initial service creation
        :param pulumi.Input[str] service_name: specifies the actual name of the service. The name cannot be changed later without
               destroying and re-creating the service so name should be picked based on intended service usage rather than current
               attributes.
        :param pulumi.Input[str] service_password: Password used for connecting to the Opensearch service, if applicable.
        :param pulumi.Input[int] service_port: Opensearch port.
        :param pulumi.Input[str] service_type: Aiven internal service type code
        :param pulumi.Input[str] service_uri: URI for connecting to the Opensearch service.
        :param pulumi.Input[str] service_username: Username used for connecting to the Opensearch service, if applicable.
...
class OpenSearch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 maintenance_window_dow: Optional[pulumi.Input[str]] = None,
                 maintenance_window_time: Optional[pulumi.Input[str]] = None,
                 opensearch: Optional[pulumi.Input[pulumi.InputType['OpenSearchOpensearchArgs']]] = None,
        ...
        :param pulumi.Input[str] maintenance_window_time: time of day when maintenance operations should be performed. UTC time in HH:mm:
               ss format.
        :param pulumi.Input[pulumi.InputType['OpenSearchOpensearchArgs']] opensearch: Allow clients to connect to opensearch from the public internet for service nodes
               that are in a project VPC or another type of private network.
        :param pulumi.Input[pulumi.InputType['OpenSearchOpensearchUserConfigArgs']] opensearch_user_config: defines Opensearch specific additional configuration options. The following
               configuration options available:
        :param pulumi.Input[str] plan: defines what kind of computing resources are allocated for the service. It can be changed after
               creation, though there are some restrictions when going to a smaller plan such as the new plan must have sufficient
               amount of disk space to store all current data and switching to a plan with fewer nodes might not be supported. The
    ...
    @property
    @pulumi.getter
    def opensearch(self) -> pulumi.Output['outputs.OpenSearchOpensearch']:
        """
        Allow clients to connect to opensearch from the public internet for service nodes
        that are in a project VPC or another type of private network.
        """
