...
class GetPgResult:
    ...
    def service_integrations(self) -> Sequence['outputs.GetPgServiceIntegrationResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetPgTagResult']:
        """
...
def get_pg(project: Optional[_builtins.str] = None,
...
def get_pg_output(project: pulumi.Input[Optional[_builtins.str]] = None,
