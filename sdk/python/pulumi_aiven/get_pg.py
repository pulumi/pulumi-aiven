...
def get_pg(cloud_name: Optional[str] = None,
    ...
    :param str maintenance_window_time: time of day when maintenance operations should be performed. 
           UTC time in HH:mm:ss format.
    :param pulumi.InputType['GetPgPgArgs'] pg: PostgreSQL specific server provided values.
    :param pulumi.InputType['GetPgPgUserConfigArgs'] pg_user_config: defines PostgreSQL specific additional configuration options. The following 
           configuration options available:
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value
           ...
           creation but doing so triggers migration to new servers so the operation can take
           significant amount of time to complete if the service has a lot of data.
    :param str service_host: PostgreSQL hostname.
...
def get_pg_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                  components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetPgComponentArgs']]]]] = None,
                  ...
                  pg: Optional[pulumi.Input[Optional[pulumi.InputType['GetPgPgArgs']]]] = None,
                  pg_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetPgPgUserConfigArgs']]]] = None,
                  ...
                  service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetPgServiceIntegrationArgs']]]]] = None,
