...
class _KafkaMirrorMakerState:
    ...
    def _configure(
        ...
        if kafka_mirrormaker_user_config is None and 'kafkaMirrormakerUserConfig' in kwargs:
            kafka_mirrormaker_user_config = kwargs['kafkaMirrormakerUserConfig']
        if kafka_mirrormakers is None and 'kafkaMirrormakers' in kwargs:
            kafka_mirrormakers = kwargs['kafkaMirrormakers']
        if maintenance_window_dow is None and 'maintenanceWindowDow' in kwargs:
            maintenance_window_dow = kwargs['maintenanceWindowDow']
        if maintenance_window_time is None and 'maintenanceWindowTime' in kwargs:
            maintenance_window_time = kwargs['maintenanceWindowTime']
...
class KafkaMirrorMaker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            kafka_mirrormaker_user_config = _utilities.configure(kafka_mirrormaker_user_config, KafkaMirrorMakerKafkaMirrormakerUserConfigArgs, True)
