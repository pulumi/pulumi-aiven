...
class RedisArgs:
    ...
    def _configure(
        ...
        if redis_user_config is None and 'redisUserConfig' in kwargs:
            redis_user_config = kwargs['redisUserConfig']
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RedisTagArgs']]]]:
        """
...
class Redis(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            redis_user_config = _utilities.configure(redis_user_config, RedisRedisUserConfigArgs, True)
