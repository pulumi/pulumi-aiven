...
__all__ = [
    'GetM3AggregatorResult',
    'AwaitableGetM3AggregatorResult',
    'get_m3_aggregator',
    'get_m3_aggregator_output',
]

@pulumi.output_type
class GetM3AggregatorResult:
    """
    A collection of values returned by getM3Aggregator.
    """
    def __init__(__self__, cloud_name=None, components=None, id=None, m3aggregator=None, m3aggregator_user_config=None, maintenance_window_dow=None, maintenance_window_time=None, plan=None, project=None, project_vpc_id=None, service_host=None, service_integrations=None, service_name=None, service_password=None, service_port=None, service_type=None, service_uri=None, service_username=None, state=None, termination_protection=None):
        ...
        if m3aggregator and not isinstance(m3aggregator, dict):
            raise TypeError("Expected argument 'm3aggregator' to be a dict")
    ...
    @property
    @pulumi.getter
    def m3aggregator(self) -> 'outputs.GetM3AggregatorM3aggregatorResult':
        """
    ...
    def m3aggregator_user_config(self) -> Optional['outputs.GetM3AggregatorM3aggregatorUserConfigResult']:
        """
    ...
    def service_integrations(self) -> Optional[Sequence['outputs.GetM3AggregatorServiceIntegrationResult']]:
...
class AwaitableGetM3AggregatorResult(GetM3AggregatorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetM3AggregatorResult(
            cloud_name=self.cloud_name,
            components=self.components,
            id=self.id,
            m3aggregator=self.m3aggregator,
...
def get_m3_aggregator(cloud_name: Optional[str] = None,
                      components: Optional[Sequence[pulumi.InputType['GetM3AggregatorComponentArgs']]] = None,
                      m3aggregator: Optional[pulumi.InputType['GetM3AggregatorM3aggregatorArgs']] = None,
                      m3aggregator_user_config: Optional[pulumi.InputType['GetM3AggregatorM3aggregatorUserConfigArgs']] = None,
                      ...
                      service_integrations: Optional[Sequence[pulumi.InputType['GetM3AggregatorServiceIntegrationArgs']]] = None,
    ...
    :param str cloud_name: defines where the cloud provider and region where the service is hosted
           ...
           like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
           [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
    :param pulumi.InputType['GetM3AggregatorM3aggregatorArgs'] m3aggregator: M3 Aggregator specific server provided values.
    :param pulumi.InputType['GetM3AggregatorM3aggregatorUserConfigArgs'] m3aggregator_user_config: defines M3 Aggregator specific additional configuration options. 
           The following configuration options available:
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value
           ...
           creation but doing so triggers migration to new servers so the operation can take
           significant amount of time to complete if the service has a lot of data.
    :param str service_host: M3 Aggregator hostname.
    :param str service_name: specifies the actual name of the service. The name cannot be changed
           later without destroying and re-creating the service so name should be picked based on
           intended service usage rather than current attributes.
    :param str service_password: Password used for connecting to the M3 Aggregator service, if applicable.
    :param int service_port: M3 Aggregator port.
    :param str service_uri: URI for connecting to the M3 Aggregator service.
    :param str service_username: Username used for connecting to the M3 Aggregator service, if applicable.
    ...
    __args__['m3aggregator'] = m3aggregator
    ...
    __ret__ = pulumi.runtime.invoke('aiven:index/getM3Aggregator:getM3Aggregator', __args__, opts=opts, typ=GetM3AggregatorResult).value

    return AwaitableGetM3AggregatorResult(
        cloud_name=__ret__.cloud_name,
        components=__ret__.components,
        id=__ret__.id,
        m3aggregator=__ret__.m3aggregator,
...
def get_m3_aggregator_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                             components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetM3AggregatorComponentArgs']]]]] = None,
                             m3aggregator: Optional[pulumi.Input[Optional[pulumi.InputType['GetM3AggregatorM3aggregatorArgs']]]] = None,
                             m3aggregator_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetM3AggregatorM3aggregatorUserConfigArgs']]]] = None,
                             ...
                             service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetM3AggregatorServiceIntegrationArgs']]]]] = None,
