...
def get_m3db_user(project: Optional[builtins.str] = None,
    ...
    **After 30 April 2025** all running Aiven for M3 services will be powered off and deleted, making data from these services inaccessible.
    ...
    :param builtins.str username: Name of the M3DB service user. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
    """
    __args__ = dict()
...
def get_m3db_user_output(project: Optional[pulumi.Input[builtins.str]] = None,
