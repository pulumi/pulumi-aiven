...
def get_kafka(cloud_name=None, components=None, default_acl=None, kafka=None, kafka_user_config=None, maintenance_window_dow=None, maintenance_window_time=None, plan=None, project=None, project_vpc_id=None, service_host=None, service_integrations=None, service_name=None, service_password=None, service_port=None, service_type=None, service_uri=None, service_username=None, state=None, termination_protection=None, opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('aiven:index/getKafka:getKafka', __args__, opts=opts).value

    return AwaitableGetKafkaResult(
        cloud_name=__ret__.get('cloudName'),
        components=__ret__.get('components'),
        default_acl=__ret__.get('defaultAcl'),
        id=__ret__.get('id'),
