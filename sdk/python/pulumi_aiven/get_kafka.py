...
class GetKafkaResult:
    ...
    """
    def __init__(__self__, cloud_name=None, components=None, default_acl=None, id=None, kafka=None, kafka_user_config=None, maintenance_window_dow=None, maintenance_window_time=None, plan=None, project=None, project_vpc_id=None, service_host=None, service_integrations=None, service_name=None, service_password=None, service_port=None, service_type=None, service_uri=None, service_username=None, state=None, termination_protection=None):
    ...
    @property
    @pulumi.getter
    def kafka(self) -> 'outputs.GetKafkaKafkaResult':
        """
    ...
    def kafka_user_config(self) -> Optional['outputs.GetKafkaKafkaUserConfigResult']:
        """
...
def get_kafka(cloud_name: Optional[str] = None,
    ...
    :param str cloud_name: defines where the cloud provider and region where the service is hosted
           ...
           like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
           [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
    :param pulumi.InputType['GetKafkaKafkaArgs'] kafka: Kafka server provided values:
    :param pulumi.InputType['GetKafkaKafkaUserConfigArgs'] kafka_user_config: defines Kafka specific additional configuration options. The following 
           configuration options available:
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value
           ...
           creation but doing so triggers migration to new servers so the operation can take
           significant amount of time to complete if the service has a lot of data.
    :param str service_host: Kafka hostname.
    ...
    __args__['defaultAcl'] = default_acl
    ...
    return AwaitableGetKafkaResult(
        ...
        default_acl=__ret__.default_acl,
        id=__ret__.id,
        kafka=__ret__.kafka,
...
def get_kafka_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                     components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetKafkaComponentArgs']]]]] = None,
                     default_acl: Optional[pulumi.Input[Optional[bool]]] = None,
                     kafka: Optional[pulumi.Input[Optional[pulumi.InputType['GetKafkaKafkaArgs']]]] = None,
                     kafka_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetKafkaKafkaUserConfigArgs']]]] = None,
                     ...
                     service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetKafkaServiceIntegrationArgs']]]]] = None,
