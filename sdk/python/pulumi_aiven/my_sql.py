...
class MySqlArgs:
    ...
    def _configure(
        ...
        if mysql_user_config is None and 'mysqlUserConfig' in kwargs:
            mysql_user_config = kwargs['mysqlUserConfig']
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MySqlTagArgs']]]]:
        """
...
class MySql(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            mysql_user_config = _utilities.configure(mysql_user_config, MySqlMysqlUserConfigArgs, True)
