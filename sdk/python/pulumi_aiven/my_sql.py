...
class MySql(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.MySqlComponent']:
        """
    ...
    @property
    @pulumi.getter
    def mysql(self) -> 'outputs.MySqlMysql':
        """
    ...
    def mysql_user_config(self) -> Optional['outputs.MySqlMysqlUserConfig']:
        """
    ...
    def service_integrations(self) -> Optional[List['outputs.MySqlServiceIntegration']]:
        """
