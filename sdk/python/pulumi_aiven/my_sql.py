...
class MySql(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, cloud_name=None, maintenance_window_dow=None, maintenance_window_time=None, mysql=None, mysql_user_config=None, plan=None, project=None, project_vpc_id=None, service_integrations=None, service_name=None, termination_protection=None, __props__=None, __name__=None, __opts__=None):
        """
