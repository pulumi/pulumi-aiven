...
__all__ = [
    'GetCassandraResult',
    'AwaitableGetCassandraResult',
    'get_cassandra',
    'get_cassandra_output',
]

@pulumi.output_type
class GetCassandraResult:
    """
    ...
    @property
    @pulumi.getter
    def cassandra(self) -> 'outputs.GetCassandraCassandraResult':
        """
    ...
    def cassandra_user_config(self) -> Optional['outputs.GetCassandraCassandraUserConfigResult']:
        """
    ...
    def service_integrations(self) -> Optional[Sequence['outputs.GetCassandraServiceIntegrationResult']]:
...
class AwaitableGetCassandraResult(GetCassandraResult):
...
def get_cassandra(cassandra: Optional[pulumi.InputType['GetCassandraCassandraArgs']] = None,
                  cassandra_user_config: Optional[pulumi.InputType['GetCassandraCassandraUserConfigArgs']] = None,
                  cloud_name: Optional[str] = None,
                  components: Optional[Sequence[pulumi.InputType['GetCassandraComponentArgs']]] = None,
                  ...
                  service_integrations: Optional[Sequence[pulumi.InputType['GetCassandraServiceIntegrationArgs']]] = None,
    ...
    :param pulumi.InputType['GetCassandraCassandraArgs'] cassandra: Cassandra specific server provided values.
    :param pulumi.InputType['GetCassandraCassandraUserConfigArgs'] cassandra_user_config: defines Cassandra specific additional configuration options. 
           The following configuration options available:
    ...
    __ret__ = pulumi.runtime.invoke('aiven:index/getCassandra:getCassandra', __args__, opts=opts, typ=GetCassandraResult).value
...
def get_cassandra_output(cassandra: Optional[pulumi.Input[Optional[pulumi.InputType['GetCassandraCassandraArgs']]]] = None,
                         cassandra_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetCassandraCassandraUserConfigArgs']]]] = None,
                         cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                         components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetCassandraComponentArgs']]]]] = None,
                         ...
                         service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetCassandraServiceIntegrationArgs']]]]] = None,
