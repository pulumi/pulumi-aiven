...
class GetM3DbResult:
    ...
    """
    def __init__(__self__, cloud_name=None, components=None, id=None, m3db=None, m3db_user_config=None, maintenance_window_dow=None, maintenance_window_time=None, plan=None, project=None, project_vpc_id=None, service_host=None, service_integrations=None, service_name=None, service_password=None, service_port=None, service_type=None, service_uri=None, service_username=None, state=None, termination_protection=None):
        ...
        if m3db and not isinstance(m3db, dict):
            raise TypeError("Expected argument 'm3db' to be a dict")
        pulumi.set(__self__, "m3db", m3db)
        if m3db_user_config and not isinstance(m3db_user_config, dict):
            raise TypeError("Expected argument 'm3db_user_config' to be a dict")
    ...
    @property
    @pulumi.getter
    def m3db(self) -> 'outputs.GetM3DbM3dbResult':
        """
    ...
    def m3db_user_config(self) -> Optional['outputs.GetM3DbM3dbUserConfigResult']:
        """
    ...
    def service_integrations(self) -> Optional[Sequence['outputs.GetM3DbServiceIntegrationResult']]:
...
class AwaitableGetM3DbResult(GetM3DbResult):
    ...
    def __await__(self):
        ...
        return GetM3DbResult(
            ...
            id=self.id,
            m3db=self.m3db,
            m3db_user_config=self.m3db_user_config,
...
def get_m3_db(cloud_name: Optional[str] = None,
              components: Optional[Sequence[pulumi.InputType['GetM3DbComponentArgs']]] = None,
              m3db: Optional[pulumi.InputType['GetM3DbM3dbArgs']] = None,
              m3db_user_config: Optional[pulumi.InputType['GetM3DbM3dbUserConfigArgs']] = None,
              ...
              service_integrations: Optional[Sequence[pulumi.InputType['GetM3DbServiceIntegrationArgs']]] = None,
    ...
    :param str cloud_name: defines where the cloud provider and region where the service is hosted
           ...
           like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
           [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
    :param pulumi.InputType['GetM3DbM3dbArgs'] m3db: M3 specific server provided values.
    :param pulumi.InputType['GetM3DbM3dbUserConfigArgs'] m3db_user_config: defines M3 specific additional configuration options. The following 
           configuration options available:
    ...
    :param str project_vpc_id: optionally specifies the VPC the service should run in. If the value
           ...
           creation but doing so triggers migration to new servers so the operation can take
           significant amount of time to complete if the service has a lot of data.
    :param str service_host: M3 hostname.
    :param str service_name: specifies the actual name of the service. The name cannot be changed
           later without destroying and re-creating the service so name should be picked based on
           intended service usage rather than current attributes.
    :param str service_password: Password used for connecting to the M3 service, if applicable.
    :param int service_port: M3 port.
    :param str service_uri: URI for connecting to the M3 service.
    :param str service_username: Username used for connecting to the M3 service, if applicable.
    ...
    __args__['m3db'] = m3db
    __args__['m3dbUserConfig'] = m3db_user_config
    ...
    return AwaitableGetM3DbResult(
        ...
        id=__ret__.id,
        m3db=__ret__.m3db,
        m3db_user_config=__ret__.m3db_user_config,
...
def get_m3_db_output(cloud_name: Optional[pulumi.Input[Optional[str]]] = None,
                     components: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetM3DbComponentArgs']]]]] = None,
                     m3db: Optional[pulumi.Input[Optional[pulumi.InputType['GetM3DbM3dbArgs']]]] = None,
                     m3db_user_config: Optional[pulumi.Input[Optional[pulumi.InputType['GetM3DbM3dbUserConfigArgs']]]] = None,
                     ...
                     service_integrations: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetM3DbServiceIntegrationArgs']]]]] = None,
