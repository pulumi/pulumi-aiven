...
def get_account_authentication(account_id: Optional[str] = None,
    ...
    return AwaitableGetAccountAuthenticationResult(
        ...
        saml_digest_algorithm=__ret__.saml_digest_algorithm,
        saml_entity_id=__ret__.saml_entity_id,
        saml_field_mappings=__ret__.saml_field_mappings,
        saml_idp_login_allowed=__ret__.saml_idp_login_allowed,
        saml_idp_url=__ret__.saml_idp_url,
        saml_metadata_url=__ret__.saml_metadata_url,
        saml_signature_algorithm=__ret__.saml_signature_algorithm,
        saml_variant=__ret__.saml_variant,
        type=__ret__.type,
