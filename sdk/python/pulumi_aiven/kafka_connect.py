...
class KafkaConnect(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, cloud_name=None, kafka_connect=None, kafka_connect_user_config=None, maintenance_window_dow=None, maintenance_window_time=None, plan=None, project=None, project_vpc_id=None, service_integrations=None, service_name=None, termination_protection=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[dict] kafka_connect: Kafka Connect server provided values
        :param pulumi.Input[dict] kafka_connect_user_config: Kafka Connect user configurable settings
    ...
    @staticmethod
    def get(resource_name, id, opts=None, cloud_name=None, components=None, kafka_connect=None, kafka_connect_user_config=None, maintenance_window_dow=None, maintenance_window_time=None, plan=None, project=None, project_vpc_id=None, service_host=None, service_integrations=None, service_name=None, service_password=None, service_port=None, service_type=None, service_uri=None, service_username=None, state=None, termination_protection=None):
        """
