...
class KafkaConnectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['KafkaConnectKafkaConnectUserConfigArgs'] kafka_connect_user_config: Kafka_connect user configurable settings
...
class KafkaConnect(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] disk_space: The disk space of the service, possible values depend on the service type, the cloud provider and the project. Reducing
               will result in the service rebalancing.
        :param pulumi.Input[pulumi.InputType['KafkaConnectKafkaConnectUserConfigArgs']] kafka_connect_user_config: Kafka_connect user configurable settings
        :param pulumi.Input[str] maintenance_window_dow: Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
        :param pulumi.Input[str] maintenance_window_time: Time of day when maintenance operations should be performed. UTC time in HH:mm:ss format.
        :param pulumi.Input[str] plan: Defines what kind of computing resources are allocated for the service. It can be changed after creation, though there
               are some restrictions when going to a smaller plan such as the new plan must have sufficient amount of disk space to
