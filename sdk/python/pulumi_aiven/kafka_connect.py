...
class KafkaConnect(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def components(self) -> List['outputs.KafkaConnectComponent']:
        """
    ...
    def kafka_connect(self) -> 'outputs.KafkaConnectKafkaConnect':
        """
    ...
    def kafka_connect_user_config(self) -> Optional['outputs.KafkaConnectKafkaConnectUserConfig']:
        """
    ...
    def service_integrations(self) -> Optional[List['outputs.KafkaConnectServiceIntegration']]:
        """
