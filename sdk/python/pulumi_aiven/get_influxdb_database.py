...
def get_influxdb_database(database_name: Optional[_builtins.str] = None,
...
def get_influxdb_database_output(database_name: Optional[pulumi.Input[_builtins.str]] = None,
