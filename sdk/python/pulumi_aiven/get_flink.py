...
def get_flink(project: Optional[_builtins.str] = None,
    ...
    return AwaitableGetFlinkResult(
        ...
        flink_user_configs=pulumi.get(__ret__, 'flink_user_configs'),
...
def get_flink_output(project: pulumi.Input[Optional[_builtins.str]] = None,
