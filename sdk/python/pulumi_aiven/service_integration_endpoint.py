...
class ServiceIntegrationEndpointArgs:
    def __init__(__self__, *,
                 ...
                 autoscaler_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointAutoscalerUserConfigArgs']] = None,
                 datadog_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointDatadogUserConfigArgs']] = None,
                 external_aws_cloudwatch_logs_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgs']] = None,
                 external_aws_cloudwatch_metrics_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgs']] = None,
                 external_aws_s3_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsS3UserConfigArgs']] = None,
                 external_azure_blob_storage_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgs']] = None,
                 external_clickhouse_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalClickhouseUserConfigArgs']] = None,
                 external_elasticsearch_logs_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgs']] = None,
                 external_google_cloud_bigquery: pulumi.Input[Optional['ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgs']] = None,
                 external_google_cloud_logging_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgs']] = None,
                 external_kafka_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalKafkaUserConfigArgs']] = None,
                 external_mysql_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalMysqlUserConfigArgs']] = None,
                 external_object_storage_config_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgs']] = None,
                 external_opensearch_logs_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgs']] = None,
                 external_postgresql: pulumi.Input[Optional['ServiceIntegrationEndpointExternalPostgresqlArgs']] = None,
                 external_prometheus_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalPrometheusUserConfigArgs']] = None,
                 external_schema_registry_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgs']] = None,
                 jolokia_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointJolokiaUserConfigArgs']] = None,
                 opentelemetry_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointOpentelemetryUserConfigArgs']] = None,
                 prometheus_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointPrometheusUserConfigArgs']] = None,
                 rsyslog_user_config: pulumi.Input[Optional['ServiceIntegrationEndpointRsyslogUserConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['ServiceIntegrationEndpointOpentelemetryUserConfigArgs'] opentelemetry_user_config: Opentelemetry user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        ...
        if external_object_storage_config_user_config is not None:
            pulumi.set(__self__, "external_object_storage_config_user_config", external_object_storage_config_user_config)
        ...
        if opentelemetry_user_config is not None:
            pulumi.set(__self__, "opentelemetry_user_config", opentelemetry_user_config)
    ...
    def autoscaler_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointAutoscalerUserConfigArgs']]:
        """
    ...
    def autoscaler_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointAutoscalerUserConfigArgs']]):
        pulumi.set(self, "autoscaler_user_config", value)

    @_builtins.property
    @pulumi.getter(name="datadogUserConfig")
    def datadog_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointDatadogUserConfigArgs']]:
        """
    ...
    def datadog_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointDatadogUserConfigArgs']]):
        pulumi.set(self, "datadog_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalAwsCloudwatchLogsUserConfig")
    def external_aws_cloudwatch_logs_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgs']]:
        """
    ...
    def external_aws_cloudwatch_logs_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgs']]):
        pulumi.set(self, "external_aws_cloudwatch_logs_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalAwsCloudwatchMetricsUserConfig")
    def external_aws_cloudwatch_metrics_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgs']]:
        """
    ...
    def external_aws_cloudwatch_metrics_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgs']]):
        pulumi.set(self, "external_aws_cloudwatch_metrics_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalAwsS3UserConfig")
    def external_aws_s3_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsS3UserConfigArgs']]:
        """
    ...
    def external_aws_s3_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAwsS3UserConfigArgs']]):
        pulumi.set(self, "external_aws_s3_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalAzureBlobStorageUserConfig")
    def external_azure_blob_storage_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgs']]:
        """
    ...
    def external_azure_blob_storage_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgs']]):
        pulumi.set(self, "external_azure_blob_storage_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalClickhouseUserConfig")
    def external_clickhouse_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalClickhouseUserConfigArgs']]:
        """
    ...
    def external_clickhouse_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalClickhouseUserConfigArgs']]):
        pulumi.set(self, "external_clickhouse_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalElasticsearchLogsUserConfig")
    def external_elasticsearch_logs_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgs']]:
        """
    ...
    def external_elasticsearch_logs_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgs']]):
        pulumi.set(self, "external_elasticsearch_logs_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalGoogleCloudBigquery")
    def external_google_cloud_bigquery(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgs']]:
        """
    ...
    def external_google_cloud_bigquery(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgs']]):
        pulumi.set(self, "external_google_cloud_bigquery", value)

    @_builtins.property
    @pulumi.getter(name="externalGoogleCloudLoggingUserConfig")
    def external_google_cloud_logging_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgs']]:
        """
    ...
    def external_google_cloud_logging_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgs']]):
        pulumi.set(self, "external_google_cloud_logging_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalKafkaUserConfig")
    def external_kafka_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalKafkaUserConfigArgs']]:
        """
    ...
    def external_kafka_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalKafkaUserConfigArgs']]):
        pulumi.set(self, "external_kafka_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalMysqlUserConfig")
    def external_mysql_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalMysqlUserConfigArgs']]:
        """
    ...
    def external_mysql_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalMysqlUserConfigArgs']]):
        pulumi.set(self, "external_mysql_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalObjectStorageConfigUserConfig")
    def external_object_storage_config_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgs']]:
        """
        ...
        """
        return pulumi.get(self, "external_object_storage_config_user_config")

    @external_object_storage_config_user_config.setter
    def external_object_storage_config_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgs']]):
        pulumi.set(self, "external_object_storage_config_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalOpensearchLogsUserConfig")
    def external_opensearch_logs_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgs']]:
        """
    ...
    def external_opensearch_logs_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgs']]):
        pulumi.set(self, "external_opensearch_logs_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalPostgresql")
    def external_postgresql(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalPostgresqlArgs']]:
        """
    ...
    def external_postgresql(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalPostgresqlArgs']]):
        pulumi.set(self, "external_postgresql", value)

    @_builtins.property
    @pulumi.getter(name="externalPrometheusUserConfig")
    def external_prometheus_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalPrometheusUserConfigArgs']]:
        """
    ...
    def external_prometheus_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalPrometheusUserConfigArgs']]):
        pulumi.set(self, "external_prometheus_user_config", value)

    @_builtins.property
    @pulumi.getter(name="externalSchemaRegistryUserConfig")
    def external_schema_registry_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgs']]:
        """
    ...
    def external_schema_registry_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgs']]):
        pulumi.set(self, "external_schema_registry_user_config", value)

    @_builtins.property
    @pulumi.getter(name="jolokiaUserConfig")
    def jolokia_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointJolokiaUserConfigArgs']]:
        """
    ...
    def jolokia_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointJolokiaUserConfigArgs']]):
        pulumi.set(self, "jolokia_user_config", value)

    @_builtins.property
    @pulumi.getter(name="opentelemetryUserConfig")
    def opentelemetry_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointOpentelemetryUserConfigArgs']]:
        """
        ...
        """
        return pulumi.get(self, "opentelemetry_user_config")

    @opentelemetry_user_config.setter
    def opentelemetry_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointOpentelemetryUserConfigArgs']]):
        pulumi.set(self, "opentelemetry_user_config", value)

    @_builtins.property
    @pulumi.getter(name="prometheusUserConfig")
    def prometheus_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointPrometheusUserConfigArgs']]:
        """
    ...
    def prometheus_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointPrometheusUserConfigArgs']]):
        pulumi.set(self, "prometheus_user_config", value)

    @_builtins.property
    @pulumi.getter(name="rsyslogUserConfig")
    def rsyslog_user_config(self) -> pulumi.Input[Optional['ServiceIntegrationEndpointRsyslogUserConfigArgs']]:
        """
    ...
    def rsyslog_user_config(self, value: pulumi.Input[Optional['ServiceIntegrationEndpointRsyslogUserConfigArgs']]):
...
class ServiceIntegrationEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 autoscaler_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointAutoscalerUserConfigArgs', 'ServiceIntegrationEndpointAutoscalerUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointAutoscalerUserConfig']]] = None,
                 datadog_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointDatadogUserConfigArgs', 'ServiceIntegrationEndpointDatadogUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointDatadogUserConfig']]] = None,
                 endpoint_name: pulumi.Input[Optional[_builtins.str]] = None,
                 endpoint_type: pulumi.Input[Optional[_builtins.str]] = None,
                 external_aws_cloudwatch_logs_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgs', 'ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfig']]] = None,
                 external_aws_cloudwatch_metrics_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgs', 'ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfig']]] = None,
                 external_aws_s3_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalAwsS3UserConfigArgs', 'ServiceIntegrationEndpointExternalAwsS3UserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAwsS3UserConfig']]] = None,
                 external_azure_blob_storage_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgs', 'ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAzureBlobStorageUserConfig']]] = None,
                 external_clickhouse_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalClickhouseUserConfigArgs', 'ServiceIntegrationEndpointExternalClickhouseUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalClickhouseUserConfig']]] = None,
                 external_elasticsearch_logs_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgs', 'ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalElasticsearchLogsUserConfig']]] = None,
                 external_google_cloud_bigquery: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgs', 'ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgsDict', 'outputs.ServiceIntegrationEndpointExternalGoogleCloudBigquery']]] = None,
                 external_google_cloud_logging_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgs', 'ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfig']]] = None,
                 external_kafka_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalKafkaUserConfigArgs', 'ServiceIntegrationEndpointExternalKafkaUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalKafkaUserConfig']]] = None,
                 external_mysql_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalMysqlUserConfigArgs', 'ServiceIntegrationEndpointExternalMysqlUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalMysqlUserConfig']]] = None,
                 external_object_storage_config_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgs', 'ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalObjectStorageConfigUserConfig']]] = None,
                 external_opensearch_logs_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgs', 'ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalOpensearchLogsUserConfig']]] = None,
                 external_postgresql: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalPostgresqlArgs', 'ServiceIntegrationEndpointExternalPostgresqlArgsDict', 'outputs.ServiceIntegrationEndpointExternalPostgresql']]] = None,
                 external_prometheus_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalPrometheusUserConfigArgs', 'ServiceIntegrationEndpointExternalPrometheusUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalPrometheusUserConfig']]] = None,
                 external_schema_registry_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgs', 'ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalSchemaRegistryUserConfig']]] = None,
                 jolokia_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointJolokiaUserConfigArgs', 'ServiceIntegrationEndpointJolokiaUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointJolokiaUserConfig']]] = None,
                 opentelemetry_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointOpentelemetryUserConfigArgs', 'ServiceIntegrationEndpointOpentelemetryUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointOpentelemetryUserConfig']]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 prometheus_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointPrometheusUserConfigArgs', 'ServiceIntegrationEndpointPrometheusUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointPrometheusUserConfig']]] = None,
                 rsyslog_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointRsyslogUserConfigArgs', 'ServiceIntegrationEndpointRsyslogUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointRsyslogUserConfig']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ServiceIntegrationEndpointAutoscalerUserConfigArgs', 'ServiceIntegrationEndpointAutoscalerUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointAutoscalerUserConfig']] autoscaler_user_config: Autoscaler user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointDatadogUserConfigArgs', 'ServiceIntegrationEndpointDatadogUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointDatadogUserConfig']] datadog_user_config: Datadog user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[_builtins.str] endpoint_name: Name of the service integration endpoint.
        :param pulumi.Input[_builtins.str] endpoint_type: The type of service integration endpoint. The possible values are `autoscaler`, `datadog`, `external_aws_cloudwatch_logs`, `external_aws_cloudwatch_metrics`, `external_aws_s3`, `external_azure_blob_storage`, `external_clickhouse`, `external_elasticsearch_logs`, `external_google_cloud_bigquery`, `external_google_cloud_logging`, `external_kafka`, `external_mysql`, `external_object_storage_config`, `external_opensearch_logs`, `external_postgresql`, `external_prometheus`, `external_redis`, `external_schema_registry`, `external_sumologic_logs`, `jolokia`, `opentelemetry`, `prometheus` and `rsyslog`.
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgs', 'ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAwsCloudwatchLogsUserConfig']] external_aws_cloudwatch_logs_user_config: ExternalAwsCloudwatchLogs user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgs', 'ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAwsCloudwatchMetricsUserConfig']] external_aws_cloudwatch_metrics_user_config: ExternalAwsCloudwatchMetrics user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalAwsS3UserConfigArgs', 'ServiceIntegrationEndpointExternalAwsS3UserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAwsS3UserConfig']] external_aws_s3_user_config: ExternalAwsS3 user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgs', 'ServiceIntegrationEndpointExternalAzureBlobStorageUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalAzureBlobStorageUserConfig']] external_azure_blob_storage_user_config: ExternalAzureBlobStorage user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalClickhouseUserConfigArgs', 'ServiceIntegrationEndpointExternalClickhouseUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalClickhouseUserConfig']] external_clickhouse_user_config: ExternalClickhouse user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgs', 'ServiceIntegrationEndpointExternalElasticsearchLogsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalElasticsearchLogsUserConfig']] external_elasticsearch_logs_user_config: ExternalElasticsearchLogs user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgs', 'ServiceIntegrationEndpointExternalGoogleCloudBigqueryArgsDict', 'outputs.ServiceIntegrationEndpointExternalGoogleCloudBigquery']] external_google_cloud_bigquery: ExternalGoogleCloudBigquery user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgs', 'ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalGoogleCloudLoggingUserConfig']] external_google_cloud_logging_user_config: ExternalGoogleCloudLogging user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalKafkaUserConfigArgs', 'ServiceIntegrationEndpointExternalKafkaUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalKafkaUserConfig']] external_kafka_user_config: ExternalKafka user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalMysqlUserConfigArgs', 'ServiceIntegrationEndpointExternalMysqlUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalMysqlUserConfig']] external_mysql_user_config: ExternalMysql user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgs', 'ServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalObjectStorageConfigUserConfig']] external_object_storage_config_user_config: ExternalObjectStorageConfig user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgs', 'ServiceIntegrationEndpointExternalOpensearchLogsUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalOpensearchLogsUserConfig']] external_opensearch_logs_user_config: ExternalOpensearchLogs user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalPostgresqlArgs', 'ServiceIntegrationEndpointExternalPostgresqlArgsDict', 'outputs.ServiceIntegrationEndpointExternalPostgresql']] external_postgresql: ExternalPostgresql user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalPrometheusUserConfigArgs', 'ServiceIntegrationEndpointExternalPrometheusUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalPrometheusUserConfig']] external_prometheus_user_config: ExternalPrometheus user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgs', 'ServiceIntegrationEndpointExternalSchemaRegistryUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointExternalSchemaRegistryUserConfig']] external_schema_registry_user_config: ExternalSchemaRegistry user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointJolokiaUserConfigArgs', 'ServiceIntegrationEndpointJolokiaUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointJolokiaUserConfig']] jolokia_user_config: Jolokia user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[Union['ServiceIntegrationEndpointOpentelemetryUserConfigArgs', 'ServiceIntegrationEndpointOpentelemetryUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointOpentelemetryUserConfig']] opentelemetry_user_config: Opentelemetry user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        :param pulumi.Input[_builtins.str] project: Project the service integration endpoint is in.
        ...
        :param pulumi.Input[Union['ServiceIntegrationEndpointRsyslogUserConfigArgs', 'ServiceIntegrationEndpointRsyslogUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointRsyslogUserConfig']] rsyslog_user_config: Rsyslog user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["external_object_storage_config_user_config"] = external_object_storage_config_user_config
            ...
            __props__.__dict__["opentelemetry_user_config"] = opentelemetry_user_config
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            prometheus_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointPrometheusUserConfigArgs', 'ServiceIntegrationEndpointPrometheusUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointPrometheusUserConfig']]] = None,
            rsyslog_user_config: pulumi.Input[Optional[Union['ServiceIntegrationEndpointRsyslogUserConfigArgs', 'ServiceIntegrationEndpointRsyslogUserConfigArgsDict', 'outputs.ServiceIntegrationEndpointRsyslogUserConfig']]] = None) -> 'ServiceIntegrationEndpoint':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="externalObjectStorageConfigUserConfig")
    def external_object_storage_config_user_config(self) -> pulumi.Output[Optional['outputs.ServiceIntegrationEndpointExternalObjectStorageConfigUserConfig']]:
        """
        ExternalObjectStorageConfig user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        """
        return pulumi.get(self, "external_object_storage_config_user_config")
    ...
    @_builtins.property
    @pulumi.getter(name="opentelemetryUserConfig")
    def opentelemetry_user_config(self) -> pulumi.Output[Optional['outputs.ServiceIntegrationEndpointOpentelemetryUserConfig']]:
        """
        Opentelemetry user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
        """
        return pulumi.get(self, "opentelemetry_user_config")
