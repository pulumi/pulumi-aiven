...
class KafkaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] karapace: Switch the service to use [Karapace](https://aiven.io/docs/products/kafka/karapace) for schema registry and REST proxy.
