...
def get_clickhouse_database(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the ClickHouse database. Changing this property forces recreation of the resource.
...
def get_clickhouse_database_output(name: Optional[pulumi.Input[builtins.str]] = None,
