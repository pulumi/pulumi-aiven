...
// Indicates whether the maintenance window is currently enabled for this service.
func (o InfluxDbOutput) MaintenanceWindowEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *InfluxDb) pulumi.BoolOutput { return v.MaintenanceWindowEnabled }).(pulumi.BoolOutput)
}
