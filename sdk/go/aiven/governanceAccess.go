...
// The ID of the access.
func (o GovernanceAccessOutput) AccessId() pulumi.StringOutput {
	return o.ApplyT(func(v *GovernanceAccess) pulumi.StringOutput { return v.AccessId }).(pulumi.StringOutput)
}
