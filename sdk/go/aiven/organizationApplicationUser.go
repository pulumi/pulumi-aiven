...
type OrganizationApplicationUser struct {
	...
	Timeouts       OrganizationApplicationUserTimeoutsPtrOutput `pulumi:"timeouts"`
	// User ID.
...
type organizationApplicationUserState struct {
	...
	Timeouts       *OrganizationApplicationUserTimeouts `pulumi:"timeouts"`
	// User ID.
...
type OrganizationApplicationUserState struct {
	...
	Timeouts       OrganizationApplicationUserTimeoutsPtrInput
	// User ID.
...
func (o OrganizationApplicationUserOutput) Timeouts() OrganizationApplicationUserTimeoutsPtrOutput {
	return o.ApplyT(func(v *OrganizationApplicationUser) OrganizationApplicationUserTimeoutsPtrOutput { return v.Timeouts }).(OrganizationApplicationUserTimeoutsPtrOutput)
}
