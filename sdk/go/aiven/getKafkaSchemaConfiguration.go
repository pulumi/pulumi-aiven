...
type LookupKafkaSchemaConfigurationResult struct {
	...
	Project string `pulumi:"project"`
	// Schema references.
	References []GetKafkaSchemaConfigurationReference `pulumi:"references"`
...
func LookupKafkaSchemaConfigurationOutput(ctx *pulumi.Context, args LookupKafkaSchemaConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupKafkaSchemaConfigurationResultOutput {
	...
	return ctx.InvokeOutput("aiven:index/getKafkaSchemaConfiguration:getKafkaSchemaConfiguration", args, LookupKafkaSchemaConfigurationResultOutput{}, options).(LookupKafkaSchemaConfigurationResultOutput)
}
...
// Schema references.
func (o LookupKafkaSchemaConfigurationResultOutput) References() GetKafkaSchemaConfigurationReferenceArrayOutput {
	return o.ApplyT(func(v LookupKafkaSchemaConfigurationResult) []GetKafkaSchemaConfigurationReference {
		return v.References
	}).(GetKafkaSchemaConfigurationReferenceArrayOutput)
}
