...
// Indicates whether the maintenance window is currently enabled for this service.
func (o M3AggregatorOutput) MaintenanceWindowEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *M3Aggregator) pulumi.BoolOutput { return v.MaintenanceWindowEnabled }).(pulumi.BoolOutput)
}
