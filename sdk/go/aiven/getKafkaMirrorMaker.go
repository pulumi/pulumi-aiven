...
type LookupKafkaMirrorMakerOutputArgs struct {
	...
	Components GetKafkaMirrorMakerComponentArrayInput `pulumi:"components"`
	// Kafka MirrorMaker 2 specific server provided values.
	KafkaMirrormaker GetKafkaMirrorMakerKafkaMirrormakerPtrInput `pulumi:"kafkaMirrormaker"`
	// defines Kafka MirrorMaker 2 specific additional configuration options.
	// The following configuration options available:
	KafkaMirrormakerUserConfig GetKafkaMirrorMakerKafkaMirrormakerUserConfigPtrInput `pulumi:"kafkaMirrormakerUserConfig"`
	// day of week when maintenance operations should be performed.
	// On monday, tuesday, wednesday, etc.
	...
	ServiceIntegrations GetKafkaMirrorMakerServiceIntegrationArrayInput `pulumi:"serviceIntegrations"`
	// specifies the actual name of the service. The name cannot be changed
	// later without destroying and re-creating the service so name should be picked based on
	// intended service usage rather than current attributes.
...
// like [here for Google](https://cloud.google.com/compute/docs/regions-zones/) and
// [here for AWS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html).
func (o LookupKafkaMirrorMakerResultOutput) CloudName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) *string { return v.CloudName }).(pulumi.StringPtrOutput)
}
...
// Kafka MirrorMaker 2 specific server provided values.
func (o LookupKafkaMirrorMakerResultOutput) KafkaMirrormaker() GetKafkaMirrorMakerKafkaMirrormakerOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) GetKafkaMirrorMakerKafkaMirrormaker { return v.KafkaMirrormaker }).(GetKafkaMirrorMakerKafkaMirrormakerOutput)
}

// defines Kafka MirrorMaker 2 specific additional configuration options.
// The following configuration options available:
func (o LookupKafkaMirrorMakerResultOutput) KafkaMirrormakerUserConfig() GetKafkaMirrorMakerKafkaMirrormakerUserConfigPtrOutput {
	...
	}).(GetKafkaMirrorMakerKafkaMirrormakerUserConfigPtrOutput)
}

// day of week when maintenance operations should be performed.
// On monday, tuesday, wednesday, etc.
func (o LookupKafkaMirrorMakerResultOutput) MaintenanceWindowDow() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) *string { return v.MaintenanceWindowDow }).(pulumi.StringPtrOutput)
}

// time of day when maintenance operations should be performed.
// UTC time in HH:mm:ss format.
func (o LookupKafkaMirrorMakerResultOutput) MaintenanceWindowTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) *string { return v.MaintenanceWindowTime }).(pulumi.StringPtrOutput)
}
...
// (roughly) the amount of memory on each node (also other attributes like number of CPUs
// and amount of disk space varies but naming is based on memory). The available options can be seem from the [Aiven pricing page](https://aiven.io/pricing).
func (o LookupKafkaMirrorMakerResultOutput) Plan() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) *string { return v.Plan }).(pulumi.StringPtrOutput)
}
...
// creation but doing so triggers migration to new servers so the operation can take
// significant amount of time to complete if the service has a lot of data.
func (o LookupKafkaMirrorMakerResultOutput) ProjectVpcId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) *string { return v.ProjectVpcId }).(pulumi.StringPtrOutput)
}
...
// with backups much of the content can at least be restored from backup in case accidental
// deletion is done.
func (o LookupKafkaMirrorMakerResultOutput) TerminationProtection() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupKafkaMirrorMakerResult) *bool { return v.TerminationProtection }).(pulumi.BoolPtrOutput)
}
