...
//			_, err := aiven.GetServiceIntegrationEndpoint(ctx, &aiven.LookupServiceIntegrationEndpointArgs{
...
type LookupServiceIntegrationEndpointResult struct {
	...
	ExternalObjectStorageConfigUserConfigs []GetServiceIntegrationEndpointExternalObjectStorageConfigUserConfig `pulumi:"externalObjectStorageConfigUserConfigs"`
...
// ExternalObjectStorageConfig user configurable settings. **Warning:** There's no way to reset advanced configuration options to default. Options that you add cannot be removed later
func (o LookupServiceIntegrationEndpointResultOutput) ExternalObjectStorageConfigUserConfigs() GetServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArrayOutput {
	return o.ApplyT(func(v LookupServiceIntegrationEndpointResult) []GetServiceIntegrationEndpointExternalObjectStorageConfigUserConfig {
		return v.ExternalObjectStorageConfigUserConfigs
	}).(GetServiceIntegrationEndpointExternalObjectStorageConfigUserConfigArrayOutput)
}
