...
func (o LookupKafkaConnectResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupKafkaConnectResult] {
	return pulumix.Output[LookupKafkaConnectResult]{
