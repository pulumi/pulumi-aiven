...
type LookupServiceIntegrationArgs struct {
	...
	// Type of the service integration. The possible values are `alertTriageKafka`, `alertmanager`, `autoscaler`, `caching`, `clickhouseCredentials`, `clickhouseKafka`, `clickhousePostgresql`, `dashboard`, `datadog`, `datahubMetadataIngestion`, `datasource`, `disasterRecovery`, `externalAwsCloudwatchLogs`, `externalAwsCloudwatchMetrics`, `externalElasticsearchLogs`, `externalGoogleCloudLogging`, `externalOpensearchLogs`, `flink`, `flinkExternalBigquery`, `flinkExternalKafka`, `flinkExternalPostgresql`, `internalConnectivity`, `jolokia`, `kafkaConnect`, `kafkaConnectPostgresql`, `kafkaLogs`, `kafkaMirrormaker`, `logs`, `metrics`, `opensearchCrossClusterReplication`, `opensearchCrossClusterSearch`, `opentelemetry`, `postgresqlClickhouseCdc`, `prometheus`, `readReplica`, `rsyslog`, `schemaRegistryProxy`, `serviceComposition`, `stresstester`, `thanosDistributedQuery`, `thanosMigrate`, `thanosObjectStorage`, `thanoscompactor`, `thanosquery`, `thanosruler`, `thanosstore`, `vector` and `vmalert`.
...
func LookupServiceIntegrationOutput(ctx *pulumi.Context, args LookupServiceIntegrationOutputArgs, opts ...pulumi.InvokeOption) LookupServiceIntegrationResultOutput {
	...
	return ctx.InvokeOutput("aiven:index/getServiceIntegration:getServiceIntegration", args, LookupServiceIntegrationResultOutput{}, options).(LookupServiceIntegrationResultOutput)
}
