...
// MySQL grants for the service user.
func (o LookupOpensearchUserResultOutput) MysqlGrants() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupOpensearchUserResult) []string { return v.MysqlGrants }).(pulumi.StringArrayOutput)
}
