...
public final class GetPgUserTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPgUserTimeoutsArgs Empty = new GetPgUserTimeoutsArgs();
    ...
    private GetPgUserTimeoutsArgs() {}

    private GetPgUserTimeoutsArgs(GetPgUserTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetPgUserTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPgUserTimeoutsArgs();
        }

        public Builder(GetPgUserTimeoutsArgs defaults) {
            $ = new GetPgUserTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPgUserTimeoutsArgs build() {
            return $;
        }
    }
