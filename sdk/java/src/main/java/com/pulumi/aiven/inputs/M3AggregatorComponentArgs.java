...
public final class M3AggregatorComponentArgs extends com.pulumi.resources.ResourceArgs {

    public static final M3AggregatorComponentArgs Empty = new M3AggregatorComponentArgs();
    ...
    private M3AggregatorComponentArgs() {}

    private M3AggregatorComponentArgs(M3AggregatorComponentArgs $) {
    ...
    public static Builder builder(M3AggregatorComponentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new M3AggregatorComponentArgs();
        }

        public Builder(M3AggregatorComponentArgs defaults) {
            $ = new M3AggregatorComponentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public M3AggregatorComponentArgs build() {
            return $;
        }
    }
