...
import com.pulumi.aiven.outputs.GetValkeyComponent;
import com.pulumi.aiven.outputs.GetValkeyServiceIntegration;
import com.pulumi.aiven.outputs.GetValkeyTag;
import com.pulumi.aiven.outputs.GetValkeyTechEmail;
import com.pulumi.aiven.outputs.GetValkeyValkey;
import com.pulumi.aiven.outputs.GetValkeyValkeyUserConfig;
...
@CustomType
public final class GetValkeyResult {
    /**
     ...
     * 
     */
    private List<GetValkeyComponent> components;
    /**
     ...
     * 
     */
    private List<GetValkeyServiceIntegration> serviceIntegrations;
    /**
     ...
     * 
     */
    private List<GetValkeyTag> tags;
    /**
     ...
     * 
     */
    private List<GetValkeyTechEmail> techEmails;
    /**
     ...
     * 
     */
    private List<GetValkeyValkey> valkeys;

    private GetValkeyResult() {}
    /**
     * @return Add [disk storage](https://aiven.io/docs/platform/howto/add-storage-space) in increments of 30 GiB to the default disk space defined by the `plan`. The maximum value depends on the service type and cloud provider. Removing additional storage causes the service nodes to go through a rolling restart, and there might be a short downtime for services without an autoscaler integration or high availability capabilities. The field can be safely removed when autoscaler is enabled without causing any changes.
     * 
     */
     ...
     * 
     */
    public List<GetValkeyComponent> components() {
     ...
     * 
     */
    public List<GetValkeyServiceIntegration> serviceIntegrations() {
     ...
     * 
     */
    public List<GetValkeyTechEmail> techEmails() {
    ...
    public List<GetValkeyValkeyUserConfig> valkeyUserConfigs() {
        return this.valkeyUserConfigs;
    }
    /**
     * @return Valkey server provided values
     * 
     */
    public List<GetValkeyValkey> valkeys() {
        return this.valkeys;
    }
    ...
    public static Builder builder(GetValkeyResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetValkeyValkey> valkeys;
        public Builder() {}
        public Builder(GetValkeyResult defaults) {
    	      ...
    	      this.valkeyUserConfigs = defaults.valkeyUserConfigs;
    	      this.valkeys = defaults.valkeys;
        }

        @CustomType.Setter
        public Builder additionalDiskSpace(String additionalDiskSpace) {
            if (additionalDiskSpace == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "additionalDiskSpace");
            }
        ...
        public Builder cloudName(String cloudName) {
            if (cloudName == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "cloudName");
            }
        ...
        public Builder cmkId(String cmkId) {
            if (cmkId == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "cmkId");
            }
            this.cmkId = cmkId;
            return this;
        }
        @CustomType.Setter
        public Builder components(List<GetValkeyComponent> components) {
            if (components == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "components");
            }
            this.components = components;
            return this;
        }
        public Builder components(GetValkeyComponent... components) {
            return components(List.of(components));
        }
        @CustomType.Setter
        public Builder diskSpace(String diskSpace) {
            if (diskSpace == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "diskSpace");
            }
        ...
        public Builder diskSpaceCap(String diskSpaceCap) {
            if (diskSpaceCap == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "diskSpaceCap");
            }
        ...
        public Builder diskSpaceDefault(String diskSpaceDefault) {
            if (diskSpaceDefault == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "diskSpaceDefault");
            }
        ...
        public Builder diskSpaceStep(String diskSpaceStep) {
            if (diskSpaceStep == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "diskSpaceStep");
            }
        ...
        public Builder diskSpaceUsed(String diskSpaceUsed) {
            if (diskSpaceUsed == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "diskSpaceUsed");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder maintenanceWindowDow(String maintenanceWindowDow) {
            if (maintenanceWindowDow == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "maintenanceWindowDow");
            }
        ...
        public Builder maintenanceWindowEnabled(Boolean maintenanceWindowEnabled) {
            if (maintenanceWindowEnabled == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "maintenanceWindowEnabled");
            }
        ...
        public Builder maintenanceWindowTime(String maintenanceWindowTime) {
            if (maintenanceWindowTime == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "maintenanceWindowTime");
            }
        ...
        public Builder plan(String plan) {
            if (plan == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "plan");
            }
            this.plan = plan;
            return this;
        }
        ...
        public Builder project(String project) {
            if (project == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "project");
            }
        ...
        public Builder projectVpcId(String projectVpcId) {
            if (projectVpcId == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "projectVpcId");
            }
        ...
        public Builder serviceHost(String serviceHost) {
            if (serviceHost == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "serviceHost");
            }
            this.serviceHost = serviceHost;
            return this;
        }
        @CustomType.Setter
        public Builder serviceIntegrations(List<GetValkeyServiceIntegration> serviceIntegrations) {
            if (serviceIntegrations == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "serviceIntegrations");
            }
            this.serviceIntegrations = serviceIntegrations;
            return this;
        }
        public Builder serviceIntegrations(GetValkeyServiceIntegration... serviceIntegrations) {
            return serviceIntegrations(List.of(serviceIntegrations));
        }
        @CustomType.Setter
        public Builder serviceName(String serviceName) {
            if (serviceName == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "serviceName");
            }
        ...
        public Builder servicePassword(String servicePassword) {
            if (servicePassword == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "servicePassword");
            }
        ...
        public Builder servicePort(Integer servicePort) {
            if (servicePort == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "servicePort");
            }
        ...
        public Builder serviceType(String serviceType) {
            if (serviceType == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "serviceType");
            }
        ...
        public Builder serviceUri(String serviceUri) {
            if (serviceUri == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "serviceUri");
            }
        ...
        public Builder serviceUsername(String serviceUsername) {
            if (serviceUsername == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "serviceUsername");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder staticIps(List<String> staticIps) {
            if (staticIps == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "staticIps");
            }
        ...
        @CustomType.Setter
        public Builder tags(List<GetValkeyTag> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "tags");
            }
            this.tags = tags;
            return this;
        }
        public Builder tags(GetValkeyTag... tags) {
            return tags(List.of(tags));
        }
        @CustomType.Setter
        public Builder techEmails(List<GetValkeyTechEmail> techEmails) {
            if (techEmails == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "techEmails");
            }
            this.techEmails = techEmails;
            return this;
        }
        public Builder techEmails(GetValkeyTechEmail... techEmails) {
            return techEmails(List.of(techEmails));
        }
        @CustomType.Setter
        public Builder terminationProtection(Boolean terminationProtection) {
            if (terminationProtection == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "terminationProtection");
            }
            this.terminationProtection = terminationProtection;
            return this;
        }
        @CustomType.Setter
        public Builder valkeyUserConfigs(List<GetValkeyValkeyUserConfig> valkeyUserConfigs) {
            if (valkeyUserConfigs == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "valkeyUserConfigs");
            }
            this.valkeyUserConfigs = valkeyUserConfigs;
            return this;
        }
        public Builder valkeyUserConfigs(GetValkeyValkeyUserConfig... valkeyUserConfigs) {
            return valkeyUserConfigs(List.of(valkeyUserConfigs));
        }
        @CustomType.Setter
        public Builder valkeys(List<GetValkeyValkey> valkeys) {
            if (valkeys == null) {
              throw new MissingRequiredPropertyException("GetValkeyResult", "valkeys");
            }
            this.valkeys = valkeys;
            return this;
        }
        public Builder valkeys(GetValkeyValkey... valkeys) {
            return valkeys(List.of(valkeys));
        }
        public GetValkeyResult build() {
            final var _resultValue = new GetValkeyResult();
            ...
            _resultValue.valkeyUserConfigs = valkeyUserConfigs;
            _resultValue.valkeys = valkeys;
            return _resultValue;
        }
    }
}
