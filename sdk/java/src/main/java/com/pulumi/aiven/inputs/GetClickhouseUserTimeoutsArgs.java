...
public final class GetClickhouseUserTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetClickhouseUserTimeoutsArgs Empty = new GetClickhouseUserTimeoutsArgs();
    ...
    private GetClickhouseUserTimeoutsArgs() {}

    private GetClickhouseUserTimeoutsArgs(GetClickhouseUserTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetClickhouseUserTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClickhouseUserTimeoutsArgs();
        }

        public Builder(GetClickhouseUserTimeoutsArgs defaults) {
            $ = new GetClickhouseUserTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetClickhouseUserTimeoutsArgs build() {
            return $;
        }
    }
