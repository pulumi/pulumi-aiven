...
public final class AccountTeamMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountTeamMemberArgs Empty = new AccountTeamMemberArgs();
    ...
    private AccountTeamMemberArgs() {}

    private AccountTeamMemberArgs(AccountTeamMemberArgs $) {
    ...
    public static Builder builder(AccountTeamMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AccountTeamMemberArgs defaults) {
            $ = new AccountTeamMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountTeamMemberArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("AccountTeamMemberArgs", "accountId");
            }
            if ($.teamId == null) {
                throw new MissingRequiredPropertyException("AccountTeamMemberArgs", "teamId");
            }
            if ($.userEmail == null) {
                throw new MissingRequiredPropertyException("AccountTeamMemberArgs", "userEmail");
            }
            return $;
        }
    }
