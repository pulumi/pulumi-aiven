...
@CustomType
public final class StaticIpTimeouts {
    /**
    ...
    public static Builder builder(StaticIpTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(StaticIpTimeouts defaults) {
        ...
        public StaticIpTimeouts build() {
            final var _resultValue = new StaticIpTimeouts();
