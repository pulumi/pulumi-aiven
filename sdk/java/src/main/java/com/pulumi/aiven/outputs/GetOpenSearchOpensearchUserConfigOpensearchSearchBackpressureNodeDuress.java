...
@CustomType
public final class GetOpenSearchOpensearchUserConfigOpensearchSearchBackpressureNodeDuress {
    /**
    ...
    private GetOpenSearchOpensearchUserConfigOpensearchSearchBackpressureNodeDuress() {}
    /**
     * @return The CPU usage threshold (as a percentage) required for a node to be considered to be under duress. Default is 0.9.
     * 
     */
    ...
    public static Builder builder(GetOpenSearchOpensearchUserConfigOpensearchSearchBackpressureNodeDuress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer numSuccessiveBreaches;
        public Builder() {}
        public Builder(GetOpenSearchOpensearchUserConfigOpensearchSearchBackpressureNodeDuress defaults) {
        ...
        public GetOpenSearchOpensearchUserConfigOpensearchSearchBackpressureNodeDuress build() {
            final var _resultValue = new GetOpenSearchOpensearchUserConfigOpensearchSearchBackpressureNodeDuress();
