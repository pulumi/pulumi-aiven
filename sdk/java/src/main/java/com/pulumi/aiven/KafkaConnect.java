...
import com.pulumi.aiven.outputs.KafkaConnectKafkaConnect;
...
public class KafkaConnect extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="components", type=List.class, parameters={KafkaConnectComponent.class})
     ...
     * 
     */
    @Export(name="kafkaConnectUserConfig", type=KafkaConnectKafkaConnectUserConfig.class, parameters={})
     ...
     * 
     */
    @Export(name="kafkaConnects", type=List.class, parameters={KafkaConnectKafkaConnect.class})
    private Output<List<KafkaConnectKafkaConnect>> kafkaConnects;

    /**
     * @return Kafka Connect server provided values
     * 
     */
    public Output<List<KafkaConnectKafkaConnect>> kafkaConnects() {
     ...
     * 
     */
    @Export(name="serviceIntegrations", type=List.class, parameters={KafkaConnectServiceIntegration.class})
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={KafkaConnectTag.class})
     ...
     */
    public KafkaConnect(String name) {
     ...
     */
    public KafkaConnect(String name, KafkaConnectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/kafkaConnect:KafkaConnect", name, args == null ? KafkaConnectArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private KafkaConnect(String name, Output<String> id, @Nullable KafkaConnectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/kafkaConnect:KafkaConnect", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static KafkaConnect get(String name, Output<String> id, @Nullable KafkaConnectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
