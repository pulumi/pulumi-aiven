...
public final class GetClickhouseClickhouseUserConfigPublicAccess {
    ...
    public static Builder builder(GetClickhouseClickhouseUserConfigPublicAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean prometheus;
        public Builder() {}
        public Builder(GetClickhouseClickhouseUserConfigPublicAccess defaults) {
        ...
        public GetClickhouseClickhouseUserConfigPublicAccess build() {
            final var _resultValue = new GetClickhouseClickhouseUserConfigPublicAccess();
