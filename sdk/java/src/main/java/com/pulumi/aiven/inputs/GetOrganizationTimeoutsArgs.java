...
public final class GetOrganizationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOrganizationTimeoutsArgs Empty = new GetOrganizationTimeoutsArgs();
    ...
    private GetOrganizationTimeoutsArgs() {}

    private GetOrganizationTimeoutsArgs(GetOrganizationTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOrganizationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOrganizationTimeoutsArgs();
        }

        public Builder(GetOrganizationTimeoutsArgs defaults) {
            $ = new GetOrganizationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOrganizationTimeoutsArgs build() {
            return $;
        }
    }
