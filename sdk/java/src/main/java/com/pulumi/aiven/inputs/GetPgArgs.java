...
public final class GetPgArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPgArgs Empty = new GetPgArgs();
    ...
    public static Builder builder(GetPgArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetPgArgs defaults) {
            $ = new GetPgArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPgArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetPgArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetPgArgs", "serviceName");
            }
            return $;
        }
    }
