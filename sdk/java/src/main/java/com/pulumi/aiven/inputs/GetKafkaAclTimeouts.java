...
public final class GetKafkaAclTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetKafkaAclTimeouts Empty = new GetKafkaAclTimeouts();
    ...
    private GetKafkaAclTimeouts() {}

    private GetKafkaAclTimeouts(GetKafkaAclTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaAclTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaAclTimeouts();
        }

        public Builder(GetKafkaAclTimeouts defaults) {
            $ = new GetKafkaAclTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaAclTimeouts build() {
            return $;
        }
    }
