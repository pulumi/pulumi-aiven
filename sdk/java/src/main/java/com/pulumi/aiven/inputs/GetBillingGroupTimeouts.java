...
public final class GetBillingGroupTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetBillingGroupTimeouts Empty = new GetBillingGroupTimeouts();
    ...
    private GetBillingGroupTimeouts() {}

    private GetBillingGroupTimeouts(GetBillingGroupTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetBillingGroupTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBillingGroupTimeouts();
        }

        public Builder(GetBillingGroupTimeouts defaults) {
            $ = new GetBillingGroupTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetBillingGroupTimeouts build() {
            return $;
        }
    }
