...
public final class AlloydbomniUserArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlloydbomniUserArgs Empty = new AlloydbomniUserArgs();
    ...
    private AlloydbomniUserArgs() {}

    private AlloydbomniUserArgs(AlloydbomniUserArgs $) {
    ...
    public static Builder builder(AlloydbomniUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlloydbomniUserArgs();
        }

        public Builder(AlloydbomniUserArgs defaults) {
            $ = new AlloydbomniUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AlloydbomniUserArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("AlloydbomniUserArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("AlloydbomniUserArgs", "serviceName");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("AlloydbomniUserArgs", "username");
            }
            return $;
        }
    }
