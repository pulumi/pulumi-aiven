...
import com.pulumi.aiven.outputs.GetPgPgUserConfigPgaudit;
...
import com.pulumi.aiven.outputs.GetPgPgUserConfigSwitchoverWindow;
...
public final class GetPgPgUserConfig {
    ...
    /**
     * @return System-wide settings for the pgQualstats extension
     * 
     * @deprecated
    ...
    /**
     * @return Enable the pgStatMonitor extension. Changing this parameter causes a service restart. When this extension is enabled, pgStatStatements results for utility commands are unreliable. Default: `false`.
     * 
     */
    private @Nullable Boolean pgStatMonitorEnable;
    /**
     * @return Enable the pgStatPlans extension. Changing this parameter causes a service restart. Tracks execution plans for SQL queries. Default: `false`.
     * 
     */
    ...
    public List<GetPgPgUserConfigSwitchoverWindow> switchoverWindows() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder pgaudit(@Nullable GetPgPgUserConfigPgaudit pgaudit) {
        ...
        @CustomType.Setter
        public Builder switchoverWindows(@Nullable List<GetPgPgUserConfigSwitchoverWindow> switchoverWindows) {

            this.switchoverWindows = switchoverWindows;
            return this;
        }
        public Builder switchoverWindows(GetPgPgUserConfigSwitchoverWindow... switchoverWindows) {
