...
@CustomType
public final class ServiceIntegrationEndpointExternalPrometheusUserConfig {
    /**
    ...
    private ServiceIntegrationEndpointExternalPrometheusUserConfig() {}
    /**
     * @return Prometheus basic authentication password. Example: `fhyFNBjj3R`.
     * 
     */
    ...
    public static Builder builder(ServiceIntegrationEndpointExternalPrometheusUserConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String serviceUri;
        public Builder() {}
        public Builder(ServiceIntegrationEndpointExternalPrometheusUserConfig defaults) {
        ...
        public ServiceIntegrationEndpointExternalPrometheusUserConfig build() {
            final var _resultValue = new ServiceIntegrationEndpointExternalPrometheusUserConfig();
