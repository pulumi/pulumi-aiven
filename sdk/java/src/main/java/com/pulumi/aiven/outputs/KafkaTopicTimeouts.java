...
@CustomType
public final class KafkaTopicTimeouts {
    /**
    ...
    public static Builder builder(KafkaTopicTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(KafkaTopicTimeouts defaults) {
        ...
        public KafkaTopicTimeouts build() {
            final var _resultValue = new KafkaTopicTimeouts();
