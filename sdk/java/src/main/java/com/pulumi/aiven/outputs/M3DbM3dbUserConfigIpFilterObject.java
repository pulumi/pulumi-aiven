...
public final class M3DbM3dbUserConfigIpFilterObject {
    ...
    public static Builder builder(M3DbM3dbUserConfigIpFilterObject defaults) {
    ...
    public static final class Builder {
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("M3DbM3dbUserConfigIpFilterObject", "network");
            }
