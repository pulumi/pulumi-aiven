    ...
    public static final class Builder {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("GetKafkaServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("GetKafkaServiceIntegration", "sourceServiceName");
            }
            this.sourceServiceName = sourceServiceName;
            return this;
        }
        public GetKafkaServiceIntegration build() {
            final var _resultValue = new GetKafkaServiceIntegration();
