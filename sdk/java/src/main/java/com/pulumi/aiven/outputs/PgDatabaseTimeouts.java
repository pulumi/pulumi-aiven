...
@CustomType
public final class PgDatabaseTimeouts {
    /**
    ...
    public static Builder builder(PgDatabaseTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PgDatabaseTimeouts defaults) {
        ...
        public PgDatabaseTimeouts build() {
            final var _resultValue = new PgDatabaseTimeouts();
