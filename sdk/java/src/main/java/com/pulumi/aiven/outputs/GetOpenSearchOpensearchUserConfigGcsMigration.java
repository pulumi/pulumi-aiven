...
@CustomType
public final class GetOpenSearchOpensearchUserConfigGcsMigration {
    /**
    ...
    private GetOpenSearchOpensearchUserConfigGcsMigration() {}
    /**
     * @return The path to the repository data within its container. The value of this setting should not start or end with a /.
     * 
     */
    ...
    public static Builder builder(GetOpenSearchOpensearchUserConfigGcsMigration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder basePath(String basePath) {
            if (basePath == null) {
              throw new MissingRequiredPropertyException("GetOpenSearchOpensearchUserConfigGcsMigration", "basePath");
            }
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetOpenSearchOpensearchUserConfigGcsMigration", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder credentials(String credentials) {
            if (credentials == null) {
              throw new MissingRequiredPropertyException("GetOpenSearchOpensearchUserConfigGcsMigration", "credentials");
            }
        ...
        public Builder snapshotName(String snapshotName) {
            if (snapshotName == null) {
              throw new MissingRequiredPropertyException("GetOpenSearchOpensearchUserConfigGcsMigration", "snapshotName");
            }
            this.snapshotName = snapshotName;
            return this;
        }
        public GetOpenSearchOpensearchUserConfigGcsMigration build() {
            final var _resultValue = new GetOpenSearchOpensearchUserConfigGcsMigration();
