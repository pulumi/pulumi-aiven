...
import com.pulumi.aiven.inputs.KafkaMirrorMakerKafkaMirrormakerArgs;
...
public final class KafkaMirrorMakerState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Kafka_mirrormaker user configurable settings
     * 
     */
     ...
     * 
     */
    @Import(name="kafkaMirrormakers")
    private @Nullable Output<List<KafkaMirrorMakerKafkaMirrormakerArgs>> kafkaMirrormakers;

    /**
     * @return Kafka MirrorMaker 2 server provided values
     * 
     */
    public Optional<Output<List<KafkaMirrorMakerKafkaMirrormakerArgs>>> kafkaMirrormakers() {
        return Optional.ofNullable(this.kafkaMirrormakers);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param diskSpaceDefault The default disk space of the service, possible values depend on the service type, the cloud provider and the project.
         * Its also the minimum value for `disk_space`
         * 
         * @return builder
         * 
        ...
        /**
         * @param diskSpaceStep The default disk space step of the service, possible values depend on the service type, the cloud provider and the
         * project. `disk_space` needs to increment from `disk_space_default` by increments of this size.
         * 
         * @return builder
         * 
        ...
        /**
         * @param kafkaMirrormakerUserConfig Kafka_mirrormaker user configurable settings
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param kafkaMirrormakers Kafka MirrorMaker 2 server provided values
         * 
         * @return builder
         * 
         */
        public Builder kafkaMirrormakers(@Nullable Output<List<KafkaMirrorMakerKafkaMirrormakerArgs>> kafkaMirrormakers) {
         ...
         * 
         */
        public Builder kafkaMirrormakers(List<KafkaMirrorMakerKafkaMirrormakerArgs> kafkaMirrormakers) {
            return kafkaMirrormakers(Output.of(kafkaMirrormakers));
        }
         ...
         * 
         */
        public Builder kafkaMirrormakers(KafkaMirrorMakerKafkaMirrormakerArgs... kafkaMirrormakers) {
