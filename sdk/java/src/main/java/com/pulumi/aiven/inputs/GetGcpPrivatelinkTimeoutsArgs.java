...
public final class GetGcpPrivatelinkTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGcpPrivatelinkTimeoutsArgs Empty = new GetGcpPrivatelinkTimeoutsArgs();
    ...
    private GetGcpPrivatelinkTimeoutsArgs() {}

    private GetGcpPrivatelinkTimeoutsArgs(GetGcpPrivatelinkTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetGcpPrivatelinkTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGcpPrivatelinkTimeoutsArgs();
        }

        public Builder(GetGcpPrivatelinkTimeoutsArgs defaults) {
            $ = new GetGcpPrivatelinkTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGcpPrivatelinkTimeoutsArgs build() {
            return $;
        }
    }
