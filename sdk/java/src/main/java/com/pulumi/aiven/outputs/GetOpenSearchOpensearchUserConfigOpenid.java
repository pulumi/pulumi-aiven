...
public final class GetOpenSearchOpensearchUserConfigOpenid {
    ...
    /**
     * @return The HTTP header that stores the token. Typically the Authorization header with the Bearer schema: Authorization: Bearer &lt;token&gt;. Optional. Default is Authorization. Example: `preferredUsername`.
     * 
     */
