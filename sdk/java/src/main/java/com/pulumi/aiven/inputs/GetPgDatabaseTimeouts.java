...
public final class GetPgDatabaseTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetPgDatabaseTimeouts Empty = new GetPgDatabaseTimeouts();
    ...
    private GetPgDatabaseTimeouts() {}

    private GetPgDatabaseTimeouts(GetPgDatabaseTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetPgDatabaseTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPgDatabaseTimeouts();
        }

        public Builder(GetPgDatabaseTimeouts defaults) {
            $ = new GetPgDatabaseTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetPgDatabaseTimeouts build() {
            return $;
        }
    }
