...
public final class GetCassandaArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCassandaArgs Empty = new GetCassandaArgs();
    ...
    private GetCassandaArgs() {}

    private GetCassandaArgs(GetCassandaArgs $) {
    ...
    public static Builder builder(GetCassandaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCassandaArgs defaults) {
            $ = new GetCassandaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCassandaArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetCassandaArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetCassandaArgs", "serviceName");
            }
            return $;
        }
    }
