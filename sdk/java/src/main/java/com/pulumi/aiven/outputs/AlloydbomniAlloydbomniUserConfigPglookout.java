...
@CustomType
public final class AlloydbomniAlloydbomniUserConfigPglookout {
    /**
    ...
    private AlloydbomniAlloydbomniUserConfigPglookout() {}
    /**
     * @return Number of seconds of master unavailability before triggering database failover to standby. Default: `60`.
     * 
     */
    ...
    public static Builder builder(AlloydbomniAlloydbomniUserConfigPglookout defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer maxFailoverReplicationTimeLag;
        public Builder() {}
        public Builder(AlloydbomniAlloydbomniUserConfigPglookout defaults) {
        ...
        public AlloydbomniAlloydbomniUserConfigPglookout build() {
            final var _resultValue = new AlloydbomniAlloydbomniUserConfigPglookout();
