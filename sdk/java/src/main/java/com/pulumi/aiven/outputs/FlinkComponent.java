...
@CustomType
public final class FlinkComponent {
    ...
    public static Builder builder(FlinkComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FlinkComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            this.usage = usage;
            return this;
        }        public FlinkComponent build() {
            return new FlinkComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
