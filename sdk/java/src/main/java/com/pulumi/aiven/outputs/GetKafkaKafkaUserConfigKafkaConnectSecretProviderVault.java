...
@CustomType
public final class GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault {
    /**
    ...
    private GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault() {}
    /**
     * @return Address of the Vault server.
     * 
     */
    ...
    public static Builder builder(GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault defaults) {
    ...
    public static final class Builder {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault", "address");
            }
        ...
        public Builder authMethod(String authMethod) {
            if (authMethod == null) {
              throw new MissingRequiredPropertyException("GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault", "authMethod");
            }
        ...
        public GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault build() {
            final var _resultValue = new GetKafkaKafkaUserConfigKafkaConnectSecretProviderVault();
