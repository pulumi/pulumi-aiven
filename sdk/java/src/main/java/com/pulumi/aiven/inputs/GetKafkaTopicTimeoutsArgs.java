...
public final class GetKafkaTopicTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKafkaTopicTimeoutsArgs Empty = new GetKafkaTopicTimeoutsArgs();
    ...
    private GetKafkaTopicTimeoutsArgs() {}

    private GetKafkaTopicTimeoutsArgs(GetKafkaTopicTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaTopicTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaTopicTimeoutsArgs();
        }

        public Builder(GetKafkaTopicTimeoutsArgs defaults) {
            $ = new GetKafkaTopicTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaTopicTimeoutsArgs build() {
            return $;
        }
    }
