...
public final class GetServiceListTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceListTimeouts Empty = new GetServiceListTimeouts();
    ...
    private GetServiceListTimeouts() {}

    private GetServiceListTimeouts(GetServiceListTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetServiceListTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceListTimeouts();
        }

        public Builder(GetServiceListTimeouts defaults) {
            $ = new GetServiceListTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceListTimeouts build() {
            return $;
        }
    }
