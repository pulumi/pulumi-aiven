...
public final class KafkaMirrorMakerComponent {
    ...
    public static Builder builder(KafkaMirrorMakerComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KafkaMirrorMakerComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            this.usage = usage;
            return this;
        }        public KafkaMirrorMakerComponent build() {
            return new KafkaMirrorMakerComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
