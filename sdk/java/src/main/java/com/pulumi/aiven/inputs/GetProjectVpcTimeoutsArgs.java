...
public final class GetProjectVpcTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetProjectVpcTimeoutsArgs Empty = new GetProjectVpcTimeoutsArgs();
    ...
    private GetProjectVpcTimeoutsArgs() {}

    private GetProjectVpcTimeoutsArgs(GetProjectVpcTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetProjectVpcTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProjectVpcTimeoutsArgs();
        }

        public Builder(GetProjectVpcTimeoutsArgs defaults) {
            $ = new GetProjectVpcTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetProjectVpcTimeoutsArgs build() {
            return $;
        }
    }
