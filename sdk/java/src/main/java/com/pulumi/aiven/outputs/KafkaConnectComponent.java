...
@CustomType
public final class KafkaConnectComponent {
    ...
    public static Builder builder(KafkaConnectComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KafkaConnectComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            this.usage = usage;
            return this;
        }        public KafkaConnectComponent build() {
            return new KafkaConnectComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
