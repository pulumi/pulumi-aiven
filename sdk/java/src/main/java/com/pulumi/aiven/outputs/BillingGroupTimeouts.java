...
@CustomType
public final class BillingGroupTimeouts {
    /**
    ...
    public static Builder builder(BillingGroupTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(BillingGroupTimeouts defaults) {
        ...
        public BillingGroupTimeouts build() {
            final var _resultValue = new BillingGroupTimeouts();
