...
@CustomType
public final class MySqlComponent {
    ...
    public static Builder builder(MySqlComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MySqlComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            ...
            return new MySqlComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
