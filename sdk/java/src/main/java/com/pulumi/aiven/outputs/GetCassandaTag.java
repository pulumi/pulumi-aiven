...
public final class GetCassandaTag {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCassandaTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetCassandaTag", "value");
            }
            this.value = value;
            return this;
        }
        public GetCassandaTag build() {
            final var _resultValue = new GetCassandaTag();
