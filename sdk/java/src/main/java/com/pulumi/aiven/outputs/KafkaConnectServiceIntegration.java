...
@CustomType
public final class KafkaConnectServiceIntegration {
    /**
    ...
    private KafkaConnectServiceIntegration() {}
    /**
     * @return Type of the service integration
     * 
     */
    ...
    public static Builder builder(KafkaConnectServiceIntegration defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceServiceName;
        public Builder() {}
        public Builder(KafkaConnectServiceIntegration defaults) {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("KafkaConnectServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("KafkaConnectServiceIntegration", "sourceServiceName");
            }
