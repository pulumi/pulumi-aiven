...
public final class ClickhouseClickhouseUserConfigIpFilterObject {
    ...
    public static Builder builder(ClickhouseClickhouseUserConfigIpFilterObject defaults) {
    ...
    public static final class Builder {
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("ClickhouseClickhouseUserConfigIpFilterObject", "network");
            }
