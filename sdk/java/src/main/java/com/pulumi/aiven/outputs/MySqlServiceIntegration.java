    ...
    public static final class Builder {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("MySqlServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("MySqlServiceIntegration", "sourceServiceName");
            }
            this.sourceServiceName = sourceServiceName;
            return this;
        }
        public MySqlServiceIntegration build() {
            final var _resultValue = new MySqlServiceIntegration();
