...
public final class GetMysqlUserTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetMysqlUserTimeouts Empty = new GetMysqlUserTimeouts();
    ...
    private GetMysqlUserTimeouts() {}

    private GetMysqlUserTimeouts(GetMysqlUserTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetMysqlUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMysqlUserTimeouts();
        }

        public Builder(GetMysqlUserTimeouts defaults) {
            $ = new GetMysqlUserTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetMysqlUserTimeouts build() {
            return $;
        }
    }
