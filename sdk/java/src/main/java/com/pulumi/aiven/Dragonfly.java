...
public class Dragonfly extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="dragonflies", refs={List.class,DragonflyDragonfly.class}, tree="[0,1]")
    private Output<List<DragonflyDragonfly>> dragonflies;

    /**
     * @return Dragonfly server provided values
     * 
     */
    public Output<List<DragonflyDragonfly>> dragonflies() {
    ...
    private Output</* @Nullable */ List<DragonflyServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<Optional<List<DragonflyServiceIntegration>>> serviceIntegrations() {
     ...
     */
    public Dragonfly(String name, DragonflyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/dragonfly:Dragonfly", name, args == null ? DragonflyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Dragonfly(String name, Output<String> id, @Nullable DragonflyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/dragonfly:Dragonfly", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static Dragonfly get(String name, Output<String> id, @Nullable DragonflyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
