...
public final class CmkTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CmkTimeoutsArgs Empty = new CmkTimeoutsArgs();
    ...
    private CmkTimeoutsArgs() {}

    private CmkTimeoutsArgs(CmkTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.read = $.read;
        this.update = $.update;
    ...
    public static Builder builder(CmkTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CmkTimeoutsArgs defaults) {
            $ = new CmkTimeoutsArgs(Objects.requireNonNull(defaults));
        }
