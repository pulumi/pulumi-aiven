...
public final class FlinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(FlinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FlinkArgs defaults) {
            $ = new FlinkArgs(Objects.requireNonNull(defaults));
        }
