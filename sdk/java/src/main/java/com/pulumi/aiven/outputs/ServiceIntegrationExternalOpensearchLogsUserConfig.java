...
@CustomType
public final class ServiceIntegrationExternalOpensearchLogsUserConfig {
    /**
    ...
    private ServiceIntegrationExternalOpensearchLogsUserConfig() {}
    /**
     * @return The list of logging fields that will be sent to the integration logging service. The MESSAGE and timestamp fields are always sent.
     * 
     */
    ...
    public static Builder builder(ServiceIntegrationExternalOpensearchLogsUserConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> selectedLogFields;
        public Builder() {}
        public Builder(ServiceIntegrationExternalOpensearchLogsUserConfig defaults) {
        ...
        public ServiceIntegrationExternalOpensearchLogsUserConfig build() {
            final var _resultValue = new ServiceIntegrationExternalOpensearchLogsUserConfig();
