...
@CustomType
public final class GetThanosThanosUserConfigPrivatelinkAccess {
    /**
    ...
    private GetThanosThanosUserConfigPrivatelinkAccess() {}
    /**
     * @return Enable query_frontend.
     * 
     */
    ...
    public static Builder builder(GetThanosThanosUserConfigPrivatelinkAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean receiverRouting;
        public Builder() {}
        public Builder(GetThanosThanosUserConfigPrivatelinkAccess defaults) {
        ...
        public GetThanosThanosUserConfigPrivatelinkAccess build() {
            final var _resultValue = new GetThanosThanosUserConfigPrivatelinkAccess();
