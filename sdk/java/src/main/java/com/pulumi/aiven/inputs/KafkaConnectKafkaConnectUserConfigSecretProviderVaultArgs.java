...
public final class KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs extends com.pulumi.resources.ResourceArgs {

    public static final KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs Empty = new KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs();
    ...
    private KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs() {}

    private KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs(KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs $) {
    ...
    public static Builder builder(KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs();
        }

        public Builder(KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs defaults) {
            $ = new KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs", "address");
            }
            if ($.authMethod == null) {
                throw new MissingRequiredPropertyException("KafkaConnectKafkaConnectUserConfigSecretProviderVaultArgs", "authMethod");
            }
            return $;
        }
    }
