    ...
    public static final class Builder {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("GetFlinkServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("GetFlinkServiceIntegration", "sourceServiceName");
            }
            this.sourceServiceName = sourceServiceName;
            return this;
        }
        public GetFlinkServiceIntegration build() {
            final var _resultValue = new GetFlinkServiceIntegration();
