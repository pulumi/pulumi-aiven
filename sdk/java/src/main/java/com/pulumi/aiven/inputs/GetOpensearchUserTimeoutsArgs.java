...
public final class GetOpensearchUserTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOpensearchUserTimeoutsArgs Empty = new GetOpensearchUserTimeoutsArgs();
    ...
    private GetOpensearchUserTimeoutsArgs() {}

    private GetOpensearchUserTimeoutsArgs(GetOpensearchUserTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOpensearchUserTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOpensearchUserTimeoutsArgs();
        }

        public Builder(GetOpensearchUserTimeoutsArgs defaults) {
            $ = new GetOpensearchUserTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOpensearchUserTimeoutsArgs build() {
            return $;
        }
    }
