...
public class M3Aggregator extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<List<M3AggregatorComponent>> components() {
     ...
     * 
     */
    public Output<Optional<M3AggregatorM3aggregatorUserConfig>> m3aggregatorUserConfig() {
        return Codegen.optional(this.m3aggregatorUserConfig);
    }
    /**
    ...
    private Output<List<M3AggregatorServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<M3AggregatorServiceIntegration>> serviceIntegrations() {
     ...
     */
    public M3Aggregator(java.lang.String name) {
        this(name, M3AggregatorArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public M3Aggregator(java.lang.String name, M3AggregatorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public M3Aggregator(java.lang.String name, M3AggregatorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/m3Aggregator:M3Aggregator", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private M3Aggregator(java.lang.String name, Output<java.lang.String> id, @Nullable M3AggregatorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/m3Aggregator:M3Aggregator", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static M3Aggregator get(java.lang.String name, Output<java.lang.String> id, @Nullable M3AggregatorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
