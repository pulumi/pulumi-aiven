...
public class M3Aggregator extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<List<M3AggregatorM3aggregator>> m3aggregators() {
     ...
     */
    public M3Aggregator(String name) {
     ...
     */
    public M3Aggregator(String name, M3AggregatorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static M3Aggregator get(String name, Output<String> id, @Nullable M3AggregatorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
