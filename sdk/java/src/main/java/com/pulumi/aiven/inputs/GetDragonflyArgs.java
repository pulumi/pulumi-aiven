...
public final class GetDragonflyArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDragonflyArgs Empty = new GetDragonflyArgs();
    ...
    private GetDragonflyArgs() {}

    private GetDragonflyArgs(GetDragonflyArgs $) {
    ...
    public static Builder builder(GetDragonflyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDragonflyArgs();
        }

        public Builder(GetDragonflyArgs defaults) {
            $ = new GetDragonflyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDragonflyArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetDragonflyArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetDragonflyArgs", "serviceName");
            }
            return $;
        }
    }
