...
@CustomType
public final class MysqlUserTimeouts {
    /**
    ...
    public static Builder builder(MysqlUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(MysqlUserTimeouts defaults) {
        ...
        public MysqlUserTimeouts build() {
            final var _resultValue = new MysqlUserTimeouts();
