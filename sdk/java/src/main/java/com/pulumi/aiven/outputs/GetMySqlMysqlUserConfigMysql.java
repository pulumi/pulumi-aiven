...
public final class GetMySqlMysqlUserConfigMysql {
    ...
    /**
     * @return The number of I/O operations per second (IOPS) available to InnoDB background tasks, such as flushing pages from the buffer pool and merging data from the change buffer. Set this to a value appropriate for the underlying storage; it must not exceed innodb_io_capacity_max. Example: `2000`.
     * 
     */
    ...
    public static final class Builder {
        ...
        public GetMySqlMysqlUserConfigMysql build() {
            final var _resultValue = new GetMySqlMysqlUserConfigMysql();
