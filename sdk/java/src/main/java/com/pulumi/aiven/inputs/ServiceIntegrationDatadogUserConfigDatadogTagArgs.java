...
public final class ServiceIntegrationDatadogUserConfigDatadogTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param comment Optional tag explanation. Example: `Used to tag primary replica metrics`.
         * 
         * @return builder
         * 
         */
        ...
        public ServiceIntegrationDatadogUserConfigDatadogTagArgs build() {
            if ($.tag == null) {
                throw new MissingRequiredPropertyException("ServiceIntegrationDatadogUserConfigDatadogTagArgs", "tag");
            }
            return $;
        }
    }
