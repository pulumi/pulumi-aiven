...
@CustomType
public final class ValkeyComponent {
    /**
    ...
    public static Builder builder(ValkeyComponent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usage;
        public Builder() {}
        public Builder(ValkeyComponent defaults) {
        ...
        public ValkeyComponent build() {
            final var _resultValue = new ValkeyComponent();
