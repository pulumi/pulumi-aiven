...
@CustomType
public final class KafkaComponent {
    ...
    public static Builder builder(KafkaComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KafkaComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            this.usage = usage;
            return this;
        }        public KafkaComponent build() {
            return new KafkaComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
