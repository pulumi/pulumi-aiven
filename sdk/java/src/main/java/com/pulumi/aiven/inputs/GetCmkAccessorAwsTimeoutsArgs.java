...
public final class GetCmkAccessorAwsTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCmkAccessorAwsTimeoutsArgs Empty = new GetCmkAccessorAwsTimeoutsArgs();
    ...
    private GetCmkAccessorAwsTimeoutsArgs() {}

    private GetCmkAccessorAwsTimeoutsArgs(GetCmkAccessorAwsTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetCmkAccessorAwsTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCmkAccessorAwsTimeoutsArgs();
        }

        public Builder(GetCmkAccessorAwsTimeoutsArgs defaults) {
            $ = new GetCmkAccessorAwsTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCmkAccessorAwsTimeoutsArgs build() {
            return $;
        }
    }
