...
public final class GetMysqlDatabaseTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMysqlDatabaseTimeoutsArgs Empty = new GetMysqlDatabaseTimeoutsArgs();
    ...
    private GetMysqlDatabaseTimeoutsArgs() {}

    private GetMysqlDatabaseTimeoutsArgs(GetMysqlDatabaseTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetMysqlDatabaseTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMysqlDatabaseTimeoutsArgs();
        }

        public Builder(GetMysqlDatabaseTimeoutsArgs defaults) {
            $ = new GetMysqlDatabaseTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMysqlDatabaseTimeoutsArgs build() {
            return $;
        }
    }
