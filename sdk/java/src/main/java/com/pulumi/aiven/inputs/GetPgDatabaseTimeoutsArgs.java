...
public final class GetPgDatabaseTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPgDatabaseTimeoutsArgs Empty = new GetPgDatabaseTimeoutsArgs();
    ...
    private GetPgDatabaseTimeoutsArgs() {}

    private GetPgDatabaseTimeoutsArgs(GetPgDatabaseTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetPgDatabaseTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPgDatabaseTimeoutsArgs();
        }

        public Builder(GetPgDatabaseTimeoutsArgs defaults) {
            $ = new GetPgDatabaseTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPgDatabaseTimeoutsArgs build() {
            return $;
        }
    }
