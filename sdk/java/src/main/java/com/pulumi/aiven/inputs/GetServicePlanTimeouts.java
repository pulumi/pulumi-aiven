...
public final class GetServicePlanTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetServicePlanTimeouts Empty = new GetServicePlanTimeouts();
    ...
    private GetServicePlanTimeouts() {}

    private GetServicePlanTimeouts(GetServicePlanTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetServicePlanTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServicePlanTimeouts();
        }

        public Builder(GetServicePlanTimeouts defaults) {
            $ = new GetServicePlanTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetServicePlanTimeouts build() {
            return $;
        }
    }
