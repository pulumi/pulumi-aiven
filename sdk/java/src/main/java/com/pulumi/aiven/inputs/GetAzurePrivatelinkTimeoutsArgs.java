...
public final class GetAzurePrivatelinkTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAzurePrivatelinkTimeoutsArgs Empty = new GetAzurePrivatelinkTimeoutsArgs();
    ...
    private GetAzurePrivatelinkTimeoutsArgs() {}

    private GetAzurePrivatelinkTimeoutsArgs(GetAzurePrivatelinkTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetAzurePrivatelinkTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAzurePrivatelinkTimeoutsArgs();
        }

        public Builder(GetAzurePrivatelinkTimeoutsArgs defaults) {
            $ = new GetAzurePrivatelinkTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAzurePrivatelinkTimeoutsArgs build() {
            return $;
        }
    }
