...
public final class GetCmkAccessorOciTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCmkAccessorOciTimeoutsArgs Empty = new GetCmkAccessorOciTimeoutsArgs();
    ...
    private GetCmkAccessorOciTimeoutsArgs() {}

    private GetCmkAccessorOciTimeoutsArgs(GetCmkAccessorOciTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetCmkAccessorOciTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCmkAccessorOciTimeoutsArgs();
        }

        public Builder(GetCmkAccessorOciTimeoutsArgs defaults) {
            $ = new GetCmkAccessorOciTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCmkAccessorOciTimeoutsArgs build() {
            return $;
        }
    }
