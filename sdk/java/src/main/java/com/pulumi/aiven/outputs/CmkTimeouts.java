...
@CustomType
public final class CmkTimeouts {
    /**
    ...
    public static Builder builder(CmkTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(CmkTimeouts defaults) {
        ...
        public CmkTimeouts build() {
            final var _resultValue = new CmkTimeouts();
