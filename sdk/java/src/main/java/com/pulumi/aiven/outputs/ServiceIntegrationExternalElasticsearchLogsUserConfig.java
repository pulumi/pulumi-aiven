...
@CustomType
public final class ServiceIntegrationExternalElasticsearchLogsUserConfig {
    /**
    ...
    private ServiceIntegrationExternalElasticsearchLogsUserConfig() {}
    /**
     * @return The list of logging fields that will be sent to the integration logging service. The MESSAGE and timestamp fields are always sent.
     * 
     */
    ...
    public static Builder builder(ServiceIntegrationExternalElasticsearchLogsUserConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> selectedLogFields;
        public Builder() {}
        public Builder(ServiceIntegrationExternalElasticsearchLogsUserConfig defaults) {
        ...
        public ServiceIntegrationExternalElasticsearchLogsUserConfig build() {
            final var _resultValue = new ServiceIntegrationExternalElasticsearchLogsUserConfig();
