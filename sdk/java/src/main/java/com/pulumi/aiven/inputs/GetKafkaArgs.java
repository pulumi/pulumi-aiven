...
public final class GetKafkaArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetKafkaArgs Empty = new GetKafkaArgs();
    ...
    private GetKafkaArgs() {}

    private GetKafkaArgs(GetKafkaArgs $) {
    ...
    public static Builder builder(GetKafkaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetKafkaArgs defaults) {
            $ = new GetKafkaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetKafkaArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetKafkaArgs", "serviceName");
            }
            return $;
        }
    }
