...
@CustomType
public final class MysqlDatabaseTimeouts {
    /**
    ...
    public static Builder builder(MysqlDatabaseTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(MysqlDatabaseTimeouts defaults) {
        ...
        public MysqlDatabaseTimeouts build() {
            final var _resultValue = new MysqlDatabaseTimeouts();
