...
public final class GetOrganizationAddressTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOrganizationAddressTimeoutsArgs Empty = new GetOrganizationAddressTimeoutsArgs();
    ...
    private GetOrganizationAddressTimeoutsArgs() {}

    private GetOrganizationAddressTimeoutsArgs(GetOrganizationAddressTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOrganizationAddressTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOrganizationAddressTimeoutsArgs();
        }

        public Builder(GetOrganizationAddressTimeoutsArgs defaults) {
            $ = new GetOrganizationAddressTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOrganizationAddressTimeoutsArgs build() {
            return $;
        }
    }
