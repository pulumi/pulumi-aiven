...
public final class GetAwsPrivatelinkTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAwsPrivatelinkTimeoutsArgs Empty = new GetAwsPrivatelinkTimeoutsArgs();
    ...
    private GetAwsPrivatelinkTimeoutsArgs() {}

    private GetAwsPrivatelinkTimeoutsArgs(GetAwsPrivatelinkTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetAwsPrivatelinkTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAwsPrivatelinkTimeoutsArgs();
        }

        public Builder(GetAwsPrivatelinkTimeoutsArgs defaults) {
            $ = new GetAwsPrivatelinkTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAwsPrivatelinkTimeoutsArgs build() {
            return $;
        }
    }
