...
public final class GetCmkAccessorGcpTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCmkAccessorGcpTimeoutsArgs Empty = new GetCmkAccessorGcpTimeoutsArgs();
    ...
    private GetCmkAccessorGcpTimeoutsArgs() {}

    private GetCmkAccessorGcpTimeoutsArgs(GetCmkAccessorGcpTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetCmkAccessorGcpTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCmkAccessorGcpTimeoutsArgs();
        }

        public Builder(GetCmkAccessorGcpTimeoutsArgs defaults) {
            $ = new GetCmkAccessorGcpTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCmkAccessorGcpTimeoutsArgs build() {
            return $;
        }
    }
