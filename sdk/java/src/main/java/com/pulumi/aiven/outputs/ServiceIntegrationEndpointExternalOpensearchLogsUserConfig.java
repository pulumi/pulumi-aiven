...
public final class ServiceIntegrationEndpointExternalOpensearchLogsUserConfig {
    ...
    public static final class Builder {
        ...
        public Builder indexPrefix(String indexPrefix) {
            if (indexPrefix == null) {
              throw new MissingRequiredPropertyException("ServiceIntegrationEndpointExternalOpensearchLogsUserConfig", "indexPrefix");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ServiceIntegrationEndpointExternalOpensearchLogsUserConfig", "url");
            }
            this.url = url;
            return this;
        }
        public ServiceIntegrationEndpointExternalOpensearchLogsUserConfig build() {
            final var _resultValue = new ServiceIntegrationEndpointExternalOpensearchLogsUserConfig();
            _resultValue.ca = ca;
