...
public final class GetMysqlUserTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMysqlUserTimeoutsArgs Empty = new GetMysqlUserTimeoutsArgs();
    ...
    private GetMysqlUserTimeoutsArgs() {}

    private GetMysqlUserTimeoutsArgs(GetMysqlUserTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetMysqlUserTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMysqlUserTimeoutsArgs();
        }

        public Builder(GetMysqlUserTimeoutsArgs defaults) {
            $ = new GetMysqlUserTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMysqlUserTimeoutsArgs build() {
            return $;
        }
    }
