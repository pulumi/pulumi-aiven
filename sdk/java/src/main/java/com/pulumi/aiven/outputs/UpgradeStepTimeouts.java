...
@CustomType
public final class UpgradeStepTimeouts {
    /**
    ...
    public static Builder builder(UpgradeStepTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(UpgradeStepTimeouts defaults) {
        ...
        public UpgradeStepTimeouts build() {
            final var _resultValue = new UpgradeStepTimeouts();
