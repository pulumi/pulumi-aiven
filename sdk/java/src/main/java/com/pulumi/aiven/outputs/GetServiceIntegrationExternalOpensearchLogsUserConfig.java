...
@CustomType
public final class GetServiceIntegrationExternalOpensearchLogsUserConfig {
    /**
    ...
    private GetServiceIntegrationExternalOpensearchLogsUserConfig() {}
    /**
     * @return The list of logging fields that will be sent to the integration logging service. The MESSAGE and timestamp fields are always sent.
     * 
     */
    ...
    public static Builder builder(GetServiceIntegrationExternalOpensearchLogsUserConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> selectedLogFields;
        public Builder() {}
        public Builder(GetServiceIntegrationExternalOpensearchLogsUserConfig defaults) {
        ...
        public GetServiceIntegrationExternalOpensearchLogsUserConfig build() {
            final var _resultValue = new GetServiceIntegrationExternalOpensearchLogsUserConfig();
