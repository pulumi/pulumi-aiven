...
@CustomType
public final class OrganizationTimeouts {
    /**
    ...
    public static Builder builder(OrganizationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(OrganizationTimeouts defaults) {
