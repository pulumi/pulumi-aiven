...
public final class GetMySqlArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMySqlArgs Empty = new GetMySqlArgs();
    ...
    private GetMySqlArgs() {}

    private GetMySqlArgs(GetMySqlArgs $) {
    ...
    public static Builder builder(GetMySqlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetMySqlArgs defaults) {
            $ = new GetMySqlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMySqlArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetMySqlArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetMySqlArgs", "serviceName");
            }
            return $;
        }
    }
