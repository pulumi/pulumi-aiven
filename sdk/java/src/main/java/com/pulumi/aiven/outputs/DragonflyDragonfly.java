...
@CustomType
public final class DragonflyDragonfly {
    /**
    ...
    public static Builder builder(DragonflyDragonfly defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> uris;
        public Builder() {}
        public Builder(DragonflyDragonfly defaults) {
        ...
        public DragonflyDragonfly build() {
            final var _resultValue = new DragonflyDragonfly();
