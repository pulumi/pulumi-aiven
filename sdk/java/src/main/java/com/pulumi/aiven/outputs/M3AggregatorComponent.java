...
@CustomType
public final class M3AggregatorComponent {
    ...
    public static Builder builder(M3AggregatorComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(M3AggregatorComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            ...
            return new M3AggregatorComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
