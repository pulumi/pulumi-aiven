...
public final class GetConnectionPoolTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetConnectionPoolTimeoutsArgs Empty = new GetConnectionPoolTimeoutsArgs();
    ...
    private GetConnectionPoolTimeoutsArgs() {}

    private GetConnectionPoolTimeoutsArgs(GetConnectionPoolTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetConnectionPoolTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetConnectionPoolTimeoutsArgs();
        }

        public Builder(GetConnectionPoolTimeoutsArgs defaults) {
            $ = new GetConnectionPoolTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetConnectionPoolTimeoutsArgs build() {
            return $;
        }
    }
