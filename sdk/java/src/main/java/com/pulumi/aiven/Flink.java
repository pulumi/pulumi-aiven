...
public class Flink extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="components", type=List.class, parameters={FlinkComponent.class})
     ...
     * 
     */
    @Export(name="flink", type=FlinkFlink.class, parameters={})
     ...
     * 
     */
    @Export(name="flinkUserConfig", type=FlinkFlinkUserConfig.class, parameters={})
     ...
     * 
     */
    @Export(name="serviceIntegrations", type=List.class, parameters={FlinkServiceIntegration.class})
    private Output</* @Nullable */ List<FlinkServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<Optional<List<FlinkServiceIntegration>>> serviceIntegrations() {
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={FlinkTag.class})
    ...
    public Flink(String name, FlinkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/flink:Flink", name, args == null ? FlinkArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
