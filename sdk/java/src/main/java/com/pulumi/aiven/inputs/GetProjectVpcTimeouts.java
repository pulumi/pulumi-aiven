...
public final class GetProjectVpcTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetProjectVpcTimeouts Empty = new GetProjectVpcTimeouts();
    ...
    private GetProjectVpcTimeouts() {}

    private GetProjectVpcTimeouts(GetProjectVpcTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetProjectVpcTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProjectVpcTimeouts();
        }

        public Builder(GetProjectVpcTimeouts defaults) {
            $ = new GetProjectVpcTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetProjectVpcTimeouts build() {
            return $;
        }
    }
