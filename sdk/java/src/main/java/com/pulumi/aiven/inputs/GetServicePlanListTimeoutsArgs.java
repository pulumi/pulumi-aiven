...
public final class GetServicePlanListTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetServicePlanListTimeoutsArgs Empty = new GetServicePlanListTimeoutsArgs();
    ...
    private GetServicePlanListTimeoutsArgs() {}

    private GetServicePlanListTimeoutsArgs(GetServicePlanListTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetServicePlanListTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServicePlanListTimeoutsArgs();
        }

        public Builder(GetServicePlanListTimeoutsArgs defaults) {
            $ = new GetServicePlanListTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServicePlanListTimeoutsArgs build() {
            return $;
        }
    }
