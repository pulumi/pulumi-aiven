...
@CustomType
public final class MySqlMysqlUserConfigIpFilterObject {
    /**
    ...
    public static Builder builder(MySqlMysqlUserConfigIpFilterObject defaults) {
    ...
    public static final class Builder {
        ...
        private String network;
        public Builder() {}
        public Builder(MySqlMysqlUserConfigIpFilterObject defaults) {
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("MySqlMysqlUserConfigIpFilterObject", "network");
            }
