    ...
    public static final class Builder {
        ...
        public InfluxDbServiceIntegrationArgs build() {
            if ($.integrationType == null) {
                throw new MissingRequiredPropertyException("InfluxDbServiceIntegrationArgs", "integrationType");
            }
            if ($.sourceServiceName == null) {
                throw new MissingRequiredPropertyException("InfluxDbServiceIntegrationArgs", "sourceServiceName");
            }
            return $;
        }
    }
