...
public final class GetKafkaTopicListTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKafkaTopicListTimeoutsArgs Empty = new GetKafkaTopicListTimeoutsArgs();
    ...
    private GetKafkaTopicListTimeoutsArgs() {}

    private GetKafkaTopicListTimeoutsArgs(GetKafkaTopicListTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaTopicListTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaTopicListTimeoutsArgs();
        }

        public Builder(GetKafkaTopicListTimeoutsArgs defaults) {
            $ = new GetKafkaTopicListTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaTopicListTimeoutsArgs build() {
            return $;
        }
    }
