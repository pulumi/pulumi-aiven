...
@CustomType
public final class GetServiceIntegrationExternalAwsCloudwatchLogsUserConfig {
    /**
    ...
    private GetServiceIntegrationExternalAwsCloudwatchLogsUserConfig() {}
    /**
     * @return The list of logging fields that will be sent to the integration logging service. The MESSAGE and timestamp fields are always sent.
     * 
     */
    ...
    public static Builder builder(GetServiceIntegrationExternalAwsCloudwatchLogsUserConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> selectedLogFields;
        public Builder() {}
        public Builder(GetServiceIntegrationExternalAwsCloudwatchLogsUserConfig defaults) {
        ...
        public GetServiceIntegrationExternalAwsCloudwatchLogsUserConfig build() {
            final var _resultValue = new GetServiceIntegrationExternalAwsCloudwatchLogsUserConfig();
