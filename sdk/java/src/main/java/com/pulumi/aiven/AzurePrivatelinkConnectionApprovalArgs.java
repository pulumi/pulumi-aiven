...
public final class AzurePrivatelinkConnectionApprovalArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AzurePrivatelinkConnectionApprovalArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("AzurePrivatelinkConnectionApprovalArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("AzurePrivatelinkConnectionApprovalArgs", "serviceName");
            }
            return $;
        }
    }
