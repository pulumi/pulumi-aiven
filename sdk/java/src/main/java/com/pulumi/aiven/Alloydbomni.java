...
import com.pulumi.aiven.inputs.AlloydbomniState;
import com.pulumi.aiven.outputs.AlloydbomniAlloydbomni;
import com.pulumi.aiven.outputs.AlloydbomniAlloydbomniUserConfig;
import com.pulumi.aiven.outputs.AlloydbomniComponent;
import com.pulumi.aiven.outputs.AlloydbomniServiceIntegration;
import com.pulumi.aiven.outputs.AlloydbomniTag;
import com.pulumi.aiven.outputs.AlloydbomniTechEmail;
 ...
 * 
 */
@ResourceType(type="aiven:index/alloydbomni:Alloydbomni")
public class Alloydbomni extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="alloydbomni", refs={AlloydbomniAlloydbomni.class}, tree="[0]")
    private Output<AlloydbomniAlloydbomni> alloydbomni;

    /**
     * @return Values provided by the AlloyDB Omni server.
     * 
     */
    public Output<AlloydbomniAlloydbomni> alloydbomni() {
        return this.alloydbomni;
    }
    /**
     ...
     * 
     */
    public Output<Optional<AlloydbomniAlloydbomniUserConfig>> alloydbomniUserConfig() {
        return Codegen.optional(this.alloydbomniUserConfig);
    }
    /**
     ...
     * 
     */
    @Export(name="components", refs={List.class,AlloydbomniComponent.class}, tree="[0,1]")
    private Output<List<AlloydbomniComponent>> components;

    /**
     * @return Service component information objects
     * 
     */
    public Output<List<AlloydbomniComponent>> components() {
     ...
     * 
     */
    @Export(name="serviceAccountCredentials", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> serviceAccountCredentials;

    /**
     * @return Your [Google service account key](https://cloud.google.com/iam/docs/service-account-creds#key-types) in JSON format.
     * 
     */
    public Output<Optional<String>> serviceAccountCredentials() {
        return Codegen.optional(this.serviceAccountCredentials);
    }
    /**
     ...
     * 
     */
    @Export(name="serviceIntegrations", refs={List.class,AlloydbomniServiceIntegration.class}, tree="[0,1]")
    private Output<List<AlloydbomniServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<AlloydbomniServiceIntegration>> serviceIntegrations() {
     ...
     * 
     */
    @Export(name="tags", refs={List.class,AlloydbomniTag.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AlloydbomniTag>> tags;

    /**
     * @return Tags are key-value pairs that allow you to categorize services.
     * 
     */
    public Output<Optional<List<AlloydbomniTag>>> tags() {
     ...
     * 
     */
    @Export(name="techEmails", refs={List.class,AlloydbomniTechEmail.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AlloydbomniTechEmail>> techEmails;
     ...
     * 
     */
    public Output<Optional<List<AlloydbomniTechEmail>>> techEmails() {
     ...
     */
    public Alloydbomni(java.lang.String name) {
        this(name, AlloydbomniArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Alloydbomni(java.lang.String name, AlloydbomniArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Alloydbomni(java.lang.String name, AlloydbomniArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/alloydbomni:Alloydbomni", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Alloydbomni(java.lang.String name, Output<java.lang.String> id, @Nullable AlloydbomniState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/alloydbomni:Alloydbomni", name, state, makeResourceOptions(options, id), false);
    }

    private static AlloydbomniArgs makeArgs(AlloydbomniArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AlloydbomniArgs.Empty : args;
    }
     ...
     */
    public static Alloydbomni get(java.lang.String name, Output<java.lang.String> id, @Nullable AlloydbomniState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Alloydbomni(name, id, state, options);
    }
}
