...
public final class GetCassandraCassandraUserConfigPublicAccess {
    ...
    private GetCassandraCassandraUserConfigPublicAccess(@CustomType.Parameter("prometheus") @Nullable String prometheus) {
    ...
    public static final class Builder {
        ...
        public Builder prometheus(@Nullable String prometheus) {
            ...
            return new GetCassandraCassandraUserConfigPublicAccess(prometheus);
        }
    }
}
