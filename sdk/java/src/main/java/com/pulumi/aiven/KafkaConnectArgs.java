...
public final class KafkaConnectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private KafkaConnectArgs() {}

    private KafkaConnectArgs(KafkaConnectArgs $) {
    ...
    public static Builder builder(KafkaConnectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KafkaConnectArgs defaults) {
            $ = new KafkaConnectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaConnectArgs build() {
            if ($.plan == null) {
                throw new MissingRequiredPropertyException("KafkaConnectArgs", "plan");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("KafkaConnectArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("KafkaConnectArgs", "serviceName");
            }
            return $;
        }
    }
