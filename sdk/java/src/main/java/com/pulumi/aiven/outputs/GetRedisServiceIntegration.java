...
@CustomType
public final class GetRedisServiceIntegration {
    /**
    ...
    private GetRedisServiceIntegration() {}
    /**
     * @return Type of the service integration. The possible value is `read_replica`.
     * 
     */
    ...
    public static Builder builder(GetRedisServiceIntegration defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceServiceName;
        public Builder() {}
        public Builder(GetRedisServiceIntegration defaults) {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("GetRedisServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("GetRedisServiceIntegration", "sourceServiceName");
            }
