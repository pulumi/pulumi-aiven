...
public final class GetKafkaUserTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKafkaUserTimeoutsArgs Empty = new GetKafkaUserTimeoutsArgs();
    ...
    private GetKafkaUserTimeoutsArgs() {}

    private GetKafkaUserTimeoutsArgs(GetKafkaUserTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaUserTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaUserTimeoutsArgs();
        }

        public Builder(GetKafkaUserTimeoutsArgs defaults) {
            $ = new GetKafkaUserTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaUserTimeoutsArgs build() {
            return $;
        }
    }
