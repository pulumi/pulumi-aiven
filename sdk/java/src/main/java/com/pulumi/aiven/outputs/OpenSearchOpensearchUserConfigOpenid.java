...
public final class OpenSearchOpensearchUserConfigOpenid {
    ...
    public static Builder builder(OpenSearchOpensearchUserConfigOpenid defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subjectKey;
        public Builder() {}
        public Builder(OpenSearchOpensearchUserConfigOpenid defaults) {
        ...
        public OpenSearchOpensearchUserConfigOpenid build() {
            final var _resultValue = new OpenSearchOpensearchUserConfigOpenid();
