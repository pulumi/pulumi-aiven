...
@CustomType
public final class FlinkJarApplicationVersionFileInfo {
    /**
    ...
    private FlinkJarApplicationVersionFileInfo() {}
    /**
     * @return sha256 of the file if known.
     * 
     */
    ...
    public static Builder builder(FlinkJarApplicationVersionFileInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String verifyErrorMessage;
        public Builder() {}
        public Builder(FlinkJarApplicationVersionFileInfo defaults) {
        ...
        public FlinkJarApplicationVersionFileInfo build() {
            final var _resultValue = new FlinkJarApplicationVersionFileInfo();
