...
@CustomType
public final class PgUserTimeouts {
    /**
    ...
    public static Builder builder(PgUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PgUserTimeouts defaults) {
        ...
        public PgUserTimeouts build() {
            final var _resultValue = new PgUserTimeouts();
