...
public class AccountAuthentication extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccountAuthentication(java.lang.String name) {
     ...
     */
    public AccountAuthentication(java.lang.String name, AccountAuthenticationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccountAuthentication(java.lang.String name, AccountAuthenticationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/accountAuthentication:AccountAuthentication", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AccountAuthentication(java.lang.String name, Output<java.lang.String> id, @Nullable AccountAuthenticationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/accountAuthentication:AccountAuthentication", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AccountAuthentication get(java.lang.String name, Output<java.lang.String> id, @Nullable AccountAuthenticationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
