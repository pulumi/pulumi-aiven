...
@CustomType
public final class ValkeyValkeyUserConfigPrivateAccess {
    /**
    ...
    private ValkeyValkeyUserConfigPrivateAccess() {}
    /**
     * @return Allow clients to connect to prometheus with a DNS name that always resolves to the service&#39;s private IP addresses. Only available in certain network locations.
     * 
     */
    ...
    public static Builder builder(ValkeyValkeyUserConfigPrivateAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean valkey;
        public Builder() {}
        public Builder(ValkeyValkeyUserConfigPrivateAccess defaults) {
        ...
        public ValkeyValkeyUserConfigPrivateAccess build() {
            final var _resultValue = new ValkeyValkeyUserConfigPrivateAccess();
