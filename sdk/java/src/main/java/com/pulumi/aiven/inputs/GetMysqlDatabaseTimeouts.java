...
public final class GetMysqlDatabaseTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetMysqlDatabaseTimeouts Empty = new GetMysqlDatabaseTimeouts();
    ...
    private GetMysqlDatabaseTimeouts() {}

    private GetMysqlDatabaseTimeouts(GetMysqlDatabaseTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetMysqlDatabaseTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMysqlDatabaseTimeouts();
        }

        public Builder(GetMysqlDatabaseTimeouts defaults) {
            $ = new GetMysqlDatabaseTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetMysqlDatabaseTimeouts build() {
            return $;
        }
    }
