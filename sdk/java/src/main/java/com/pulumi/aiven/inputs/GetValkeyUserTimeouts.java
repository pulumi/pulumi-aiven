...
public final class GetValkeyUserTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetValkeyUserTimeouts Empty = new GetValkeyUserTimeouts();
    ...
    private GetValkeyUserTimeouts() {}

    private GetValkeyUserTimeouts(GetValkeyUserTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetValkeyUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetValkeyUserTimeouts();
        }

        public Builder(GetValkeyUserTimeouts defaults) {
            $ = new GetValkeyUserTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetValkeyUserTimeouts build() {
            return $;
        }
    }
