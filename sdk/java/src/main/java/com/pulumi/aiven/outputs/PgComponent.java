...
@CustomType
public final class PgComponent {
    ...
    public static Builder builder(PgComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PgComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            this.usage = usage;
            return this;
        }        public PgComponent build() {
            return new PgComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
