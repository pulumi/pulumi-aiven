...
@CustomType
public final class ByocAwsEntityTimeouts {
    /**
    ...
    public static Builder builder(ByocAwsEntityTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ByocAwsEntityTimeouts defaults) {
        ...
        public ByocAwsEntityTimeouts build() {
            final var _resultValue = new ByocAwsEntityTimeouts();
