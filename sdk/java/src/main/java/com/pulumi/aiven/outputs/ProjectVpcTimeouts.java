...
@CustomType
public final class ProjectVpcTimeouts {
    /**
    ...
    public static Builder builder(ProjectVpcTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ProjectVpcTimeouts defaults) {
        ...
        public ProjectVpcTimeouts build() {
            final var _resultValue = new ProjectVpcTimeouts();
