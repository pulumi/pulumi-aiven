...
@CustomType
public final class KafkaUserTimeouts {
    /**
    ...
    public static Builder builder(KafkaUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(KafkaUserTimeouts defaults) {
        ...
        public KafkaUserTimeouts build() {
            final var _resultValue = new KafkaUserTimeouts();
