...
@CustomType
public final class FlinkFlinkUserConfigPublicAccess {
    /**
    ...
    private FlinkFlinkUserConfigPublicAccess() {}
    /**
     * @return Allow clients to connect to flink from the public internet for service nodes that are in a project VPC or another type of private network.
     * 
     */
    ...
    public static Builder builder(FlinkFlinkUserConfigPublicAccess defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean flink;
        public Builder() {}
        public Builder(FlinkFlinkUserConfigPublicAccess defaults) {
        ...
        public FlinkFlinkUserConfigPublicAccess build() {
            final var _resultValue = new FlinkFlinkUserConfigPublicAccess();
