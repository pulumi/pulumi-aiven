...
@CustomType
public final class ValkeyUserTimeouts {
    /**
    ...
    public static Builder builder(ValkeyUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ValkeyUserTimeouts defaults) {
        ...
        public ValkeyUserTimeouts build() {
            final var _resultValue = new ValkeyUserTimeouts();
