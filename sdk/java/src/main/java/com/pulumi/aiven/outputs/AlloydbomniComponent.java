...
@CustomType
public final class AlloydbomniComponent {
    /**
    ...
    public static Builder builder(AlloydbomniComponent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usage;
        public Builder() {}
        public Builder(AlloydbomniComponent defaults) {
        ...
        public AlloydbomniComponent build() {
            final var _resultValue = new AlloydbomniComponent();
