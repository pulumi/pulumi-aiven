...
public final class GetKafkaUserTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetKafkaUserTimeouts Empty = new GetKafkaUserTimeouts();
    ...
    private GetKafkaUserTimeouts() {}

    private GetKafkaUserTimeouts(GetKafkaUserTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaUserTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaUserTimeouts();
        }

        public Builder(GetKafkaUserTimeouts defaults) {
            $ = new GetKafkaUserTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaUserTimeouts build() {
            return $;
        }
    }
