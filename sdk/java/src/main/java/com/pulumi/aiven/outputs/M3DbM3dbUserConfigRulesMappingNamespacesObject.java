...
@CustomType
public final class M3DbM3dbUserConfigRulesMappingNamespacesObject {
    /**
    ...
    public static Builder builder(M3DbM3dbUserConfigRulesMappingNamespacesObject defaults) {
