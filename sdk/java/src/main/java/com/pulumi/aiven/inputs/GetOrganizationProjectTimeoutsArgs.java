...
public final class GetOrganizationProjectTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOrganizationProjectTimeoutsArgs Empty = new GetOrganizationProjectTimeoutsArgs();
    ...
    private GetOrganizationProjectTimeoutsArgs() {}

    private GetOrganizationProjectTimeoutsArgs(GetOrganizationProjectTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOrganizationProjectTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOrganizationProjectTimeoutsArgs();
        }

        public Builder(GetOrganizationProjectTimeoutsArgs defaults) {
            $ = new GetOrganizationProjectTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOrganizationProjectTimeoutsArgs build() {
            return $;
        }
    }
