...
@CustomType
public final class InfluxDbComponent {
    ...
    public static Builder builder(InfluxDbComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InfluxDbComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            this.usage = usage;
            return this;
        }        public InfluxDbComponent build() {
            return new InfluxDbComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
