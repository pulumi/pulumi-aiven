...
public final class KafkaTopicConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return cleanup.policy value. The possible values are `delete`, `compact` and `compact,delete`.
     * 
     */
    ...
    /**
     * @return compression.type value. The possible values are `snappy`, `gzip`, `lz4`, `producer`, `uncompressed` and `zstd`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param cleanupPolicy cleanup.policy value. The possible values are `delete`, `compact` and `compact,delete`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param compressionType compression.type value. The possible values are `snappy`, `gzip`, `lz4`, `producer`, `uncompressed` and `zstd`.
         * 
         * @return builder
         * 
         */
