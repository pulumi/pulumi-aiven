...
@CustomType
public final class AlloydbomniAlloydbomniUserConfigPrivateAccess {
    /**
    ...
    public static Builder builder(AlloydbomniAlloydbomniUserConfigPrivateAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean prometheus;
        public Builder() {}
        public Builder(AlloydbomniAlloydbomniUserConfigPrivateAccess defaults) {
        ...
        public AlloydbomniAlloydbomniUserConfigPrivateAccess build() {
            final var _resultValue = new AlloydbomniAlloydbomniUserConfigPrivateAccess();
            _resultValue.pg = pg;
