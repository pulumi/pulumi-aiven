...
@CustomType
public final class GetPgServiceIntegration {
    /**
    ...
    private GetPgServiceIntegration() {}
    /**
     * @return Type of the service integration. The only supported value at the moment is `read_replica`
     * 
     */
    ...
    public static Builder builder(GetPgServiceIntegration defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceServiceName;
        public Builder() {}
        public Builder(GetPgServiceIntegration defaults) {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("GetPgServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("GetPgServiceIntegration", "sourceServiceName");
            }
