...
public final class AlloydbomniAlloydbomniUserConfigPgauditArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlloydbomniAlloydbomniUserConfigPgauditArgs Empty = new AlloydbomniAlloydbomniUserConfigPgauditArgs();
    ...
    private AlloydbomniAlloydbomniUserConfigPgauditArgs() {}

    private AlloydbomniAlloydbomniUserConfigPgauditArgs(AlloydbomniAlloydbomniUserConfigPgauditArgs $) {
    ...
    public static Builder builder(AlloydbomniAlloydbomniUserConfigPgauditArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlloydbomniAlloydbomniUserConfigPgauditArgs();
        }

        public Builder(AlloydbomniAlloydbomniUserConfigPgauditArgs defaults) {
            $ = new AlloydbomniAlloydbomniUserConfigPgauditArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AlloydbomniAlloydbomniUserConfigPgauditArgs build() {
            return $;
        }
    }
