...
public final class FlinkJobTableState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="schemaSql")
    private @Nullable Output<String> schemaSql;

    /**
     * @return The SQL statement to create the table. This property cannot be changed, doing so forces recreation of the resource.
     * 
     */
    public Optional<Output<String>> schemaSql() {
        return Optional.ofNullable(this.schemaSql);
    }
    ...
    private FlinkJobTableState() {}

    private FlinkJobTableState(FlinkJobTableState $) {
    ...
    public static Builder builder(FlinkJobTableState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlinkJobTableState();
        }

        public Builder(FlinkJobTableState defaults) {
            $ = new FlinkJobTableState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder schemaSql(@Nullable Output<String> schemaSql) {
            $.schemaSql = schemaSql;
            return this;
        }
        ...
        /**
         * @param tableId The Table ID of the flink table in the flink service.
         * 
         * @return builder
         * 
         */
        ...
        public FlinkJobTableState build() {
            return $;
        }
    }
