...
public final class GetKafkaAclTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKafkaAclTimeoutsArgs Empty = new GetKafkaAclTimeoutsArgs();
    ...
    private GetKafkaAclTimeoutsArgs() {}

    private GetKafkaAclTimeoutsArgs(GetKafkaAclTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaAclTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaAclTimeoutsArgs();
        }

        public Builder(GetKafkaAclTimeoutsArgs defaults) {
            $ = new GetKafkaAclTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaAclTimeoutsArgs build() {
            return $;
        }
    }
