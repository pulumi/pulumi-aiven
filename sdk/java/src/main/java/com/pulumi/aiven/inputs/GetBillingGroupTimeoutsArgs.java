...
public final class GetBillingGroupTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetBillingGroupTimeoutsArgs Empty = new GetBillingGroupTimeoutsArgs();
    ...
    private GetBillingGroupTimeoutsArgs() {}

    private GetBillingGroupTimeoutsArgs(GetBillingGroupTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetBillingGroupTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBillingGroupTimeoutsArgs();
        }

        public Builder(GetBillingGroupTimeoutsArgs defaults) {
            $ = new GetBillingGroupTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBillingGroupTimeoutsArgs build() {
            return $;
        }
    }
