...
@CustomType
public final class AlloydbomniAlloydbomniUserConfigPgaudit {
    /**
    ...
    private AlloydbomniAlloydbomniUserConfigPgaudit() {}
    /**
     * @return Enable pgaudit extension. When enabled, pgaudit extension will be automatically installed.Otherwise, extension will be uninstalled but auditing configurations will be preserved. Default: `false`.
     * 
     */
    ...
    public static Builder builder(AlloydbomniAlloydbomniUserConfigPgaudit defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String role;
        public Builder() {}
        public Builder(AlloydbomniAlloydbomniUserConfigPgaudit defaults) {
        ...
        public AlloydbomniAlloydbomniUserConfigPgaudit build() {
            final var _resultValue = new AlloydbomniAlloydbomniUserConfigPgaudit();
