...
@CustomType
public final class GetAlloydbomniAlloydbomniUserConfigPgaudit {
    /**
    ...
    private GetAlloydbomniAlloydbomniUserConfigPgaudit() {}
    /**
     * @return Enable pgaudit extension. When enabled, pgaudit extension will be automatically installed.Otherwise, extension will be uninstalled but auditing configurations will be preserved. Default: `false`.
     * 
     */
    ...
    public static Builder builder(GetAlloydbomniAlloydbomniUserConfigPgaudit defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String role;
        public Builder() {}
        public Builder(GetAlloydbomniAlloydbomniUserConfigPgaudit defaults) {
        ...
        public GetAlloydbomniAlloydbomniUserConfigPgaudit build() {
            final var _resultValue = new GetAlloydbomniAlloydbomniUserConfigPgaudit();
