...
@CustomType
public final class DragonflyComponent {
    /**
    ...
    public static Builder builder(DragonflyComponent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usage;
        public Builder() {}
        public Builder(DragonflyComponent defaults) {
        ...
        public DragonflyComponent build() {
            final var _resultValue = new DragonflyComponent();
