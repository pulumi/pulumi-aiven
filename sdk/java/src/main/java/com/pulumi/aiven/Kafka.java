...
import com.pulumi.aiven.inputs.KafkaState;
import com.pulumi.aiven.outputs.KafkaComponent;
import com.pulumi.aiven.outputs.KafkaKafka;
 ...
 * 
 */
@ResourceType(type="aiven:index/kafka:Kafka")
public class Kafka extends com.pulumi.resources.CustomResource {
    /**
    ...
    public Output<Optional<Boolean>> karapace() {
        return Codegen.optional(this.karapace);
    }
    /**
    ...
    private Output<List<KafkaServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<KafkaServiceIntegration>> serviceIntegrations() {
     ...
     */
    public Kafka(java.lang.String name) {
        this(name, KafkaArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Kafka(java.lang.String name, KafkaArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Kafka(java.lang.String name, KafkaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/kafka:Kafka", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Kafka(java.lang.String name, Output<java.lang.String> id, @Nullable KafkaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/kafka:Kafka", name, state, makeResourceOptions(options, id), false);
    }

    private static KafkaArgs makeArgs(KafkaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? KafkaArgs.Empty : args;
    }
     ...
     */
    public static Kafka get(java.lang.String name, Output<java.lang.String> id, @Nullable KafkaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
