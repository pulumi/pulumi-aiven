...
@CustomType
public final class GetThanosComponent {
    /**
    ...
    public static Builder builder(GetThanosComponent defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(GetThanosComponent defaults) {
        ...
        public Builder component(String component) {
            if (component == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "component");
            }
        ...
        public Builder connectionUri(String connectionUri) {
            if (connectionUri == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "connectionUri");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder kafkaAuthenticationMethod(String kafkaAuthenticationMethod) {
            if (kafkaAuthenticationMethod == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "kafkaAuthenticationMethod");
            }
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "kafkaSslCa");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "privatelinkConnectionId");
            }
        ...
        public Builder route(String route) {
            if (route == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "route");
            }
            this.route = route;
            return this;
        }
        ...
        public Builder ssl(Boolean ssl) {
            if (ssl == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "ssl");
            }
            this.ssl = ssl;
            return this;
        }
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetThanosComponent", "usage");
            }
            this.usage = usage;
            return this;
        }
        public GetThanosComponent build() {
            final var _resultValue = new GetThanosComponent();
