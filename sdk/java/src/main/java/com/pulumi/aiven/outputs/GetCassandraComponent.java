...
@CustomType
public final class GetCassandraComponent {
    /**
    ...
    public static Builder builder(GetCassandraComponent defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(GetCassandraComponent defaults) {
        ...
        public Builder component(String component) {
            if (component == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "component");
            }
        ...
        public Builder connectionUri(String connectionUri) {
            if (connectionUri == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "connectionUri");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder kafkaAuthenticationMethod(String kafkaAuthenticationMethod) {
            if (kafkaAuthenticationMethod == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "kafkaAuthenticationMethod");
            }
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "kafkaSslCa");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "privatelinkConnectionId");
            }
        ...
        public Builder route(String route) {
            if (route == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "route");
            }
            this.route = route;
            return this;
        }
        ...
        public Builder ssl(Boolean ssl) {
            if (ssl == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "ssl");
            }
            this.ssl = ssl;
            return this;
        }
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetCassandraComponent", "usage");
            }
            this.usage = usage;
            return this;
        }
        public GetCassandraComponent build() {
            final var _resultValue = new GetCassandraComponent();
