...
public final class GetCmkAccessorAzureTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCmkAccessorAzureTimeoutsArgs Empty = new GetCmkAccessorAzureTimeoutsArgs();
    ...
    private GetCmkAccessorAzureTimeoutsArgs() {}

    private GetCmkAccessorAzureTimeoutsArgs(GetCmkAccessorAzureTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetCmkAccessorAzureTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCmkAccessorAzureTimeoutsArgs();
        }

        public Builder(GetCmkAccessorAzureTimeoutsArgs defaults) {
            $ = new GetCmkAccessorAzureTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCmkAccessorAzureTimeoutsArgs build() {
            return $;
        }
    }
