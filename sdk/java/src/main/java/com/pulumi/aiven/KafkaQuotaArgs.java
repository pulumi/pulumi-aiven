...
public final class KafkaQuotaArgs extends com.pulumi.resources.ResourceArgs {

    public static final KafkaQuotaArgs Empty = new KafkaQuotaArgs();
    ...
    private KafkaQuotaArgs() {}

    private KafkaQuotaArgs(KafkaQuotaArgs $) {
    ...
    public static Builder builder(KafkaQuotaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KafkaQuotaArgs defaults) {
            $ = new KafkaQuotaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaQuotaArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("KafkaQuotaArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("KafkaQuotaArgs", "serviceName");
            }
            return $;
        }
    }
