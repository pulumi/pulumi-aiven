...
public final class GetServicePlanTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetServicePlanTimeoutsArgs Empty = new GetServicePlanTimeoutsArgs();
    ...
    private GetServicePlanTimeoutsArgs() {}

    private GetServicePlanTimeoutsArgs(GetServicePlanTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetServicePlanTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServicePlanTimeoutsArgs();
        }

        public Builder(GetServicePlanTimeoutsArgs defaults) {
            $ = new GetServicePlanTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServicePlanTimeoutsArgs build() {
            return $;
        }
    }
