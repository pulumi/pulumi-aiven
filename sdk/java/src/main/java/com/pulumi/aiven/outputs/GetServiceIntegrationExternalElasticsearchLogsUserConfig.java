...
@CustomType
public final class GetServiceIntegrationExternalElasticsearchLogsUserConfig {
    /**
    ...
    private GetServiceIntegrationExternalElasticsearchLogsUserConfig() {}
    /**
     * @return The list of logging fields that will be sent to the integration logging service. The MESSAGE and timestamp fields are always sent.
     * 
     */
    ...
    public static Builder builder(GetServiceIntegrationExternalElasticsearchLogsUserConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> selectedLogFields;
        public Builder() {}
        public Builder(GetServiceIntegrationExternalElasticsearchLogsUserConfig defaults) {
        ...
        public GetServiceIntegrationExternalElasticsearchLogsUserConfig build() {
            final var _resultValue = new GetServiceIntegrationExternalElasticsearchLogsUserConfig();
