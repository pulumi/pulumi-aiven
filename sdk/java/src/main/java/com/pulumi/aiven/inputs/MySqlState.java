...
public final class MySqlState extends com.pulumi.resources.ResourceArgs {

    public static final MySqlState Empty = new MySqlState();
    ...
    private @Nullable Output<List<MySqlComponentArgs>> components;

    /**
     * @return Service component information objects
     * 
     */
    public Optional<Output<List<MySqlComponentArgs>>> components() {
    ...
    public static Builder builder(MySqlState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MySqlState defaults) {
            $ = new MySqlState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder components(@Nullable Output<List<MySqlComponentArgs>> components) {
         ...
         * 
         */
        public Builder components(List<MySqlComponentArgs> components) {
         ...
         * 
         */
        public Builder components(MySqlComponentArgs... components) {
