...
public final class OpenSearchOpensearchUserConfigIndexTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param numberOfReplicas The number of replicas each primary shard has. Deprecated, use an index template instead. Example: `1`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param numberOfShards The number of primary shards that an index should have. Deprecated, use an index template instead. Example: `1`.
         * 
         * @return builder
         * 
         */
