...
import com.pulumi.aiven.inputs.PgState;
import com.pulumi.aiven.outputs.PgComponent;
import com.pulumi.aiven.outputs.PgPg;
import com.pulumi.aiven.outputs.PgPgUserConfig;
import com.pulumi.aiven.outputs.PgServiceIntegration;
import com.pulumi.aiven.outputs.PgTag;
import com.pulumi.aiven.outputs.PgTechEmail;
 ...
 * 
 */
@ResourceType(type="aiven:index/pg:Pg")
public class Pg extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="components", refs={List.class,PgComponent.class}, tree="[0,1]")
    private Output<List<PgComponent>> components;

    /**
     * @return Service component information objects
     * 
     */
    public Output<List<PgComponent>> components() {
     ...
     * 
     */
    @Export(name="pgUserConfig", refs={PgPgUserConfig.class}, tree="[0]")
    private Output</* @Nullable */ PgPgUserConfig> pgUserConfig;
     ...
     * 
     */
    public Output<Optional<PgPgUserConfig>> pgUserConfig() {
        return Codegen.optional(this.pgUserConfig);
    }
    /**
     ...
     * 
     */
    @Export(name="serviceIntegrations", refs={List.class,PgServiceIntegration.class}, tree="[0,1]")
    private Output<List<PgServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<PgServiceIntegration>> serviceIntegrations() {
     ...
     * 
     */
    @Export(name="tags", refs={List.class,PgTag.class}, tree="[0,1]")
    private Output</* @Nullable */ List<PgTag>> tags;

    /**
     * @return Tags are key-value pairs that allow you to categorize services.
     * 
     */
    public Output<Optional<List<PgTag>>> tags() {
     ...
     * 
     */
    @Export(name="techEmails", refs={List.class,PgTechEmail.class}, tree="[0,1]")
    private Output</* @Nullable */ List<PgTechEmail>> techEmails;
     ...
     * 
     */
    public Output<Optional<List<PgTechEmail>>> techEmails() {
     ...
     */
    public Pg(java.lang.String name) {
        this(name, PgArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Pg(java.lang.String name, PgArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Pg(java.lang.String name, PgArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/pg:Pg", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Pg(java.lang.String name, Output<java.lang.String> id, @Nullable PgState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/pg:Pg", name, state, makeResourceOptions(options, id), false);
    }

    private static PgArgs makeArgs(PgArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PgArgs.Empty : args;
    }
     ...
     */
    public static Pg get(java.lang.String name, Output<java.lang.String> id, @Nullable PgState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
