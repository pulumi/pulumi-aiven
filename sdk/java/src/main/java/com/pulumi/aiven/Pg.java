...
public class Pg extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="components", type=List.class, parameters={PgComponent.class})
     ...
     * 
     */
    @Export(name="pg", type=PgPg.class, parameters={})
     ...
     * 
     */
    @Export(name="pgUserConfig", type=PgPgUserConfig.class, parameters={})
     ...
     * 
     */
    @Export(name="serviceIntegrations", type=List.class, parameters={PgServiceIntegration.class})
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={PgTag.class})
    ...
    public Pg(String name, PgArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/pg:Pg", name, args == null ? PgArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
