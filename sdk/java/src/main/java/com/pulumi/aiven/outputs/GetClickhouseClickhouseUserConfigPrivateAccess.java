...
@CustomType
public final class GetClickhouseClickhouseUserConfigPrivateAccess {
    /**
    ...
    private GetClickhouseClickhouseUserConfigPrivateAccess() {}
    /**
     * @return Allow clients to connect to clickhouse with a DNS name that always resolves to the service&#39;s private IP addresses. Only available in certain network locations.
     * 
     */
    ...
    public static Builder builder(GetClickhouseClickhouseUserConfigPrivateAccess defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean prometheus;
        public Builder() {}
        public Builder(GetClickhouseClickhouseUserConfigPrivateAccess defaults) {
        ...
        public GetClickhouseClickhouseUserConfigPrivateAccess build() {
            final var _resultValue = new GetClickhouseClickhouseUserConfigPrivateAccess();
