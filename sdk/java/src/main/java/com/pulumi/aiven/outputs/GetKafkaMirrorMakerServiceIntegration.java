...
@CustomType
public final class GetKafkaMirrorMakerServiceIntegration {
    /**
    ...
    private GetKafkaMirrorMakerServiceIntegration() {}
    /**
     * @return Type of the service integration. The only supported value at the moment is `read_replica`
     * 
     */
    ...
    public static Builder builder(GetKafkaMirrorMakerServiceIntegration defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceServiceName;
        public Builder() {}
        public Builder(GetKafkaMirrorMakerServiceIntegration defaults) {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("GetKafkaMirrorMakerServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("GetKafkaMirrorMakerServiceIntegration", "sourceServiceName");
            }
