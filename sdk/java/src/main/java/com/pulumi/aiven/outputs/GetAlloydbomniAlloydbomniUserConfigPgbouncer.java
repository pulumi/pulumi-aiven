...
@CustomType
public final class GetAlloydbomniAlloydbomniUserConfigPgbouncer {
    /**
    ...
    private GetAlloydbomniAlloydbomniUserConfigPgbouncer() {}
    /**
     * @return If the automatically created database pools have been unused this many seconds, they are freed. If 0 then timeout is disabled. (seconds). Default: `3600`.
     * 
     */
    ...
    public static Builder builder(GetAlloydbomniAlloydbomniUserConfigPgbouncer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean serverResetQueryAlways;
        public Builder() {}
        public Builder(GetAlloydbomniAlloydbomniUserConfigPgbouncer defaults) {
        ...
        public GetAlloydbomniAlloydbomniUserConfigPgbouncer build() {
            final var _resultValue = new GetAlloydbomniAlloydbomniUserConfigPgbouncer();
