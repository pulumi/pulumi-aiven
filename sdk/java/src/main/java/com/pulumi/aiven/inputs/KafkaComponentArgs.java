...
public final class KafkaComponentArgs extends com.pulumi.resources.ResourceArgs {

    public static final KafkaComponentArgs Empty = new KafkaComponentArgs();
    ...
    private KafkaComponentArgs() {}

    private KafkaComponentArgs(KafkaComponentArgs $) {
    ...
    public static Builder builder(KafkaComponentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KafkaComponentArgs();
        }

        public Builder(KafkaComponentArgs defaults) {
            $ = new KafkaComponentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaComponentArgs build() {
            return $;
        }
    }
