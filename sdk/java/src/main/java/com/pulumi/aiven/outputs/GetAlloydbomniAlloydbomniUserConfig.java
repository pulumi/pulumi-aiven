...
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigIpFilterObject;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPg;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPgaudit;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPgbouncer;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPglookout;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPrivateAccess;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPrivatelinkAccess;
import com.pulumi.aiven.outputs.GetAlloydbomniAlloydbomniUserConfigPublicAccess;
...
@CustomType
public final class GetAlloydbomniAlloydbomniUserConfig {
    /**
     ...
     * 
     */
    private @Nullable GetAlloydbomniAlloydbomniUserConfigPgaudit pgaudit;
    /**
     * @return PGBouncer connection pooling settings
     * 
     */
    private @Nullable GetAlloydbomniAlloydbomniUserConfigPgbouncer pgbouncer;
    /**
     * @return System-wide settings for pglookout
     * 
     */
    private @Nullable GetAlloydbomniAlloydbomniUserConfigPglookout pglookout;
    /**
     * @return Allow access to selected service ports from private networks
     * 
     */
    private @Nullable GetAlloydbomniAlloydbomniUserConfigPrivateAccess privateAccess;
    /**
     * @return Allow access to selected service components through Privatelink
     * 
     */
    private @Nullable GetAlloydbomniAlloydbomniUserConfigPrivatelinkAccess privatelinkAccess;
    /**
     ...
     * 
     */
    private @Nullable GetAlloydbomniAlloydbomniUserConfigPublicAccess publicAccess;
    /**
    ...
    private GetAlloydbomniAlloydbomniUserConfig() {}
    /**
     * @return Additional Cloud Regions for Backup Replication.
     * 
     */
     ...
     * 
     */
    public List<GetAlloydbomniAlloydbomniUserConfigIpFilterObject> ipFilterObjects() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPg> pg() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPgaudit> pgaudit() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPgbouncer> pgbouncer() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPglookout> pglookout() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPrivateAccess> privateAccess() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPrivatelinkAccess> privatelinkAccess() {
     ...
     * 
     */
    public Optional<GetAlloydbomniAlloydbomniUserConfigPublicAccess> publicAccess() {
    ...
    public static Builder builder(GetAlloydbomniAlloydbomniUserConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer workMem;
        public Builder() {}
        public Builder(GetAlloydbomniAlloydbomniUserConfig defaults) {
        ...
        @CustomType.Setter
        public Builder ipFilterObjects(@Nullable List<GetAlloydbomniAlloydbomniUserConfigIpFilterObject> ipFilterObjects) {

            this.ipFilterObjects = ipFilterObjects;
            return this;
        }
        public Builder ipFilterObjects(GetAlloydbomniAlloydbomniUserConfigIpFilterObject... ipFilterObjects) {
        ...
        @CustomType.Setter
        public Builder pgaudit(@Nullable GetAlloydbomniAlloydbomniUserConfigPgaudit pgaudit) {

            this.pgaudit = pgaudit;
            return this;
        }
        @CustomType.Setter
        public Builder pgbouncer(@Nullable GetAlloydbomniAlloydbomniUserConfigPgbouncer pgbouncer) {

            this.pgbouncer = pgbouncer;
            return this;
        }
        @CustomType.Setter
        public Builder pglookout(@Nullable GetAlloydbomniAlloydbomniUserConfigPglookout pglookout) {

            this.pglookout = pglookout;
            return this;
        }
        @CustomType.Setter
        public Builder privateAccess(@Nullable GetAlloydbomniAlloydbomniUserConfigPrivateAccess privateAccess) {

            this.privateAccess = privateAccess;
            return this;
        }
        @CustomType.Setter
        public Builder privatelinkAccess(@Nullable GetAlloydbomniAlloydbomniUserConfigPrivatelinkAccess privatelinkAccess) {
        ...
        @CustomType.Setter
        public Builder publicAccess(@Nullable GetAlloydbomniAlloydbomniUserConfigPublicAccess publicAccess) {
        ...
        public GetAlloydbomniAlloydbomniUserConfig build() {
            final var _resultValue = new GetAlloydbomniAlloydbomniUserConfig();
