...
@CustomType
public final class InfluxDbServiceIntegration {
    /**
    ...
    private InfluxDbServiceIntegration() {}
    /**
     * @return Type of the service integration
     * 
     */
    ...
    public static Builder builder(InfluxDbServiceIntegration defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceServiceName;
        public Builder() {}
        public Builder(InfluxDbServiceIntegration defaults) {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("InfluxDbServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("InfluxDbServiceIntegration", "sourceServiceName");
            }
