...
public class M3Db extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="components", type=List.class, parameters={M3DbComponent.class})
     ...
     * 
     */
    @Export(name="m3dbUserConfig", type=M3DbM3dbUserConfig.class, parameters={})
     ...
     * 
     */
    @Export(name="m3dbs", type=List.class, parameters={M3DbM3db.class})
     ...
     * 
     */
    @Export(name="serviceIntegrations", type=List.class, parameters={M3DbServiceIntegration.class})
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={M3DbTag.class})
