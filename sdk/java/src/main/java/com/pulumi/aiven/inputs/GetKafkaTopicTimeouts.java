...
public final class GetKafkaTopicTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetKafkaTopicTimeouts Empty = new GetKafkaTopicTimeouts();
    ...
    private GetKafkaTopicTimeouts() {}

    private GetKafkaTopicTimeouts(GetKafkaTopicTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetKafkaTopicTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaTopicTimeouts();
        }

        public Builder(GetKafkaTopicTimeouts defaults) {
            $ = new GetKafkaTopicTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaTopicTimeouts build() {
            return $;
        }
    }
