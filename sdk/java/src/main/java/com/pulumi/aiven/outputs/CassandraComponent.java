...
@CustomType
public final class CassandraComponent {
    ...
    public static Builder builder(CassandraComponent defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CassandraComponent defaults) {
        ...
        public Builder usage(@Nullable String usage) {
            ...
            return new CassandraComponent(component, host, kafkaAuthenticationMethod, port, route, ssl, usage);
        }
    }
}
