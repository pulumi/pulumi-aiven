...
@CustomType
public final class GetKafkaConnectComponent {
    /**
    ...
    private GetKafkaConnectComponent() {}
    /**
     * @return Service component name
     * 
     */
    ...
    public static Builder builder(GetKafkaConnectComponent defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(GetKafkaConnectComponent defaults) {
        ...
        public Builder component(String component) {
            if (component == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "component");
            }
        ...
        public Builder connectionUri(String connectionUri) {
            if (connectionUri == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "connectionUri");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder kafkaAuthenticationMethod(String kafkaAuthenticationMethod) {
            if (kafkaAuthenticationMethod == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "kafkaAuthenticationMethod");
            }
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "kafkaSslCa");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "privatelinkConnectionId");
            }
        ...
        public Builder route(String route) {
            if (route == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "route");
            }
            this.route = route;
            return this;
        }
        ...
        public Builder ssl(Boolean ssl) {
            if (ssl == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "ssl");
            }
            this.ssl = ssl;
            return this;
        }
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectComponent", "usage");
            }
            this.usage = usage;
            return this;
        }
        public GetKafkaConnectComponent build() {
            final var _resultValue = new GetKafkaConnectComponent();
