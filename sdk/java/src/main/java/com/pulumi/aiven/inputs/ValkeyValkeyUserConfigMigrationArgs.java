...
public final class ValkeyValkeyUserConfigMigrationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ValkeyValkeyUserConfigMigrationArgs Empty = new ValkeyValkeyUserConfigMigrationArgs();
    ...
    private ValkeyValkeyUserConfigMigrationArgs() {}

    private ValkeyValkeyUserConfigMigrationArgs(ValkeyValkeyUserConfigMigrationArgs $) {
        this.dbname = $.dbname;
        this.host = $.host;
    ...
    public static Builder builder(ValkeyValkeyUserConfigMigrationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ValkeyValkeyUserConfigMigrationArgs();
        }

        public Builder(ValkeyValkeyUserConfigMigrationArgs defaults) {
            $ = new ValkeyValkeyUserConfigMigrationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ValkeyValkeyUserConfigMigrationArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("ValkeyValkeyUserConfigMigrationArgs", "host");
            }
            if ($.port == null) {
                throw new MissingRequiredPropertyException("ValkeyValkeyUserConfigMigrationArgs", "port");
            }
            return $;
        }
    }
