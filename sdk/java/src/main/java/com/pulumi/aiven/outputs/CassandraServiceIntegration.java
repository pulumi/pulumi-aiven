...
@CustomType
public final class CassandraServiceIntegration {
    /**
    ...
    private CassandraServiceIntegration() {}
    /**
     * @return Type of the service integration
     * 
     */
    ...
    public static Builder builder(CassandraServiceIntegration defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceServiceName;
        public Builder() {}
        public Builder(CassandraServiceIntegration defaults) {
        ...
        public Builder integrationType(String integrationType) {
            if (integrationType == null) {
              throw new MissingRequiredPropertyException("CassandraServiceIntegration", "integrationType");
            }
        ...
        public Builder sourceServiceName(String sourceServiceName) {
            if (sourceServiceName == null) {
              throw new MissingRequiredPropertyException("CassandraServiceIntegration", "sourceServiceName");
            }
