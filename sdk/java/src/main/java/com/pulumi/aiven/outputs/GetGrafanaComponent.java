...
public final class GetGrafanaComponent {
    ...
    public static final class Builder {
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetGrafanaComponent", "kafkaSslCa");
            }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetGrafanaComponent", "privatelinkConnectionId");
            }
