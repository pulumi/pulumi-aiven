...
@CustomType
public final class GetM3DbComponent {
    /**
    ...
    public static Builder builder(GetM3DbComponent defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(GetM3DbComponent defaults) {
        ...
        public Builder component(String component) {
            if (component == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "component");
            }
        ...
        public Builder connectionUri(String connectionUri) {
            if (connectionUri == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "connectionUri");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder kafkaAuthenticationMethod(String kafkaAuthenticationMethod) {
            if (kafkaAuthenticationMethod == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "kafkaAuthenticationMethod");
            }
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "kafkaSslCa");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "privatelinkConnectionId");
            }
        ...
        public Builder route(String route) {
            if (route == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "route");
            }
            this.route = route;
            return this;
        }
        ...
        public Builder ssl(Boolean ssl) {
            if (ssl == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "ssl");
            }
            this.ssl = ssl;
            return this;
        }
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetM3DbComponent", "usage");
            }
            this.usage = usage;
            return this;
        }
        public GetM3DbComponent build() {
            final var _resultValue = new GetM3DbComponent();
