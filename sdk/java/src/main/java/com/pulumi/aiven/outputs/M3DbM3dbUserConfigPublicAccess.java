...
public final class M3DbM3dbUserConfigPublicAccess {
    ...
    private M3DbM3dbUserConfigPublicAccess(@CustomType.Parameter("m3coordinator") @Nullable String m3coordinator) {
    ...
    public static final class Builder {
        ...
        public Builder m3coordinator(@Nullable String m3coordinator) {
            ...
            return new M3DbM3dbUserConfigPublicAccess(m3coordinator);
        }
    }
}
