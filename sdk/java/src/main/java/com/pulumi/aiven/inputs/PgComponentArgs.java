...
public final class PgComponentArgs extends com.pulumi.resources.ResourceArgs {

    public static final PgComponentArgs Empty = new PgComponentArgs();
    ...
    private PgComponentArgs() {}

    private PgComponentArgs(PgComponentArgs $) {
    ...
    public static Builder builder(PgComponentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PgComponentArgs defaults) {
            $ = new PgComponentArgs(Objects.requireNonNull(defaults));
        }
