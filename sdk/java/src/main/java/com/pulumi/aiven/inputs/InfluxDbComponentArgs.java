...
public final class InfluxDbComponentArgs extends com.pulumi.resources.ResourceArgs {

    public static final InfluxDbComponentArgs Empty = new InfluxDbComponentArgs();
    ...
    public static Builder builder(InfluxDbComponentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InfluxDbComponentArgs();
        }

        public Builder(InfluxDbComponentArgs defaults) {
            $ = new InfluxDbComponentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InfluxDbComponentArgs build() {
            return $;
        }
    }
