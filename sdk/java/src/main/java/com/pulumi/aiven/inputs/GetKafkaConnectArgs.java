...
public final class GetKafkaConnectArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetKafkaConnectArgs Empty = new GetKafkaConnectArgs();
    ...
    private GetKafkaConnectArgs() {}

    private GetKafkaConnectArgs(GetKafkaConnectArgs $) {
    ...
    public static Builder builder(GetKafkaConnectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKafkaConnectArgs();
        }

        public Builder(GetKafkaConnectArgs defaults) {
            $ = new GetKafkaConnectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKafkaConnectArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetKafkaConnectArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetKafkaConnectArgs", "serviceName");
            }
            return $;
        }
    }
