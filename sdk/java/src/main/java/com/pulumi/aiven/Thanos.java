...
import com.pulumi.aiven.inputs.ThanosState;
import com.pulumi.aiven.outputs.ThanosComponent;
import com.pulumi.aiven.outputs.ThanosServiceIntegration;
import com.pulumi.aiven.outputs.ThanosTag;
import com.pulumi.aiven.outputs.ThanosTechEmail;
import com.pulumi.aiven.outputs.ThanosThanos;
import com.pulumi.aiven.outputs.ThanosThanosUserConfig;
...
public class Thanos extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="components", refs={List.class,ThanosComponent.class}, tree="[0,1]")
    private Output<List<ThanosComponent>> components;

    /**
     * @return Service component information objects
     * 
     */
    public Output<List<ThanosComponent>> components() {
     ...
     * 
     */
    @Export(name="serviceIntegrations", refs={List.class,ThanosServiceIntegration.class}, tree="[0,1]")
    private Output<List<ThanosServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<ThanosServiceIntegration>> serviceIntegrations() {
     ...
     * 
     */
    @Export(name="tags", refs={List.class,ThanosTag.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ThanosTag>> tags;

    /**
     * @return Tags are key-value pairs that allow you to categorize services.
     * 
     */
    public Output<Optional<List<ThanosTag>>> tags() {
     ...
     * 
     */
    @Export(name="techEmails", refs={List.class,ThanosTechEmail.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ThanosTechEmail>> techEmails;
     ...
     * 
     */
    public Output<Optional<List<ThanosTechEmail>>> techEmails() {
     ...
     * 
     */
    @Export(name="thanos", refs={ThanosThanos.class}, tree="[0]")
    private Output<ThanosThanos> thanos;

    /**
     * @return Thanos server connection details.
     * 
     */
    public Output<ThanosThanos> thanos() {
        return this.thanos;
    }
    /**
     ...
     * 
     */
    @Export(name="thanosUserConfig", refs={ThanosThanosUserConfig.class}, tree="[0]")
    private Output</* @Nullable */ ThanosThanosUserConfig> thanosUserConfig;
     ...
     * 
     */
    public Output<Optional<ThanosThanosUserConfig>> thanosUserConfig() {
        return Codegen.optional(this.thanosUserConfig);
    }
