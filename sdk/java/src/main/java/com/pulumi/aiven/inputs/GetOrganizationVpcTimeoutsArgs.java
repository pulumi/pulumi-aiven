...
public final class GetOrganizationVpcTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOrganizationVpcTimeoutsArgs Empty = new GetOrganizationVpcTimeoutsArgs();
    ...
    private GetOrganizationVpcTimeoutsArgs() {}

    private GetOrganizationVpcTimeoutsArgs(GetOrganizationVpcTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOrganizationVpcTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOrganizationVpcTimeoutsArgs();
        }

        public Builder(GetOrganizationVpcTimeoutsArgs defaults) {
            $ = new GetOrganizationVpcTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOrganizationVpcTimeoutsArgs build() {
            return $;
        }
    }
