...
public final class M3AggregatorArgs extends com.pulumi.resources.ResourceArgs {

    public static final M3AggregatorArgs Empty = new M3AggregatorArgs();
    ...
    private M3AggregatorArgs() {}

    private M3AggregatorArgs(M3AggregatorArgs $) {
    ...
    public static Builder builder(M3AggregatorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(M3AggregatorArgs defaults) {
            $ = new M3AggregatorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public M3AggregatorArgs build() {
            if ($.plan == null) {
                throw new MissingRequiredPropertyException("M3AggregatorArgs", "plan");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("M3AggregatorArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("M3AggregatorArgs", "serviceName");
            }
            return $;
        }
    }
