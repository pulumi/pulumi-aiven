...
@CustomType
public final class KafkaAclTimeouts {
    /**
    ...
    public static Builder builder(KafkaAclTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(KafkaAclTimeouts defaults) {
        ...
        public KafkaAclTimeouts build() {
            final var _resultValue = new KafkaAclTimeouts();
