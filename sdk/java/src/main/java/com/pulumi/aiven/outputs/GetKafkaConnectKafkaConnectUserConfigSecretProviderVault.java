...
@CustomType
public final class GetKafkaConnectKafkaConnectUserConfigSecretProviderVault {
    /**
    ...
    private GetKafkaConnectKafkaConnectUserConfigSecretProviderVault() {}
    /**
     * @return Address of the Vault server.
     * 
     */
    ...
    public static Builder builder(GetKafkaConnectKafkaConnectUserConfigSecretProviderVault defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String token;
        public Builder() {}
        public Builder(GetKafkaConnectKafkaConnectUserConfigSecretProviderVault defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectKafkaConnectUserConfigSecretProviderVault", "address");
            }
        ...
        public Builder authMethod(String authMethod) {
            if (authMethod == null) {
              throw new MissingRequiredPropertyException("GetKafkaConnectKafkaConnectUserConfigSecretProviderVault", "authMethod");
            }
        ...
        public GetKafkaConnectKafkaConnectUserConfigSecretProviderVault build() {
            final var _resultValue = new GetKafkaConnectKafkaConnectUserConfigSecretProviderVault();
