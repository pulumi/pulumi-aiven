...
@CustomType
public final class M3AggregatorTag {
    private String key;
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("M3AggregatorTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("M3AggregatorTag", "value");
            }
            this.value = value;
            return this;
        }
