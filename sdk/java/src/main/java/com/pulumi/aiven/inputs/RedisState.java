...
import com.pulumi.aiven.inputs.RedisRediArgs;
...
public final class RedisState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="redis")
    private @Nullable Output<List<RedisRediArgs>> redis;

    /**
     * @return Redis server provided values
     * 
     */
    public Optional<Output<List<RedisRediArgs>>> redis() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder redis(@Nullable Output<List<RedisRediArgs>> redis) {
            $.redis = redis;
            return this;
        }
         ...
         * 
         */
        public Builder redis(List<RedisRediArgs> redis) {
         ...
         * 
         */
        public Builder redis(RedisRediArgs... redis) {
