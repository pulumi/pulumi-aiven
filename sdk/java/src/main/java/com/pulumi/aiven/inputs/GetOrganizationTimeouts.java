...
public final class GetOrganizationTimeouts extends com.pulumi.resources.InvokeArgs {

    public static final GetOrganizationTimeouts Empty = new GetOrganizationTimeouts();
    ...
    private GetOrganizationTimeouts() {}

    private GetOrganizationTimeouts(GetOrganizationTimeouts $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOrganizationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOrganizationTimeouts();
        }

        public Builder(GetOrganizationTimeouts defaults) {
            $ = new GetOrganizationTimeouts(Objects.requireNonNull(defaults));
        }
        ...
        public GetOrganizationTimeouts build() {
            return $;
        }
    }
