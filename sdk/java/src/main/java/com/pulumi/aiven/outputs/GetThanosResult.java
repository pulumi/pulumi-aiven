...
import com.pulumi.aiven.outputs.GetThanosComponent;
import com.pulumi.aiven.outputs.GetThanosServiceIntegration;
import com.pulumi.aiven.outputs.GetThanosTag;
import com.pulumi.aiven.outputs.GetThanosTechEmail;
import com.pulumi.aiven.outputs.GetThanosThano;
import com.pulumi.aiven.outputs.GetThanosThanosUserConfig;
...
@CustomType
public final class GetThanosResult {
    /**
     ...
     * 
     */
    private List<GetThanosComponent> components;
    /**
     ...
     * 
     */
    private List<GetThanosServiceIntegration> serviceIntegrations;
    /**
     ...
     * 
     */
    private List<GetThanosTag> tags;
    /**
     ...
     * 
     */
    private List<GetThanosTechEmail> techEmails;
    /**
     ...
     * 
     */
    public List<GetThanosComponent> components() {
     ...
     * 
     */
    public List<GetThanosServiceIntegration> serviceIntegrations() {
     ...
     * 
     */
    public List<GetThanosTechEmail> techEmails() {
     ...
     * 
     */
    public List<GetThanosThano> thanos() {
        return this.thanos;
    }
    /**
     * @return Thanos user configurable settings. **Warning:** There&#39;s no way to reset advanced configuration options to default. Options that you add cannot be removed later
    ...
    public static Builder builder(GetThanosResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetThanosThanosUserConfig> thanosUserConfigs;
        public Builder() {}
        public Builder(GetThanosResult defaults) {
    	      ...
    	      this.thanos = defaults.thanos;
    	      this.thanosUserConfigs = defaults.thanosUserConfigs;
        }

        @CustomType.Setter
        public Builder additionalDiskSpace(String additionalDiskSpace) {
            if (additionalDiskSpace == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "additionalDiskSpace");
            }
        ...
        public Builder cloudName(String cloudName) {
            if (cloudName == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "cloudName");
            }
        ...
        public Builder cmkId(String cmkId) {
            if (cmkId == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "cmkId");
            }
            this.cmkId = cmkId;
            return this;
        }
        @CustomType.Setter
        public Builder components(List<GetThanosComponent> components) {
            if (components == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "components");
            }
            this.components = components;
            return this;
        }
        public Builder components(GetThanosComponent... components) {
            return components(List.of(components));
        }
        @CustomType.Setter
        public Builder diskSpace(String diskSpace) {
            if (diskSpace == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "diskSpace");
            }
        ...
        public Builder diskSpaceCap(String diskSpaceCap) {
            if (diskSpaceCap == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "diskSpaceCap");
            }
        ...
        public Builder diskSpaceDefault(String diskSpaceDefault) {
            if (diskSpaceDefault == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "diskSpaceDefault");
            }
        ...
        public Builder diskSpaceStep(String diskSpaceStep) {
            if (diskSpaceStep == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "diskSpaceStep");
            }
        ...
        public Builder diskSpaceUsed(String diskSpaceUsed) {
            if (diskSpaceUsed == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "diskSpaceUsed");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder maintenanceWindowDow(String maintenanceWindowDow) {
            if (maintenanceWindowDow == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "maintenanceWindowDow");
            }
        ...
        public Builder maintenanceWindowEnabled(Boolean maintenanceWindowEnabled) {
            if (maintenanceWindowEnabled == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "maintenanceWindowEnabled");
            }
        ...
        public Builder maintenanceWindowTime(String maintenanceWindowTime) {
            if (maintenanceWindowTime == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "maintenanceWindowTime");
            }
        ...
        public Builder plan(String plan) {
            if (plan == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "plan");
            }
            this.plan = plan;
            return this;
        }
        ...
        public Builder project(String project) {
            if (project == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "project");
            }
        ...
        public Builder projectVpcId(String projectVpcId) {
            if (projectVpcId == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "projectVpcId");
            }
        ...
        public Builder serviceHost(String serviceHost) {
            if (serviceHost == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "serviceHost");
            }
            this.serviceHost = serviceHost;
            return this;
        }
        @CustomType.Setter
        public Builder serviceIntegrations(List<GetThanosServiceIntegration> serviceIntegrations) {
            if (serviceIntegrations == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "serviceIntegrations");
            }
            this.serviceIntegrations = serviceIntegrations;
            return this;
        }
        public Builder serviceIntegrations(GetThanosServiceIntegration... serviceIntegrations) {
            return serviceIntegrations(List.of(serviceIntegrations));
        }
        @CustomType.Setter
        public Builder serviceName(String serviceName) {
            if (serviceName == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "serviceName");
            }
        ...
        public Builder servicePassword(String servicePassword) {
            if (servicePassword == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "servicePassword");
            }
        ...
        public Builder servicePort(Integer servicePort) {
            if (servicePort == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "servicePort");
            }
        ...
        public Builder serviceType(String serviceType) {
            if (serviceType == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "serviceType");
            }
        ...
        public Builder serviceUri(String serviceUri) {
            if (serviceUri == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "serviceUri");
            }
        ...
        public Builder serviceUsername(String serviceUsername) {
            if (serviceUsername == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "serviceUsername");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder staticIps(List<String> staticIps) {
            if (staticIps == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "staticIps");
            }
        ...
        @CustomType.Setter
        public Builder tags(List<GetThanosTag> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "tags");
            }
            this.tags = tags;
            return this;
        }
        public Builder tags(GetThanosTag... tags) {
            return tags(List.of(tags));
        }
        @CustomType.Setter
        public Builder techEmails(List<GetThanosTechEmail> techEmails) {
            if (techEmails == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "techEmails");
            }
            this.techEmails = techEmails;
            return this;
        }
        public Builder techEmails(GetThanosTechEmail... techEmails) {
            return techEmails(List.of(techEmails));
        }
        @CustomType.Setter
        public Builder terminationProtection(Boolean terminationProtection) {
            if (terminationProtection == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "terminationProtection");
            }
            this.terminationProtection = terminationProtection;
            return this;
        }
        @CustomType.Setter
        public Builder thanos(List<GetThanosThano> thanos) {
            if (thanos == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "thanos");
            }
            this.thanos = thanos;
            return this;
        }
        public Builder thanos(GetThanosThano... thanos) {
            return thanos(List.of(thanos));
        }
        @CustomType.Setter
        public Builder thanosUserConfigs(List<GetThanosThanosUserConfig> thanosUserConfigs) {
            if (thanosUserConfigs == null) {
              throw new MissingRequiredPropertyException("GetThanosResult", "thanosUserConfigs");
            }
            this.thanosUserConfigs = thanosUserConfigs;
            return this;
        }
        public Builder thanosUserConfigs(GetThanosThanosUserConfig... thanosUserConfigs) {
            return thanosUserConfigs(List.of(thanosUserConfigs));
        }
        public GetThanosResult build() {
            final var _resultValue = new GetThanosResult();
            ...
            _resultValue.thanos = thanos;
            _resultValue.thanosUserConfigs = thanosUserConfigs;
            return _resultValue;
        }
    }
}
