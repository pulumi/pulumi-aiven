...
public final class GetM3AggregatorResult {
    ...
    public static final class Builder {
        ...
        public Builder terminationProtection(Boolean terminationProtection) {
            ...
            return new GetM3AggregatorResult(additionalDiskSpace, cloudName, components, diskSpace, diskSpaceCap, diskSpaceDefault, diskSpaceStep, diskSpaceUsed, id, m3aggregatorUserConfigs, m3aggregators, maintenanceWindowDow, maintenanceWindowTime, plan, project, projectVpcId, serviceHost, serviceIntegrations, serviceName, servicePassword, servicePort, serviceType, serviceUri, serviceUsername, state, staticIps, tags, terminationProtection);
        }
    }
}
