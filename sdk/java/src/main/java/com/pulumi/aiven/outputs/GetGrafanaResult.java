...
public final class GetGrafanaResult {
    ...
    public static final class Builder {
        ...
        public Builder terminationProtection(Boolean terminationProtection) {
            ...
            return new GetGrafanaResult(additionalDiskSpace, cloudName, components, diskSpace, diskSpaceCap, diskSpaceDefault, diskSpaceStep, diskSpaceUsed, grafanaUserConfigs, grafanas, id, maintenanceWindowDow, maintenanceWindowTime, plan, project, projectVpcId, serviceHost, serviceIntegrations, serviceName, servicePassword, servicePort, serviceType, serviceUri, serviceUsername, state, staticIps, tags, terminationProtection);
        }
    }
}
