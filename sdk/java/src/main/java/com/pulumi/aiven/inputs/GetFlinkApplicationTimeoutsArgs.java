...
public final class GetFlinkApplicationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFlinkApplicationTimeoutsArgs Empty = new GetFlinkApplicationTimeoutsArgs();
    ...
    private GetFlinkApplicationTimeoutsArgs() {}

    private GetFlinkApplicationTimeoutsArgs(GetFlinkApplicationTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetFlinkApplicationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFlinkApplicationTimeoutsArgs();
        }

        public Builder(GetFlinkApplicationTimeoutsArgs defaults) {
            $ = new GetFlinkApplicationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFlinkApplicationTimeoutsArgs build() {
            return $;
        }
    }
