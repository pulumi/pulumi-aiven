...
public final class GetClickhouseDatabaseTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetClickhouseDatabaseTimeoutsArgs Empty = new GetClickhouseDatabaseTimeoutsArgs();
    ...
    private GetClickhouseDatabaseTimeoutsArgs() {}

    private GetClickhouseDatabaseTimeoutsArgs(GetClickhouseDatabaseTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetClickhouseDatabaseTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClickhouseDatabaseTimeoutsArgs();
        }

        public Builder(GetClickhouseDatabaseTimeoutsArgs defaults) {
            $ = new GetClickhouseDatabaseTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetClickhouseDatabaseTimeoutsArgs build() {
            return $;
        }
    }
