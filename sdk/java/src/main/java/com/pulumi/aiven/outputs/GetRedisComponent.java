...
@CustomType
public final class GetRedisComponent {
    /**
    ...
    public static Builder builder(GetRedisComponent defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(GetRedisComponent defaults) {
        ...
        public Builder component(String component) {
            if (component == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "component");
            }
        ...
        public Builder connectionUri(String connectionUri) {
            if (connectionUri == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "connectionUri");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder kafkaAuthenticationMethod(String kafkaAuthenticationMethod) {
            if (kafkaAuthenticationMethod == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "kafkaAuthenticationMethod");
            }
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "kafkaSslCa");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "privatelinkConnectionId");
            }
        ...
        public Builder route(String route) {
            if (route == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "route");
            }
            this.route = route;
            return this;
        }
        ...
        public Builder ssl(Boolean ssl) {
            if (ssl == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "ssl");
            }
            this.ssl = ssl;
            return this;
        }
        ...
        public Builder usage(String usage) {
            if (usage == null) {
              throw new MissingRequiredPropertyException("GetRedisComponent", "usage");
            }
            this.usage = usage;
            return this;
        }
        public GetRedisComponent build() {
            final var _resultValue = new GetRedisComponent();
