...
public final class CassandraCassandraUserConfigIpFilterObject {
    ...
    public static Builder builder(CassandraCassandraUserConfigIpFilterObject defaults) {
    ...
    public static final class Builder {
        ...
        private String network;
        public Builder() {}
        public Builder(CassandraCassandraUserConfigIpFilterObject defaults) {
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("CassandraCassandraUserConfigIpFilterObject", "network");
            }
