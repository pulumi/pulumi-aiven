...
public final class GetKafkaKafkaUserConfigKafkaConnectConfig {
    ...
    public static Builder builder(GetKafkaKafkaUserConfigKafkaConnectConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetKafkaKafkaUserConfigKafkaConnectConfig defaults) {
        ...
        public Builder sessionTimeoutMs(@Nullable String sessionTimeoutMs) {
            this.sessionTimeoutMs = sessionTimeoutMs;
            return this;
        }        public GetKafkaKafkaUserConfigKafkaConnectConfig build() {
            return new GetKafkaKafkaUserConfigKafkaConnectConfig(connectorClientConfigOverridePolicy, consumerAutoOffsetReset, consumerFetchMaxBytes, consumerIsolationLevel, consumerMaxPartitionFetchBytes, consumerMaxPollIntervalMs, consumerMaxPollRecords, offsetFlushIntervalMs, offsetFlushTimeoutMs, producerCompressionType, producerMaxRequestSize, sessionTimeoutMs);
        }
    }
}
