    ...
    public static final class Builder {
        ...
        public KafkaServiceIntegrationArgs build() {
            if ($.integrationType == null) {
                throw new MissingRequiredPropertyException("KafkaServiceIntegrationArgs", "integrationType");
            }
            if ($.sourceServiceName == null) {
                throw new MissingRequiredPropertyException("KafkaServiceIntegrationArgs", "sourceServiceName");
            }
            return $;
        }
    }
