...
@CustomType
public final class AlloydbomniAlloydbomniUserConfigPgbouncer {
    /**
    ...
    private AlloydbomniAlloydbomniUserConfigPgbouncer() {}
    /**
     * @return If the automatically created database pools have been unused this many seconds, they are freed. If 0 then timeout is disabled. (seconds). Default: `3600`.
     * 
     */
    ...
    public static Builder builder(AlloydbomniAlloydbomniUserConfigPgbouncer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean serverResetQueryAlways;
        public Builder() {}
        public Builder(AlloydbomniAlloydbomniUserConfigPgbouncer defaults) {
        ...
        public AlloydbomniAlloydbomniUserConfigPgbouncer build() {
            final var _resultValue = new AlloydbomniAlloydbomniUserConfigPgbouncer();
