...
@CustomType
public final class ThanosComponent {
    /**
    ...
    public static Builder builder(ThanosComponent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usage;
        public Builder() {}
        public Builder(ThanosComponent defaults) {
        ...
        public ThanosComponent build() {
            final var _resultValue = new ThanosComponent();
