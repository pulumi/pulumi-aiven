...
public final class M3DbArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public M3DbArgs build() {
            if ($.plan == null) {
                throw new MissingRequiredPropertyException("M3DbArgs", "plan");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("M3DbArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("M3DbArgs", "serviceName");
            }
            return $;
        }
    }
