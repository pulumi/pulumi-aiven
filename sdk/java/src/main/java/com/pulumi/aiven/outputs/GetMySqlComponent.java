...
public final class GetMySqlComponent {
    ...
    public static final class Builder {
        ...
        public Builder kafkaSslCa(String kafkaSslCa) {
            if (kafkaSslCa == null) {
              throw new MissingRequiredPropertyException("GetMySqlComponent", "kafkaSslCa");
            }
        ...
        public Builder privatelinkConnectionId(String privatelinkConnectionId) {
            if (privatelinkConnectionId == null) {
              throw new MissingRequiredPropertyException("GetMySqlComponent", "privatelinkConnectionId");
            }
