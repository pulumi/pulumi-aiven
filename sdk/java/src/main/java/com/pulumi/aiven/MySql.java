...
public class MySql extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<List<MySqlMysql>> mysqls() {
        return this.mysqls;
    }
    /**
     ...
     */
    public static MySql get(String name, Output<String> id, @Nullable MySqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
