 ...
 * 
 */
@ResourceType(type="aiven:index/mySql:MySql")
public class MySql extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<List<MySqlComponent>> components() {
     ...
     * 
     */
    public Output<Optional<MySqlMysqlUserConfig>> mysqlUserConfig() {
        return Codegen.optional(this.mysqlUserConfig);
    }
    /**
    ...
    private Output<List<MySqlServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<MySqlServiceIntegration>> serviceIntegrations() {
    ...
    public MySql(java.lang.String name, MySqlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/mySql:MySql", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MySql(java.lang.String name, Output<java.lang.String> id, @Nullable MySqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/mySql:MySql", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static MySql get(java.lang.String name, Output<java.lang.String> id, @Nullable MySqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
