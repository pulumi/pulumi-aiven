...
public final class GrafanaTag {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GrafanaTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GrafanaTag", "value");
            }
            this.value = value;
            return this;
        }
        public GrafanaTag build() {
            final var _resultValue = new GrafanaTag();
