...
public final class GetDragonflyPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDragonflyPlainArgs Empty = new GetDragonflyPlainArgs();
    ...
    private GetDragonflyPlainArgs() {}

    private GetDragonflyPlainArgs(GetDragonflyPlainArgs $) {
    ...
    public static Builder builder(GetDragonflyPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDragonflyPlainArgs();
        }

        public Builder(GetDragonflyPlainArgs defaults) {
            $ = new GetDragonflyPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDragonflyPlainArgs build() {
            if ($.project == null) {
                throw new MissingRequiredPropertyException("GetDragonflyPlainArgs", "project");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetDragonflyPlainArgs", "serviceName");
            }
            return $;
        }
    }
