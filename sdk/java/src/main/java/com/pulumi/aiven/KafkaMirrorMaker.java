...
public class KafkaMirrorMaker extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="components", type=List.class, parameters={KafkaMirrorMakerComponent.class})
     ...
     * 
     */
    @Export(name="kafkaMirrormakerUserConfig", type=KafkaMirrorMakerKafkaMirrormakerUserConfig.class, parameters={})
     ...
     * 
     */
    @Export(name="kafkaMirrormakers", type=List.class, parameters={KafkaMirrorMakerKafkaMirrormaker.class})
     ...
     * 
     */
    @Export(name="serviceIntegrations", type=List.class, parameters={KafkaMirrorMakerServiceIntegration.class})
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={KafkaMirrorMakerTag.class})
