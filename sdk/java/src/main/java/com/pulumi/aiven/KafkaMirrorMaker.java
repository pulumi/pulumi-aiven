...
import com.pulumi.aiven.inputs.KafkaMirrorMakerState;
import com.pulumi.aiven.outputs.KafkaMirrorMakerComponent;
import com.pulumi.aiven.outputs.KafkaMirrorMakerKafkaMirrormakerUserConfig;
import com.pulumi.aiven.outputs.KafkaMirrorMakerServiceIntegration;
import com.pulumi.aiven.outputs.KafkaMirrorMakerTag;
import com.pulumi.aiven.outputs.KafkaMirrorMakerTechEmail;
 ...
 * 
 */
@ResourceType(type="aiven:index/kafkaMirrorMaker:KafkaMirrorMaker")
public class KafkaMirrorMaker extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="components", refs={List.class,KafkaMirrorMakerComponent.class}, tree="[0,1]")
    private Output<List<KafkaMirrorMakerComponent>> components;

    /**
     * @return Service component information objects
     * 
     */
    public Output<List<KafkaMirrorMakerComponent>> components() {
     ...
     * 
     */
    @Export(name="kafkaMirrormakerUserConfig", refs={KafkaMirrorMakerKafkaMirrormakerUserConfig.class}, tree="[0]")
    private Output</* @Nullable */ KafkaMirrorMakerKafkaMirrormakerUserConfig> kafkaMirrormakerUserConfig;
     ...
     * 
     */
    public Output<Optional<KafkaMirrorMakerKafkaMirrormakerUserConfig>> kafkaMirrormakerUserConfig() {
     ...
     * 
     */
    @Export(name="serviceIntegrations", refs={List.class,KafkaMirrorMakerServiceIntegration.class}, tree="[0,1]")
    private Output<List<KafkaMirrorMakerServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<KafkaMirrorMakerServiceIntegration>> serviceIntegrations() {
     ...
     * 
     */
    @Export(name="tags", refs={List.class,KafkaMirrorMakerTag.class}, tree="[0,1]")
    private Output</* @Nullable */ List<KafkaMirrorMakerTag>> tags;

    /**
     * @return Tags are key-value pairs that allow you to categorize services.
     * 
     */
    public Output<Optional<List<KafkaMirrorMakerTag>>> tags() {
     ...
     * 
     */
    @Export(name="techEmails", refs={List.class,KafkaMirrorMakerTechEmail.class}, tree="[0,1]")
    private Output</* @Nullable */ List<KafkaMirrorMakerTechEmail>> techEmails;
     ...
     * 
     */
    public Output<Optional<List<KafkaMirrorMakerTechEmail>>> techEmails() {
