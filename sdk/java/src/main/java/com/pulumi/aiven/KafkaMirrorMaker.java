...
import com.pulumi.aiven.outputs.KafkaMirrorMakerKafkaMirrormaker;
...
public class KafkaMirrorMaker extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="kafkaMirrormakers", refs={List.class,KafkaMirrorMakerKafkaMirrormaker.class}, tree="[0,1]")
    private Output<List<KafkaMirrorMakerKafkaMirrormaker>> kafkaMirrormakers;

    /**
     * @return Kafka MirrorMaker 2 server provided values
     * 
     */
    public Output<List<KafkaMirrorMakerKafkaMirrormaker>> kafkaMirrormakers() {
    ...
    private Output</* @Nullable */ List<KafkaMirrorMakerServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<Optional<List<KafkaMirrorMakerServiceIntegration>>> serviceIntegrations() {
    ...
    public KafkaMirrorMaker(String name, KafkaMirrorMakerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/kafkaMirrorMaker:KafkaMirrorMaker", name, args == null ? KafkaMirrorMakerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
