...
public final class GetValkeyUserTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetValkeyUserTimeoutsArgs Empty = new GetValkeyUserTimeoutsArgs();
    ...
    private GetValkeyUserTimeoutsArgs() {}

    private GetValkeyUserTimeoutsArgs(GetValkeyUserTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetValkeyUserTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetValkeyUserTimeoutsArgs();
        }

        public Builder(GetValkeyUserTimeoutsArgs defaults) {
            $ = new GetValkeyUserTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetValkeyUserTimeoutsArgs build() {
            return $;
        }
    }
