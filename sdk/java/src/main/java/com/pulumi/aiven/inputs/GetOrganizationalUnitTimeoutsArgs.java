...
public final class GetOrganizationalUnitTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOrganizationalUnitTimeoutsArgs Empty = new GetOrganizationalUnitTimeoutsArgs();
    ...
    private GetOrganizationalUnitTimeoutsArgs() {}

    private GetOrganizationalUnitTimeoutsArgs(GetOrganizationalUnitTimeoutsArgs $) {
        this.read = $.read;
    }
    ...
    public static Builder builder(GetOrganizationalUnitTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOrganizationalUnitTimeoutsArgs();
        }

        public Builder(GetOrganizationalUnitTimeoutsArgs defaults) {
            $ = new GetOrganizationalUnitTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOrganizationalUnitTimeoutsArgs build() {
            return $;
        }
    }
