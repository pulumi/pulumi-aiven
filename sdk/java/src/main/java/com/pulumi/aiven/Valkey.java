...
import com.pulumi.aiven.inputs.ValkeyState;
import com.pulumi.aiven.outputs.ValkeyComponent;
import com.pulumi.aiven.outputs.ValkeyServiceIntegration;
import com.pulumi.aiven.outputs.ValkeyTag;
import com.pulumi.aiven.outputs.ValkeyTechEmail;
import com.pulumi.aiven.outputs.ValkeyValkey;
import com.pulumi.aiven.outputs.ValkeyValkeyUserConfig;
 ...
 * 
 */
@ResourceType(type="aiven:index/valkey:Valkey")
public class Valkey extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="components", refs={List.class,ValkeyComponent.class}, tree="[0,1]")
    private Output<List<ValkeyComponent>> components;

    /**
     * @return Service component information objects
     * 
     */
    public Output<List<ValkeyComponent>> components() {
     ...
     * 
     */
    @Export(name="serviceIntegrations", refs={List.class,ValkeyServiceIntegration.class}, tree="[0,1]")
    private Output<List<ValkeyServiceIntegration>> serviceIntegrations;

    /**
     * @return Service integrations to specify when creating a service. Not applied after initial service creation
     * 
     */
    public Output<List<ValkeyServiceIntegration>> serviceIntegrations() {
     ...
     * 
     */
    @Export(name="tags", refs={List.class,ValkeyTag.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ValkeyTag>> tags;

    /**
     * @return Tags are key-value pairs that allow you to categorize services.
     * 
     */
    public Output<Optional<List<ValkeyTag>>> tags() {
     ...
     * 
     */
    @Export(name="techEmails", refs={List.class,ValkeyTechEmail.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ValkeyTechEmail>> techEmails;
     ...
     * 
     */
    public Output<Optional<List<ValkeyTechEmail>>> techEmails() {
     ...
     * 
     */
    @Export(name="valkey", refs={ValkeyValkey.class}, tree="[0]")
    private Output<ValkeyValkey> valkey;

    /**
     * @return Valkey server provided values
     * 
     */
    public Output<ValkeyValkey> valkey() {
        return this.valkey;
    }
    /**
     ...
     * 
     */
    @Export(name="valkeyUserConfig", refs={ValkeyValkeyUserConfig.class}, tree="[0]")
    private Output</* @Nullable */ ValkeyValkeyUserConfig> valkeyUserConfig;
     ...
     * 
     */
    public Output<Optional<ValkeyValkeyUserConfig>> valkeyUserConfig() {
        return Codegen.optional(this.valkeyUserConfig);
    }
     ...
     */
    public Valkey(java.lang.String name) {
        this(name, ValkeyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Valkey(java.lang.String name, ValkeyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Valkey(java.lang.String name, ValkeyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/valkey:Valkey", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Valkey(java.lang.String name, Output<java.lang.String> id, @Nullable ValkeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aiven:index/valkey:Valkey", name, state, makeResourceOptions(options, id), false);
    }

    private static ValkeyArgs makeArgs(ValkeyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ValkeyArgs.Empty : args;
    }
     ...
     */
    public static Valkey get(java.lang.String name, Output<java.lang.String> id, @Nullable ValkeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Valkey(name, id, state, options);
    }
}
